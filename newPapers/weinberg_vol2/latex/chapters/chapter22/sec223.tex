...
\begin{equation}
 \chi\equiv
 \begin{bmatrix}
  \tfrac12(1+\gamma^5)\psi\\[2pt]
  \tfrac12\bigl[\mathcal C(1-\gamma^5)\psi\bigr]^*
 \end{bmatrix}
 =
 \begin{bmatrix}
  \tfrac12(1+\gamma^5)\psi\\[2pt]
  \tfrac12(1+\gamma^5)\mathcal C\psi^*
 \end{bmatrix},
...
\begin{equation}
 ...
 \left[
  \frac{1+\gamma^5}{2}t_\alpha^L
  +\frac{1-\gamma^5}{2}t_\alpha^R
 \right]\psi
...
\begin{equation}
 P_L=\left(\frac{1+\gamma^5}{2}\right)
...
Eq.~\eqref{eq:22.3.15} arising from the 1 and the $\gamma^5$ in the
projection matrix $\tfrac12(1+\gamma^5)$. The terms arising from the 1
...
We are left with the term in the trace involving $\gamma^5$. This is
totally antisymmetric
\begin{equation}
 \operatorname{tr}
 \left[\gamma^\kappa\gamma^\nu\gamma^\lambda\gamma^\rho\gamma^5\right]
 =-4i\epsilon^{\kappa\nu\lambda\rho},
...
$T_\alpha$ of global symmetries like chiral $SU(3)\cdot SU(3)$ take the
...
$SU(3)\cdot SU(3)$ symmetry of the strong interactions, with momentum shift
...
$SU(3)\cdot SU(3)$ symmetry (which acts on quark flavors rather than colors)
...
$(1-\gamma^5)\psi$ of fermion-number-conserving theories) that do not
...
\begin{equation}
 \sl{D}=\sl{\partial}
 -iA_\alpha T_\alpha\left(\frac{1+\gamma^5}{2}\right).
...
\begin{equation}
 \sl{D}
 =\sl{\partial}\left(\frac{1-\gamma^5}{2}\right)
 +\sl{D}\left(\frac{1+\gamma^5}{2}\right),
...
\begin{equation}
 \sl{D}_L=\sl{D}\left(\frac{1+\gamma^5}{2}\right).
