...
% Source review: rendered physical pp. 168--171 checked, including both sides of the Section 18.5/18.6 boundary; no unresolved transcription uncertainties. The source's T_0 in Eq. (18.5.3) and its first body footnote, and O(g_4(mu)) without a square in Eq. (18.5.8), are preserved as printed.
...
G_N\bigl(\kappa(T-T_0)^{1/\lambda_0}\bigr).
...
=\left[-2+\frac{g_4(\mu)}{16\pi^2}+O\bigl(g_4(\mu)\bigr)\right]g_2(\mu).
