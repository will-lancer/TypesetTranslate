...
theory. The complete vacuum vacuum amplitude in the presence of these
currents is then
\begin{align}
Z[J]
&\equiv \langle \Omega;\,\mathrm{out}\|\Omega;\,\mathrm{in}\rangle_J \notag\\
...
&=i\langle \Omega;\,\mathrm{out}\|\Phi^r(x)\|\Omega;\,\mathrm{in}\rangle_{J=0}.
\label{eq:16.1.2}
\end{align}
...
\begin{equation}
\phi_J^r(x)\equiv
\frac{\langle \Omega;\,\mathrm{out}\|\Phi^r(x)\|\Omega;\,\mathrm{in}\rangle_J}
{\langle \Omega;\,\mathrm{out}\|\Omega;\,\mathrm{in}\rangle_J}
