...
% Uncertainties: none after rendered-page review; the source's later word ``nonpositive'' is preserved despite the preceding convexity discussion.
...
\begin{equation}
\langle \Omega;\,\mathrm{out}\|\Omega;\,\mathrm{in}\rangle_{\mathcal J}
