...
\]
where $\boldsymbol\sigma$ is the usual three-vector of $2\cdot2$ Pauli
matrices, and `$\mathbf{1}$' and `$0$' here are the $2\cdot2$ unit and zero
...
independent $4\cdot4$ matrices are
\begin{equation}
