...
Add to the standard-model matter content one right-handed neutrino
  ...
  \(C=i\gamma^2\gamma^0\) in the Dirac representation, and write
  \[
...
Use the trace and determinant of
  ...
  \[
    ...
    \qquad D_\mu\phi=\partial_\mu\phi-i\tau_aA^a_\mu\phi,
  \]
      ...
      \[
        f_{\widetilde\phi}(e^{i\theta^aT_a})
          =\operatorname{Re}\!\left(
             \widetilde\phi^\dagger e^{i\theta^a\tau_a}v\right)
      \]
