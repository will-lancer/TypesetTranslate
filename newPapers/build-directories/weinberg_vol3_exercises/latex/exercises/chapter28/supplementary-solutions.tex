  ...
  \begin{enumerate}
    ...
    \begin{tikzpicture}[font=\scriptsize]
      \begin{scope}
        ...
        \draw[thick,->] (a) arc[start angle=180,end angle=0,radius=0.7];
        \draw[thick,->] (b) arc[start angle=0,end angle=-180,radius=0.7];
...
For Eq.~\eqref{eq:28.5.51},
  ...
  \begin{enumerate}
    ...
    \begin{tikzpicture}[font=\scriptsize]
      ...
      \draw[thick,->] (-1.65,0.65)--(v1) node[midway,above left] {\(u_{Rm}\)};
      \draw[thick,->] (-1.65,-0.65)--(v1) node[midway,below left] {\(d_{Rn}\)};
      \draw[thick,dashed] (v1)--(v2) node[midway,above] {\(\widetilde d_{Rk}\)};
      \draw[thick,<-] (v2)--(4.45,-0.65) node[midway,below right] {\(d_{Lj}\)};
      \draw[thick,->] (v2)--(4.45,0.65) node[midway,above right] {\(\bar\nu_i\)};
      \fill (v1) circle (1.6pt); \fill (v2) circle (1.6pt);
      \node[below=5pt] at (v1) {\(\lambda''\)};
      \node[below=5pt] at (v2) {\(\lambda'\)};
    \end{tikzpicture}
    \end{center}
    ...
    \begin{tikzpicture}[font=\scriptsize]
      \coordinate (v) at (0,0);
      \draw[thick,dashed,->] (-1.8,-0.9)--(v)
        node[midway,below left] {\(\widetilde u_{L\alpha}\)};
      \draw[thick,dashed,->] (v)--(1.8,-0.9)
        node[midway,below right] {\(\widetilde d^{\,*}_{L\beta}\)};
      \draw[thick] (-1.8,0.9)--(v)
        node[midway,above left] {\(G_\mu^A\)};
      \draw[thick] (v)--(1.8,0.9)
        node[midway,above right] {\(W_\nu^-\)};
      \fill (v) circle (1.8pt);
    \end{tikzpicture}
    \end{center}
