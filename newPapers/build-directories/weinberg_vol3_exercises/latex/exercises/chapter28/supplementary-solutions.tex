...
\begin{enumerate}
  ...
  \SupplementarySolution{3}{Gaugino Mass Ratios at a Common Scale}
...
If a product of messenger couplings \(c\) generates the Higgs bilinear
  ...
  \SupplementarySolution{15}{Radiative Breaking and Stable Cascade Endpoints}
  \begin{enumerate}
