...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    Let \(\omega=e^{2\pi \ii/3}\), and assign additive charges modulo three
      \[
  ...
  \begin{enumerate}
    ...
    \[
      \frac{\dd}{\dd\ln\mu}\frac{1}{g_a^2}=-2\beta_a.
    \]
    Hence
    \[
      \boxed{
  ...
  \begin{enumerate}
    ...
    In the super-CKM basis a flavor change on a squark line is represented
      ...
      \[
        (\delta^d_{12})_{LL}
          =\frac{(\Delta M_{\widetilde \dd}^2)_{12}}{\widetilde M^2}.
      \]
  ...
  \begin{enumerate}
    ...
    Define the neutral gauge singlet
      \(H\cdot\phi=H^{\mathsf T}\ii\sigma_2\phi\).  The most general potential is
      \[
      \begin{aligned}
    ...
    Let
      \(\widetilde H=\ii\sigma_2H^*\) and
      \(\widetilde\phi=\ii\sigma_2\phi^*\).  Omitting possible neutrino
...
For Eq.~\eqref{eq:28.5.51},
  ...
  \begin{enumerate}
    ...
    \[
      C\sim\frac{\lambda'\lambda''}{M_{\widetilde \dd}^2}.
    \]
    ...
    \[
      \boxed{\Gamma_p\sim
        ...
        \frac{m_p^5}{M_{\widetilde \dd}^4}.}
      \tag{28.14.5}
    \]
    For \(m_p\sim1\,\mathrm{GeV}\) and
    \(M_{\widetilde \dd}=10^4\,\mathrm{GeV}\), this is
    ...
    \[
      |\lambda'\lambda''|
       \lesssim
       \left(8\pi\Gamma_p\frac{M_{\widetilde \dd}^4}{m_p^5}\right)^{1/2}
       \sim10^{-24}\text{--}10^{-25}.
      \tag{28.14.6}
    \]
    ...
    \[
      \mathcal L_{\rm kin}=-(D_\mu\widetilde Q)^\dagger
        D^\mu\widetilde Q,
      \qquad
      D_\mu=\partial_\mu-\ii g_sG_\mu^AT^A-\ii g_2W_\mu^at^a-\cdots,
    \]
    ...
    \[
      \boxed{-2\ii g_sg_2\eta_{\mu\nu}
        (T^A)_{\beta\alpha}(t^a)_{ji}.}
      \tag{28.14.8}
    \]
    For \(W^-=(W^1+\ii W^2)/\sqrt2\), it becomes
    \(-\ii\sqrt2g_sg_2\eta_{\mu\nu}(T^A)_{\beta\alpha}\) for
  ...
  \begin{enumerate}
    \item Put \(g=g_\phi e^{\ii\epsilon^aT_a}\).  At the maximum,
      \[
    ...
    \item Since \(D(h)v=v\),
      ...
      \[
        A_\mu^{\mathfrak h}\longmapsto
          h^{-1}A_\mu^{\mathfrak h}h+\ii h^{-1}\partial_\mu h,
        \qquad
    ...
    \item The expansion is
      \[
      \begin{split}
        f_{\widetilde\phi}(e^{\ii\theta\cdot T})
    ...
    \item Write \(\phi=\rho e^{\ii\vartheta}\).  For charge \(p\), one may
      choose \(g_\phi=e^{\ii\vartheta/p}\), modulo the residual subgroup
    ...
    \item Take \(\tau_i=\sigma_i/2\) and
      ...
      \[
        ...
        \end{pmatrix}.
      \]
      Thus \(W^\pm=(\widehat A^1\mp \ii\widehat A^2)/\sqrt2\) have
