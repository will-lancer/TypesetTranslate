...
Let \(q\) be the number of real supercharges.  After dimensional
  ...
  Starting from
  \[
    S_5=\frac{M_5^3}{2}\int_0^Ldy\int d^4x\,
      \sqrt{|G_5|}\,{}^{(5)}R,
  \]
  the cylinder condition and the curvature identity in the question give
  \[
  \begin{split}
    S_5=\frac{M_5^3L}{2}\int d^4x\sqrt{|g|}\bigg[
       e^\sigma{}^{(4)}R-2\nabla^2e^\sigma
  ...
  \[
    S_J=\frac{M_4^2}{2}\int d^4x\sqrt{|g|}
  ...
  \[
    \boxed{
    S_E=\frac{M_4^2}{2}\int d^4x\sqrt{|g_E|}
  ...
  \[
    dy+A_\mu dx^\mu
      =dy'+(A_\mu+\partial_\mu\lambda)dx^\mu,
  \]
  so
  \[
  ...
  \begin{enumerate}
    \item Cartesian factorization gives
      \[
        I_N=\prod_{i=1}^N\int_{-\infty}^{\infty}dx_i\,e^{-x_i^2}
          =\pi^{N/2}.
      \tag{1}
      \]
      ...
      \[
        I_N=\Omega_{N-1}\int_0^\infty d\rho\,
             \rho^{N-1}e^{-\rho^2}
    ...
    \item Let the compact coordinate have period \(2\pi R\), let
      ...
      \((2\pi R)^{-1}\int dz/(r^2+z^2)=1/(2Rr)\).  Matching the
  ...
  \begin{enumerate}
    ...
    \item The four-dimensional Einstein term is weighted by the square of
      ...
      \begin{split}
        M_{\rm Pl}^2
          &=M_*^3r\int_{-\pi}^{\pi}d\theta\,e^{-2kr|\theta|}\\
