...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    Regard \(m\) and \(\lambda\) as background chiral spurions.  Holomorphy,
      ...
      \(\Phi,m,\lambda\) leave only the tree monomials
      \(m\Phi^2/2\) and \(\lambda\Phi^3/3\).  A perturbative correction that
      vanished as \(\lambda\to0\) cannot be both holomorphic and neutral under
      these spurion symmetries.  Thus the Wilsonian superpotential is not
      perturbatively renormalized.
