...
With the orientation and mostly-plus metric of this volume, take
  ...
  \begin{enumerate}
    ...
    \item The operator \(B_\mu\) is a Lorentz vector, so
      ...
      \begin{aligned}
        [M^{\rho\sigma},C_{\mu\nu}]
          =\ii\big(&\delta_\mu^\sigma C^\rho{}_\nu
  ...
  \begin{enumerate}
    \item The nonzero anticommutators are
      ...
      \[
        ...
        \qquad
        [K_i,\WeylQ_{ar}]
          =-\frac{\ii}{2}(\sigma_i)_{ab}\WeylQ_{br},
      \]
      and
      \[
  ...
  \begin{enumerate}
    ...
    Up to a common convention for rescaling the adjoint chirals, the action is
      \[
      \begin{aligned}
        S=\frac1{g^2}\int \dd^4x\,\operatorname{Tr}\Bigg\{&
          \int \dd^4\theta\,
             \sum_{i=1}^3
      ...
      \(\phi_i=(X^{2\ii-1}+\ii X^{2\ii})/\sqrt2\) therefore combines both
      contributions into
      \[
        V_{\rm scalar}
