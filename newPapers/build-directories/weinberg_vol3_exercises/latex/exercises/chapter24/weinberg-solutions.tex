...
\begin{aligned}
 ...
 &=\ii(\delta\psi_2^\mu)\partial_+\psi_{2\mu}
   +\ii\psi_2^\mu\partial_+(\delta\psi_{2\mu})\\
 &=-T\partial_+\!\left(
   \alpha_2\psi_2^\mu\partial_-X_\mu\right)
   +2T\alpha_2\psi_2^\mu\partial_+\partial_-X_\mu .
\end{aligned}
...
\begin{gathered}
 ...
 \mathcal F=\frac{F-\ii G}{\sqrt2},\qquad
...
\begin{aligned}
 K^\mu={}&\frac12\gamma^\mu\Big[
   -\gamma^\nu(\partial_\nu A)\psi
   +\ii\gamma^\nu(\partial_\nu B)\gamma_5\psi
   +F\psi+\ii G\gamma_5\psi\Big]\\
 &+\gamma^\mu\Big[
   \bigl(mA+g(A^2-B^2)\bigr)\psi
   +\ii\bigl(mB+2gAB\bigr)\gamma_5\psi\Big].
\end{aligned}
\]
