...
% Corrected the normalization of Eq. (27.3.12) to agree with its Abelian
% limit in Eqs. (27.2.15) and (27.2.17).
% Uncertainties: none.
...
\end{equation}
\begin{equation}
  \delta D_A=\ii\left(\bar\alpha\gamma_5\sl{\partial}\lambda_A\right).
...
\begin{equation}
  ...
  \equiv{}&
  \frac{\ii}{4}\sum_{\beta\gamma}\epsilon_{\beta\gamma}
...
\begin{equation}
  ...
  \right]_{\mathcal{F}}
  ={}&
  -\ii\sum_A\left(\bar\lambda_A\sl{D}\gamma_5\lambda_A\right)
  \\
  &+\frac14\epsilon_{\mu\nu\rho\sigma}
    \sum_A f_A^{\mu\nu}f_A^{\rho\sigma}.
  \end{aligned}
