...
% Corrected duplicated scalar factors in Eqs. (27.8.1) and (27.8.4).
% Uncertainties: none.
...
\begin{equation}
  \begin{aligned}
    ...
    \delta\mathcal{F}
    &=\sqrt{2}\bigl(\bar\alpha_L\sl{\partial}\psi_L\bigr)\,,\\
    \delta\phi
    &=\sqrt{2}\bigl(\bar\alpha_R\psi_L\bigr)\,.
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
    ...
    &=\bigl(\bar\alpha\gamma_\mu\lambda\bigr)\,,\\
    \widetilde{\delta}\lambda
    &=\ii D\gamma_5\alpha
      +\frac12\bigl[\partial_\mu\sl{V},\gamma^\mu\bigr]\alpha\,,\\
    \widetilde{\delta}D
    &=\ii\bigl(\bar\alpha\gamma_5\sl{\partial}\lambda\bigr)\,,
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
    \widetilde{\delta}\psi_L
    &=\sqrt{2}\,D_\mu\phi\,\gamma^\mu\alpha_R
      +\sqrt{2}\mathcal{F}\alpha_L\,,\\
    \widetilde{\delta}\mathcal{F}
    &=\sqrt{2}\bigl(\bar\alpha_L\sl{D}\psi_L\bigr)
      -2\ii q\phi\bigl(\bar\alpha_L\lambda_R\bigr)\,,\\
    \widetilde{\delta}\phi
    &=\sqrt{2}\bigl(\bar\alpha_R\psi_L\bigr)\,.
  \end{aligned}
...
\begin{equation}
  \delta C=0,\qquad
  \delta\omega=\sl{V}\alpha,\qquad
  \delta M=-\bigl(\bar\alpha\lambda\bigr),\qquad
  \delta N=\ii\bigl(\bar\alpha\gamma_5\lambda\bigr)\,.
...
\eqref{eq:27.1.13}:
\begin{equation}
  V\longrightarrow V+\frac{\ii}{2}\bigl[\Omega-\Omega^*\bigr]\,,
  \tag{27.8.6}\label{eq:27.8.6}
\end{equation}
where \(\Omega\) is a left-chiral superfield with components
\begin{equation}
  \phi^\Omega=0,\qquad
  \psi_L^\Omega=-\sqrt{2}\sl{V}\alpha_R,\qquad
  \mathcal{F}^\Omega
  =-\bigl(\bar\alpha(\mathbf{1}-\gamma_5)\lambda\bigr)\,.
...
\begin{equation}
  \begin{aligned}
    \delta'\psi_L
    &=-\ii\sqrt{2}q\phi\,\sl{V}\alpha_R\,,\\
    \delta'\mathcal{F}
    &=-2\ii q\phi\bigl(\bar\alpha_L\lambda_R\bigr)
      -\ii\sqrt{2}q\bigl(\bar\alpha_L\sl{V}\psi_L\bigr)\,,\\
    \delta'\phi&=0\,.
  \end{aligned}
