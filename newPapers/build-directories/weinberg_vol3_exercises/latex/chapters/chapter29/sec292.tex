...
% Source note: Eq. (29.2.40) visibly prints \Delta(x-y,m^2), whereas the
% preceding spectral formulas use \Delta(x-y,m); this is preserved.
% Uncertainties: none.
...
\(\lvert X,\mathrm{Box}\rangle\):
\begin{equation}
  \begin{aligned}
  &\sum_X
    \langle\mathrm{VAC}\lvert Q_\alpha\rvert X,\mathrm{Box}\rangle
    \langle\mathrm{VAC}\lvert Q_\beta\rvert X,\mathrm{Box}\rangle^*
  \\
  &\quad
  +\sum_X
    \langle\mathrm{VAC}\lvert Q_\beta^*\rvert X,\mathrm{Box}\rangle
  ...
  \\
  &\hspace{30mm}
  =-2i(\gamma_\mu\beta)_{\alpha\beta}
    \langle\mathrm{VAC}\lvert P^\mu\rvert\mathrm{VAC}\rangle\,.
  \end{aligned}
...
\begin{equation}
  ...
  \left\lvert
    \langle\mathrm{VAC}\lvert Q_\alpha\rvert X,\mathrm{Box}\rangle
  \right\rvert^2
  =4\langle\mathrm{VAC}\lvert P^0\rvert\mathrm{VAC}\rangle\,.
...
box-normalized state \(\lvert X,\mathrm{Box}\rangle\) containing \(N_X\)
particles is related according to Eq.~\eqref{eq:3.4.3} to the
corresponding continuum-normalized state \(\lvert X\rangle\) by
\begin{equation}
  \lvert X,\mathrm{Box}\rangle
  =\left((2\pi)^3/V\right)^{N_X/2}\lvert X\rangle\,.
...
\begin{equation}
  ...
  \langle\mathrm{VAC}\lvert S_\alpha^0(0)\rvert X\rangle\,.
...
\begin{equation}
  \rho_{\mathrm{VAC}}
  \equiv
  \langle\mathrm{VAC}\lvert P^0\rvert\mathrm{VAC}\rangle/V\,,
...
\(\lvert\mathbf p,\lambda\rangle\), with momentum \(\mathbf p\) and
...
\[
  \mathrm{CPT}\lvert\mathbf p,\lambda\rangle
  =\chi_\lambda\lvert\mathbf p,-\lambda\rangle
\]
...
\[
  ...
  =(2\pi)^{-3/2}\exp(ip\mathbin{\cdot}x)u(\mathbf p,\lambda)\,,
\]
...
\begin{equation}
  \begin{aligned}
  \langle\mathrm{VAC}\lvert S^\mu(0)\rvert\mathbf p,\lambda\rangle
  =(2\pi)^{-3/2}
  \biggl[
    &\left(\frac{1+\gamma_5}{2}\right)
      \left(\gamma^\mu F+ip^\mu F'\right)
  \\
    &+\left(\frac{1-\gamma_5}{2}\right)
      \left(\gamma^\mu F^*+ip^\mu F'{}^*\right)
...
\[
  ...
  =\operatorname{Tr}\Biggl\{&
    \left(
      ...
      +F^*\frac{1-\gamma_5}{2}
    \right)
    \gamma^0\frac{-i\sl{p}\beta}{2p^0}(\gamma^0)^\dagger
  \\
  &{}\times
    \left(
      F^*\frac{1+\gamma_5}{2}
...
\begin{equation}
  \begin{aligned}
  \langle X\lvert S^\mu(0)\rvert Y\rangle
  ={}&
  \left\{
  \begin{aligned}
    &\left(\frac{1+\gamma_5}{2}\right)
  ...
  \end{aligned}
  \right\}
  \left(\frac{-i\sl{p}}{p^2}\right)
  M(X\to Y+g)
  \\
  &+\langle X\lvert S^\mu(0)\rvert Y\rangle_{\text{no pole}}\,,
  \end{aligned}
...
\(\langle X\lvert S^\mu(0)\rvert Y\rangle_{\text{no pole}}\) may have
...
\begin{equation}
  ...
  -i\left\{
    ...
    +\left(\frac{1-\gamma_5}{2F^*}\right)
  \right\}
  p_\mu\langle X\lvert S^\mu(0)\rvert Y\rangle_{\text{no pole}}\,.
...
\begin{equation}
  ...
  =
  i\delta^3(\mathbf x-\mathbf y)\delta\chi(\mathbf x,t)+\cdots\,,
...
a complete set \(\lvert X\rangle\) of intermediate states (including
...
\begin{equation}
  ...
  \\
  &\qquad
  =\int d^4p\,\exp\bigl(ip\mathbin{\cdot}(x-y)\bigr)
...
\begin{equation}
  ...
  \equiv
  \sum_X\delta^4(p-p_X)
  \langle\mathrm{VAC}\lvert\psi_{L\alpha}(0)\rvert X\rangle
  \langle X\lvert\bar S^\mu_\beta(0)\rvert\mathrm{VAC}\rangle\,,
...
\begin{equation}
  ...
  \equiv
  \sum_X\delta^4(p-p_X)
  \langle\mathrm{VAC}\lvert\bar S^\mu_\beta(0)\rvert X\rangle
  \langle X\lvert\psi_{L\alpha}(0)\rvert\mathrm{VAC}\rangle\,.
...
\begin{equation}
  ...
  \begin{aligned}
    ...
    \\
    &-i\partial^\mu G^{(3)}(m^2)
    -i\sl{\partial}\gamma^\mu G^{(4)}(m^2)
  \end{aligned}
  \right]\Delta_+(x-y,m)
  \\
  &\quad+
  ...
  \begin{aligned}
    ...
    \\
    &-i\partial^\mu\widetilde G^{(3)}(m^2)
    -i\sl{\partial}\gamma^\mu\widetilde G^{(4)}(m^2)
  \end{aligned}
  \right]\Delta_+(y-x,m)\,,
  \end{aligned}
...
\begin{equation}
  ...
  \equiv
  (2\pi)^{-3}\int d^4p\,
  \theta(p^0)\delta(p^2+m^2)\exp(ip\mathbin{\cdot}x)\,.
...
\begin{equation}
  i\langle\delta\psi_L\rangle_{\mathrm{VAC}}
...
one-particle state \(\lvert g\rangle\) in the sums over states in
Eqs.~\eqref{eq:29.2.13} and/or \eqref{eq:29.2.14}. For the matrix elements
\(\langle\mathrm{VAC}\lvert\psi\rvert g\rangle\) or
\(\langle g\lvert\psi\rvert\mathrm{VAC}\rangle\) not to vanish, this
...
\begin{equation}
  \langle\mathrm{VAC}\lvert\psi(0)\rvert\mathbf p,\lambda\rangle
  =
  \frac1{(2\pi)^{3/2}}
  \left[
...
\begin{equation}
  \begin{aligned}
  &\int dX\,\delta^4(p-p_X)
  \langle\mathrm{VAC}\lvert S^\mu_\alpha(0)\rvert X\rangle
  \langle X\lvert\bar S^\nu_\beta(0)\rvert\mathrm{VAC}\rangle
  \\
  &\quad
  =H^{(1)}(-p^2)\gamma^\mu p^\nu
  +H^{(2)}(-p^2)\gamma^\nu p^\mu
...
\begin{equation}
  ...
  +\cdots
  \\
  ={}&(2\pi)^3\beta\int dm^2H^{(1)}(m^2)+\cdots\,.
  \end{aligned}
