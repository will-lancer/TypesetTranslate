...
% [4], [8]--[13].
% Corrections: the duality sentence links the algebra Eqs. (32.3.2)--(32.3.4),
% and the d=11 restriction follows Eq. (32.3.7).
...
\[
  ...
  ={}&\sum_{n=1}^p\sum_{r_1=1}^p\sum_{r_2=1}^p\cdots\sum_{r_p=1}^p
    \int \dd\sigma^1\,\dd\sigma^2\cdots \dd\sigma^p\,
