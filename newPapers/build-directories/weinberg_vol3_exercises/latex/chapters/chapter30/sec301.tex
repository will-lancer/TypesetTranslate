...
\begin{align}
  &\left\langle
   ...
   \right\rangle \notag\\
  &\qquad={}
  \int\left[\prod_{n,x,\theta}\dd\Phi_n(x,\theta)\right]
...
\begin{align}
  &\left\langle
   ...
   \right\rangle \notag\\
  &\qquad={}
  \int\left[\prod_{n,x,\theta}\dd S_n(x,\theta)\right]
    \exp\bigl(\ii I[\SuperD_R^2S]\bigr)
...
\begin{equation}
  ...
  =\frac12\int \dd^4x\sum_n
   ...
   +2\operatorname{Re}\int \dd^4x\,[\widetilde f(S)]_D\,.
...
\begin{equation}
  ...
  =-\frac14\int \dd^4x\int \dd^4\theta
   ...
   -\operatorname{Re}\int \dd^4x\int \dd^4\theta\,\widetilde f(S).
