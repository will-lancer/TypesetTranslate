...
% Correction: E^* consistently denotes external outgoing lines.
% Uncertainties: none.
...
\begin{equation}
  -\frac{\ii}{4}\delta^4(\theta-\theta')\Delta_F(x-x')\,.
...
external line factors, or \(E^*\) outgoing external lines and only \(E^*-1\)
