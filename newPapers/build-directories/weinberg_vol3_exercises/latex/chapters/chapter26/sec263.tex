...
\begin{equation}
  \delta\omega=
  \left(-i\gamma_5\sl{\partial}C-M+i\gamma_5N+\sl{\partial}Z\right)\alpha\,,
...
\end{equation}
\begin{equation}
  \delta N=i(\bar\alpha\gamma_5\sl{\partial}\omega)\,,
...
\begin{equation}
  ...
  -\frac{i}{2}(\bar\theta\gamma_5\theta)G(x)
  \\
  &+\frac{i}{2}(\bar\theta\gamma_5\gamma_\mu\theta)
    \partial^\mu B(x)
...
\begin{equation}
  \int d^4x\,[S_1\SuperD_\alpha S_2]_D
  =-\int d^4x\,[S_2\SuperD_\alpha S_1]_D\,.
...
$\theta\rightarrow-i\beta\theta$, and perhaps to multiply the superfield by a
...
\end{equation}
while $\theta_L\rightarrow-i\beta\theta_R$ and
$\theta_R\rightarrow-i\beta\theta_L$. Thus space inversion takes left-chiral
...
\begin{equation}
  ...
  P^{-1}\psi_L(x)P&=-i\epsilon\gamma_5\beta\psi_L^*(\Lambda_Px),\\
