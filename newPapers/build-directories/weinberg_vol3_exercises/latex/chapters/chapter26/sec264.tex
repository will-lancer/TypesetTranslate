...
\(-i(\bar\alpha Q)\) with any Heisenberg-picture quantum field \(\phi_n\) or
...
\(-i(\bar\alpha Q)\) with \(\mathcal{F}_n\) is given by
...
\begin{equation}
  ...
  -i\lambda B(\bar\psi\gamma_5\psi)
  \\
  &-m\lambda A(A^2+B^2)
...
\begin{equation}
  ...
  \qquad
  \psi(x)\longrightarrow i\beta\psi(\Lambda_Px)\,,
