...
\medskip
\noindent\amstar\textbf{13.} Let $A$ be a ring and $\mathfrak p$ a prime ideal of $A$.  The \emph{$n$th symbolic power of $\mathfrak p$} is defined
...
\medskip
\noindent\amstar\textbf{22.} A \emph{primary decomposition of $N$ in $M$} is a representation of $N$ as an intersection
\[
