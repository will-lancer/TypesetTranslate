...
\[
\int \dd^2\hat{\mathbf q}\,(p\pm q)^{-2}
=\frac{2\pi}{\mathbf p^2\mathbf q^2}\int_0^\pi
\frac{\sin\theta\,\dd\theta}{1-\cos\theta},
\]
...
\begin{equation}
S_{ba}=\delta(b-a)-2\ii\pi\delta(E_a-E_b)T_{ba},
\tag{13.4.1}\label{eq:13.4.1}
\end{equation}
where
\begin{equation}
T_{ba}=(H_{\mathrm{int}})_{ba}
+\sum_{\nu=1}^{\infty}\int \dd c_1\cdots \dd c_\nu\,
\frac{(H_{\mathrm{int}})_{bc_\nu}
(H_{\mathrm{int}})_{c_\nu c_{\nu-1}}\cdots
(H_{\mathrm{int}})_{c_1a}}
{(E_a-E_{c_1}+\ii\epsilon)\cdots(E_a-E_{c_\nu}+\ii\epsilon)}.
...
the $\ii\epsilon$ in the denominator. In order for an intermediate state $c$ to
...
{E_a-H_0+\ii\epsilon}H_{\mathrm{int}}\right]^\nu\right)_{ba},
...
\sum_{\nu=0}^{\infty}
\Biggl(
\left[H_{\mathrm{int}}\frac{\mathcal P_b}{E_a-H_0+\ii\epsilon}\right]^r
H_{\mathrm{int}}
\left[\frac{\mathcal P_{\notin a,b}}{E_a-H_0+\ii\epsilon}
H_{\mathrm{int}}\right]^\nu\notag\\
&\hspace{33mm}\cdot
\left[\frac{\mathcal P_a}{E_a-H_0+\ii\epsilon}
...
\sum_{r=0}^{\infty}
\left(\left[\frac{\mathcal P_\alpha}{E_\alpha-H_0+\ii\epsilon}
H_{\mathrm{int}}\right]^r\right)_{ca},
\tag{13.4.6}\label{eq:13.4.6}
\end{equation}
\begin{equation}
(\Omega_\beta^-)_{\dd b}\equiv
\sum_{r=0}^{\infty}
\left(\left[\frac{\mathcal P_\beta}{E_\beta-H_0-\ii\epsilon}
H_{\mathrm{int}}\right]^r\right)_{\dd b},
\tag{13.4.7}\label{eq:13.4.7}
\end{equation}
and $T_S$ is the `safe' operator\footnote{In $(\Omega_b^-)_{\dd b}$ we are using
the fact that $T_{ba}$ is calculated with $E_b=E_a$, and in $(T_S)_{\dd c}$ we
...
$\mathcal P_{\notin c,\dd}=\mathcal P_{\notin a,b}$.}
\begin{equation}
(T_S)_{\dd c}\equiv\sum_{\nu=0}^{\infty}
\left(H_{\mathrm{int}}
\left[\frac{\mathcal P_{\notin c,\dd}}{E_c-H_0+\ii\epsilon}
H_{\mathrm{int}}\right]^\nu\right)_{\dd c}.
