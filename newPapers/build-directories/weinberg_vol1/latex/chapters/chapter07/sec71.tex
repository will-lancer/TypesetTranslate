...
&=\ii\delta^3(\mathbf{x}-\mathbf{y})\delta^n_{\bar n},
...
\[
\Delta(x-y)\equiv\int\frac{\dd^3k}{2k^0(2\pi)^3}
\left[e^{\ii k\cdot(x-y)}-e^{-\ii k\cdot(x-y)}\right]
\]
with $k^0=\sqrt{\mathbf{k}^2+m^2}$. We note that
\[
\Delta(\mathbf{x},0)=0,
\qquad
\dot\Delta(\mathbf{x},0)=-\ii\delta^3(\mathbf{x}).
\]
...
\end{equation}
Equivalently, writing $\phi\equiv(\phi_1+\ii\phi_2)/\sqrt{2}$ with $\phi_k$ Hermitian for
...
\end{equation}
\begin{equation}
p_\ell(x)\equiv \ii\psi_\ell^\dagger(x).
...
\[
\delta F[q(t),p(t)]=\int \dd^3x\sum_n\left(
...
\begin{equation}
q^n(\mathbf{x},t)=\exp(\ii H_0t)q^n(\mathbf{x},0)\exp(-\ii H_0t),
\tag{7.1.19}\label{eq:7.1.19}
\end{equation}
\begin{equation}
p_n(\mathbf{x},t)=\exp(\ii H_0t)p_n(\mathbf{x},0)\exp(-\ii H_0t),
\tag{7.1.20}\label{eq:7.1.20}
\end{equation}
so the free-particle operators have the time-dependence
\begin{equation}
\dot q^n(\mathbf{x},t)=\ii[H_0,q^n(\mathbf{x},t)]
=\frac{\delta H_0}{\delta p_n(\mathbf{x},t)},
\tag{7.1.21}\label{eq:7.1.21}
\end{equation}
\begin{equation}
\dot p_n(\mathbf{x},t)=-\ii[p_n(\mathbf{x},t),H_0]
...
\begin{equation}
H_0=\int \dd^3x\left[\frac12p^2+\frac12(\boldsymbol{\nabla}q)^2
+\frac12m^2q^2\right].
...
\begin{align}
H_0&=\frac12\int \dd^3k\,k^0\{a_{\mathbf{k}},a^\dagger_{\mathbf{k}}\}
\notag\\
&=\int \dd^3k\,k^0\left(a^\dagger_{\mathbf{k}}a_{\mathbf{k}}
...
\sum_n\int \dd^3x\,p_n(\mathbf{x},t)\dot q^n(\mathbf{x},t)-H_0,
...
\begin{align}
L_0&=\int \dd^3x\left[p\dot q-\frac12p^2-\frac12(\boldsymbol{\nabla}q)^2
-\frac12m^2q^2\right]
\notag\\
&=\int \dd^3x\left[-\frac12\partial_\mu\phi\partial^\mu\phi
...
\begin{equation}
Q^n(\mathbf{x},t)=\exp(\ii Ht)q^n(\mathbf{x},0)\exp(-\ii Ht),
\tag{7.1.28}\label{eq:7.1.28}
\end{equation}
\begin{equation}
P_n(\mathbf{x},t)=\exp(\ii Ht)p_n(\mathbf{x},0)\exp(-\ii Ht),
...
\[
H[Q,P]=e^{\ii Ht}H[q,p]e^{-\ii Ht}=H[q,p].
\]
...
\begin{equation}
\dot Q^n(\mathbf{x},t)=\ii[H,Q^n(\mathbf{x},t)]
=\frac{\delta H}{\delta P_n(\mathbf{x},t)},
\tag{7.1.33}\label{eq:7.1.33}
\end{equation}
\begin{equation}
\dot P_n(\mathbf{x},t)=-\ii[P_n(\mathbf{x},t),H]
...
\begin{equation}
H=\int \dd^3x\left[\frac12P^2+\frac12(\boldsymbol{\nabla}Q)^2
