...
\begin{equation}
J^{\mu\nu}\equiv\int \dd^3x\,\mathcal{M}^{0\mu\nu},
...
\begin{equation}
\delta\Psi^\ell=\frac{\ii}{2}\omega^{\mu\nu}
(\mathcal{J}_{\mu\nu})^\ell{}_m\Psi^m,
...
=\ii\mathcal{J}_{\rho\nu}\eta_{\mu\sigma}
-\ii\mathcal{J}_{\sigma\nu}\eta_{\mu\rho}
-\ii\mathcal{J}_{\mu\rho}\eta_{\nu\sigma}
+\ii\mathcal{J}_{\mu\sigma}\eta_{\nu\rho}.
...
\qquad
\mathcal{J}_{k0}=-\ii(\mathcal{A}_k-\mathcal{B}_k),
\]
...
\begin{align*}
0={}&\frac{\ii}{2}\frac{\partial\mathcal{L}}{\partial\Psi^\ell}
(\mathcal{J}_{\mu\nu})^\ell{}_m\Psi^m
+\frac{\ii}{2}\frac{\partial\mathcal{L}}
...
\begin{align}
\Theta^{\mu\nu}=T^{\mu\nu}-\frac{\ii}{2}\partial_\kappa\Bigg[&
\frac{\partial\mathcal{L}}{\partial(\partial_\kappa\Psi^\ell)}
(\mathcal{J}^{\mu\nu})^\ell{}_m\Psi^m
...
&=\frac{\ii}{2}\epsilon_{k\ell i}\int \dd^3x\left(
x^k\frac{\partial}{\partial x^j}\Theta^{0\ell}
-x^\ell\frac{\partial}{\partial x^j}\Theta^{0k}\right)\\
&=-\ii\epsilon_{ijk}\int \dd^3x\,\Theta^{0k}
\end{align*}
and therefore
\begin{equation}
[P_j,J_i]=-\ii\epsilon_{ijk}P_k.
...
\[
K_k=\int \dd^3x\bigl(x^k\Theta^{00}-x^0\Theta^{0k}\bigr),
\]
or more explicitly
\begin{equation}
\mathbf{K}=-t\mathbf{P}+\int \dd^3x\,\mathbf{x}\Theta^{00}(\mathbf{x},t).
\tag{7.4.20}\label{eq:7.4.20}
\end{equation}
Since this is a constant, we have
$0=\dot{\mathbf{K}}=-\mathbf{P}+\ii[H,\mathbf{K}]$, and therefore
\begin{equation}
[H,\mathbf{K}]=-\ii\mathbf{P}.
\tag{7.4.21}\label{eq:7.4.21}
\end{equation}
Also, applying Eq.~\eqref{eq:7.3.28} again gives
\[
[P_j,K_k]=\ii\int \dd^3x\,x^k\frac{\partial}{\partial x^j}\Theta^{00}
=-\ii\delta_{jk}\int \dd^3x\,\Theta^{00}
\]
and therefore
\begin{equation}
[P_j,K_k]=-\ii\delta_{jk}H.
...
$e^{\ii H_0t}\int \dd^3x\,\mathbf{x}\Theta^{00}(\mathbf{x},0)e^{-\ii H_0t}$
...
$e^{\ii H_0t}\int \dd^3x\,\Theta^{00}(\mathbf{x},0)e^{-\ii H_0t}$ must vanish for
