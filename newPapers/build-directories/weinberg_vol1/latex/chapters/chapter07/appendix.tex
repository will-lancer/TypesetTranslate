...
$\mathcal{Q}^r$:
\begin{equation}
  [\mathcal{Q}^r,Q^n]=-\ii\frac{\partial f^r}{\partial P_n},\qquad
  [\mathcal{Q}^r,P_n]=\ii\frac{\partial f^r}{\partial Q^n},
  \tag{7.A.4}\label{eq:7.A.4}
\end{equation}
\begin{equation}
  [\mathcal{Q}^r,\mathcal{Q}^s]=\ii\Gamma^{rs},
...
$[Q^n,P_m]=\ii\delta^n_m$, $[Q^n,Q^m]=[P_n,P_m]=0$. The constrained and
...
\[
  ...
  =[\Psi^a,P_n]=\ii\frac{\partial\Psi^a}{\partial Q^n}
\]
or, in other words,
\begin{equation}
  \left\{[\Psi^a,\Pi_b]-\ii\delta^a_b\right\}
...
\begin{equation}
  [\Psi^a,\Pi_b]=\ii\delta^a_b+ic^a_r
  \frac{\partial\chi_{1r}}{\partial\Psi^b}
...
Dirac bracket
\begin{equation}
  [\Psi^a,\Pi_b]=\ii[\Psi^a,\Pi_b]_{\mathrm D}
...
so trivially
\begin{equation}
  [\Psi^a,\Psi^b]=\ii[\Psi^a,\Psi^b]_{\mathrm D},
  \qquad
  [\Pi_a,\Pi_b]=\ii[\Pi_a,\Pi_b]_{\mathrm D}.
