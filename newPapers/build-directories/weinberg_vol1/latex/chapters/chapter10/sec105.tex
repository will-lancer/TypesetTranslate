...
\end{equation}
where $[\ii\gamma_\mu k^\mu+m]u_k=[\ii\gamma_\mu k'^\mu+m]u_{k'}=0$.
...
\begin{align}
  ...
  \equiv{}&\int \dd^4x\int \dd^4x'\cdots
  e^{-\ii q\cdot x}e^{-\ii q'\cdot x'}\cdots \notag\\
  &\quad\cdot
  \OutBra{\beta}
