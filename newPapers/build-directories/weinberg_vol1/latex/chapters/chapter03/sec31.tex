...
Eq.~\eqref{eq:2.5.19}:
\begin{align}
&\bigl\langle p'_1,\sigma'_1,n'_1;\,p'_2,\sigma'_2,n'_2;\,\ldots
 \bigm|
 p_1,\sigma_1,n_1;\,p_2,\sigma_2,n_2;\,\ldots\bigr\rangle
\notag\\
&\quad={}
...
Eq.~\eqref{eq:3.1.1}: the `in' and `out' states\footnote{The labels `$+$' and `$-$'
for `in' and `out' states may seem backward, but they seem to have become
traditional. They arise from the signs in Eq.~\eqref{eq:3.1.16}.}
$\ket{\alpha}_{\mathrm{in}}$ and $\ket{\alpha}_{\mathrm{out}}$
...
$\ket{\alpha}_{\mathrm{in}}$ and $\ket{\alpha}_{\mathrm{out}}$ are the
...
appearance as the eigenstates $\ket{\alpha}_{\mathrm{in}}$ and
$\ket{\alpha}_{\mathrm{out}}$ of the complete Hamiltonian,
\begin{equation}
...
\begin{equation}
H\ket{\alpha}_{\mathrm{in/out}}
=E_\alpha\ket{\alpha}_{\mathrm{in/out}},
...
\begin{align}
\ket{\alpha}_{\mathrm{in}}&=\Omega(-\infty)\ket{\alpha},
\notag\\
\ket{\alpha}_{\mathrm{out}}&=\Omega(+\infty)\ket{\alpha},
...
g(\alpha)g^*(\beta)
{}_{\mathrm{in/out}}\!\bigl\langle\beta
...
\[
(E_\alpha-H_0)\ket{\alpha}_{\mathrm{in/out}}
=H_{\mathrm{int}}\ket{\alpha}_{\mathrm{in/out}}.
\]
...
H_{\mathrm{int}}\ket{\alpha}_{\mathrm{in}},
\notag\\
\ket{\alpha}_{\mathrm{out}}
&=\ket{\alpha}+(E_\alpha-H_0-i\epsilon)^{-1}
H_{\mathrm{int}}\ket{\alpha}_{\mathrm{out}},
...
\equiv\bra{\beta}H_{\mathrm{int}}\ket{\alpha}_{\mathrm{in/out}},
...
\end{equation}
We want to show that $\ket{\Psi_g(t)}_{\mathrm{in}}$ and
$\ket{\Psi_g(t)}_{\mathrm{out}}$ approach $\ket{\Phi_g(t)}$ for
...
We conclude that $\ket{\Psi_g(t)}_{\mathrm{in/out}}$ approaches
