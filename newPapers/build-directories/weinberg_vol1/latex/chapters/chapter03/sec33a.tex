...
\[
S_{\beta\alpha}={}_{\mathrm{out}}\!\braket{\beta}{\alpha}_{\mathrm{in}}
={}_{\mathrm{out}}\!\big\langle U(\Lambda,a)\beta\bigm|
U(\Lambda,a)\alpha\big\rangle_{\mathrm{in}},
\]
...
Eq.~\eqref{eq:3.2.4}:
\[
S_{\beta\alpha}=\langle\beta\vert S\vert\alpha\rangle_0.
\]
...
$-\langle\beta\vert[\mathbf{K}_0,H_{\mathrm{int}}]\vert\alpha\rangle/
...
particle species
\begin{align}
&U(T)\ket{p_1,\sigma_1,n_1;p_2,\sigma_2,n_2;\ldots}_{\mathrm{in/out}}
\nonumber\\
&\quad=\sum_{\bar n_1\bar n_2\ldots}
\mathcal{D}_{\bar n_1n_1}(T)\mathcal{D}_{\bar n_2n_2}(T)\cdots
\ket{p_1,\sigma_1,\bar n_1;p_2,\sigma_2,\bar n_2;\ldots}_{\mathrm{in/out}}.
