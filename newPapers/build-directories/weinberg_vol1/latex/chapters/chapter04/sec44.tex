...
more transparent; if $E$ is a sum of one-particle energies then $e^{-\ii Et}$ is a
product of functions of the individual energies, while
$[E-E_\alpha+\ii\epsilon]^{-1}$ is not.) The $S$-matrix is given by Eq.~\eqref{eq:3.5.10}
...
\begin{equation}
S_{\beta\alpha}=\sum_{n=0}^{\infty}\frac{(-\ii)^n}{n!}
 \int_{-\infty}^{\infty}\dd t_1\cdots \dd t_n\,
...
The factor $n!$ here cancels the $1/n!$ in Eq.~\eqref{eq:4.4.3}, and the factor $(-\ii)^n$
...
={}&\sum_{\mathrm{PART}}(\pm)\prod_{j=1}^{\nu}
 \sum_{n_j=0}^{\infty}\frac{(-\ii)^{n_j}}{n_j!}
 \int_{-\infty}^{\infty}\dd t_{j1}\cdots \dd t_{jn_j}
\\
&\quad\cdot
 \Bigl(\bra{\beta_j}T\{H_I(t_{j1})\cdots H_I(t_{jn_j})\}
 \ket{\alpha_j}\Bigr)_C.
...
\begin{equation}
S^C_{\beta\alpha}=\sum_{n=0}^{\infty}\frac{(-\ii)^n}{n!}
 \int_{-\infty}^{\infty}\dd t_1\cdots \dd t_n\,
...
$[E_\alpha-E_\beta+\ii\epsilon]^{-1}(H_{\mathrm{int}})_{\beta\alpha}$ of this
