...
\begin{equation}
  \phi^{(+)}(x)=\int d^3p\,(2\pi)^{-3/2}(2p^0)^{-1/2}
...
\begin{equation}
  \phi^{(-)}(x)=\int d^3p\,(2\pi)^{-3/2}(2p^0)^{-1/2}
  a^\dagger_{\mathbf{p}}e^{-ip\cdot x}=\phi^{(+)\dagger}(x).
...
\[
  [\phi^{(+)}(x),\phi^{(-)}(y)]_\mp
  =\int\frac{d^3p\,d^3p'}{(2\pi)^3(2p^0\cdot2p'^0)^{1/2}}
  e^{ip\cdot x}e^{-ip'\cdot y}\delta^3(\mathbf{p}-\mathbf{p}'),
\]
...
\begin{equation}
  \Delta_+(x)\equiv\frac{1}{(2\pi)^3}\int\frac{d^3p}{2p^0}e^{ip\cdot x}.
...
phases of the states so that $a_{\mathbf{p}}\to e^{i\alpha}a_{\mathbf{p}}$,
$a^\dagger_{\mathbf{p}}\to e^{-i\alpha}a^\dagger_{\mathbf{p}}$, and hence
$\kappa\to\kappa e^{i\alpha}$, $\lambda\to\lambda e^{-i\alpha}$. Taking
...
\[
  \widetilde\phi(x)=e^{i\alpha}\phi^{(+)}(x)
...
or in more detail
\begin{equation}
  \phi(x)=\int\frac{d^3p}{(2\pi)^{3/2}(2p^0)^{1/2}}
  \left[a_{\mathbf{p}}e^{ip\cdot x}
  +a^{c\dagger}_{\mathbf{p}}e^{-ip\cdot x}\right].
...
\begin{equation}
  ...
  \equiv\int\frac{d^3p}{2p^0(2\pi)^3}
