...
\input{chapters/chapter12/tables/table12-02.tex}
...
\input{chapters/chapter12/figures/fig12-04.tex}
...
\input{chapters/chapter12/figures/fig12-05.tex}
...
\[
\exp\left(\ii\int\mathcal L_{\mathrm{eff}}(\mathbf E,\mathbf B)\,\dd^4x\right)
=\int\left[\prod_x \dd\psi_e(x)\right]
\exp\left(\ii\int\mathcal L_{\mathrm{QED}}(\psi_e,A)\,\dd^4x\right).
\]
