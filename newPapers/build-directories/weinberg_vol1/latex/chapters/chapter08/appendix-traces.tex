...
integers $1,2,\ldots,2N$ into some order $P1,P2,\ldots,P\mathbin{\cdot}(2N)$,
...
P\mathbin{\cdot}(2N-1)<P\mathbin{\cdot}(2N)
...
factor $\eta_{\mu_{P\cdot(2n-1)}\mu_{P\cdot(2n)}}$. For instance (writing
...
$-\gamma_\mu=\gamma^5\gamma_\mu(\gamma^5)^{-1}$. Traces are unaffected by
...
\[
\operatorname{Tr}\{\gamma^5\gamma_{\mu_1}\gamma_{\mu_2}\cdots
\gamma_{\mu_n}\}.
\]
This vanishes for odd $n$ for the same reason as given above for traces
without a $\gamma^5$. It also vanishes for $n=0$ and $n=2$:
\begin{equation}
\operatorname{Tr}\{\gamma^5\}=0
\tag{8.A.10}\label{eq:8.A.10}
\end{equation}
\begin{equation}
\operatorname{Tr}\{\gamma^5\gamma_\mu\gamma_\nu\}=0.
\tag{8.A.11}\label{eq:8.A.11}
\end{equation}
(To see this just recall that
$\gamma^5\equiv i\gamma^0\gamma^1\gamma^2\gamma^3$, and note that there is no
...
\end{equation}
The trace of products of $\gamma^5$ with six, eight, or more Dirac matrices
