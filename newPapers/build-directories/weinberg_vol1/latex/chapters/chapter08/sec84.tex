...
H_{\mathrm{int}}&=-\int \dd^3x\,\mathbf J\cdot\mathbf A
...
\begin{equation}
O(\mathbf x,t)=\exp(\ii H_0t)O(\mathbf x,0)\exp(-\ii H_0t),
\tag{8.4.5}\label{eq:8.4.5}
\end{equation}
so that
\begin{equation}
\ii\dot O(\mathbf x,t)=[O(\mathbf x,t),H_0].
...
&=\ii\left[\delta_{ij}\delta^3(\mathbf x-\mathbf y)
...
be written
\begin{align}
a^\mu(x)=(2\pi)^{-3/2}\int\frac{\dd^3p}{\sqrt{2p^0}}\sum_\sigma
\Bigl[&e^{\ii p\cdot x}e^\mu(\mathbf p,\sigma)a_{\mathbf p,\sigma}
\notag\\[-2pt]
&+e^{-\ii p\cdot x}e^{\mu *}(\mathbf p,\sigma)
...
\begin{bmatrix}
0\\[1pt]1/\sqrt2\\[1pt]\mathord\pm \ii/\sqrt2\\[1pt]0
\end{bmatrix},
...
\begin{align}
H_0
&=\int \dd^3p\sum_\sigma\frac12p^0
  [a_{\mathbf p,\sigma},a^\dagger_{\mathbf p,\sigma}]_+
\notag\\
&=\int \dd^3p\sum_\sigma p^0
...
\begin{equation}
H_I(t)=-\int \dd^3x\,j_\mu(\mathbf x,t)a^\mu(\mathbf x,t)
...
\exp(\ii H_0t)J_\mu(\mathbf x,0)\exp(-\ii H_0t),
\tag{8.4.24}\label{eq:8.4.24}
\end{equation}
while $V_{\mathrm{Coul}}(t)$ is the Coulomb term
\begin{align}
V_{\mathrm{Coul}}(t)
&=\exp(\ii H_0t)V_{\mathrm{Coul}}\exp(-\ii H_0t)
\notag\\
...
\exp(\ii H_0t)H_{\mathrm{int,matter}}\exp(-\ii H_0t).
