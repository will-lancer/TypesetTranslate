...
counterfeit bag, there will be $i$ counterfeit coins, so the final weight will be $550\pm \ii$.
Since $i$ is distinct for each bag, we can identify the counterfeit coin bag as well as
whether the counterfeit coins are lighter or heavier than the real coins using $550\pm \ii$.
