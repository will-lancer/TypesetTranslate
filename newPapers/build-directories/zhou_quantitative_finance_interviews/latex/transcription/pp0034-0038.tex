...
\solution
Using the summation equation, $\displaystyle\sum_{n=1}^{12}n=\frac{12\times13}{2}=78$. So the numbers on each
...
\begin{align*}
  \sum_{n=1}^{100}n
  &=x+y+\sum_{i=1}^{98}z_i
  \Rightarrow x+y=\frac{100\times101}{2}-\sum_{i=1}^{98}z_i,\\
  \sum_{n=1}^{100}n^2
  &=x^2+y^2+\sum_{i=1}^{98}z_i^2
  \Rightarrow x^2+y^2=\frac{100^3}{3}+\frac{100^2}{2}+\frac{100}{6}-\sum_{i=1}^{98}z_i^2.
\end{align*}
...
5$\times$5 smaller squares with side length of 1/5 each will do since a circle with radius
