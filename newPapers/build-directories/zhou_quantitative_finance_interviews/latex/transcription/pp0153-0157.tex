...
\begin{problem}{Price direction of options}
...
\begin{problem}{Put-call parity}
\emph{Put-call parity:} $c+Ke^{-r\tau}=p+S-D$, where the European call option and the European
...
\begin{problem}{American v.s. European options}
...
\[
\begin{aligned}
C(\lambda S_1+(1-\lambda)S_2)&\leq\lambda C(S_1)+(1-\lambda)C(S_2),\\
&\qquad 0<\lambda<1.
\end{aligned}
\]
...
\begin{problem}{\emph{B.} A European put option on a non-dividend paying stock with strike price \$80 is
