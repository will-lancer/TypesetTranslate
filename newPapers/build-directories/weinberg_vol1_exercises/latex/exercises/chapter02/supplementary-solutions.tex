...
\SupplementarySolution{3}{Scalar Momentum-Space Generators and Finite Translations}
\begin{enumerate}
\item
...
\[
 U(\mathbf{1},a)=\exp(-ia_\mu P^\mu),
\]
and therefore
\[
 U(\mathbf{1},a)\ket{p,\sigma}
...
\SupplementarySolution{7}{Discrete Symmetries and Helicity}
Parity sends
\[
...
\SupplementarySolution{12}{The Galilean Algebra as a Relativistic Contraction}
...
\SupplementarySolution{13}{Massive Spin in \(2+1\) Dimensions}
...
\SupplementarySolution{14}{Massless Little-Group Characters in \(2+1\) Dimensions}
