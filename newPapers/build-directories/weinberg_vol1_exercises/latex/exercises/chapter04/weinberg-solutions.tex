...
Let
\[
 \ket{\ii}=\ket{\mathbf k,-\mathbf k},\qquad
...
\[
 ...
 =4g+8g^2 I(k)+O(g^3),
\qquad
 I(k)=\int \dd^3\mathbf q\,
 \frac{1}{2\varepsilon_k-2\varepsilon_q+\ii0}.
\]
...
\(\Lambda\),
\[
 I_\Lambda(k)=4\pi\int_0^\Lambda \dd q\,
 \frac{q^2}{2\varepsilon_k-2\varepsilon_q+\ii0},
\qquad
...
\[
 ...
 &-2\pi \ii\,\delta(2\varepsilon_{k'}-2\varepsilon_k)
...
Put
\[
 \|\lambda\|^2=\int \dd q\,|\lambda(q)|^2,
\qquad
 A^\dagger(\lambda)=\int \dd q\,\lambda(q)a_q^\dagger.
\]
