...
\begin{enumerate}
\SupplementarySolution{1}{Building a Positive Scalar Spectral Measure}
...
\SupplementarySolution{2}{Pole Weight and Continuum Threshold}
...
\SupplementarySolution{3}{The Canonical Spectral Sum Rule}
...
\SupplementarySolution{4}{Euclidean Propagator Inequalities}
After Wick rotation,
\[
 D_E(Q^2)=\int_0^\infty
...
\SupplementarySolution{5}{Parity-Resolved Fermion Spectra}
...
\SupplementarySolution{6}{A Spectral Test for a Forbidden Ghost Pole}
...
\SupplementarySolution{7}{Two Charged Insertions and One Local Ward Identity}
...
\[
 ...
 =-q\delta^4(x-y)\langle T\Phi(y)\Phi^\dagger(z)\rangle
 +q\delta^4(x-z)\langle T\Phi(y)\Phi^\dagger(z)\rangle.\;}
\]
...
\SupplementarySolution{8}{Momentum-Space Scalar Ward--Takahashi Identity}
...
\SupplementarySolution{9}{The Soft-Current Derivative Formula}
...
\SupplementarySolution{10}{Neutral Insertions and Vanishing Contact Terms}
...
\SupplementarySolution{11}{Charge Conservation as a Correlator Selection Rule}
...
\SupplementarySolution{12}{Current Conservation after LSZ Reduction}
...
\SupplementarySolution{13}{Two Form Factors for an Elastic Dirac Current}
...
\SupplementarySolution{14}{Charge and Magnetic Moment at Zero Transfer}
...
\SupplementarySolution{15}{Why a Transition Charge Must Vanish}
...
\SupplementarySolution{16}{Opposite-Parity Electromagnetic Transitions}
...
the two structures of the preceding solution by \(\gamma_5\), and its
transition-charge coefficient again vanishes at \(q^2=0\).

\SupplementarySolution{17}{The Scalar Charge-Radius Expansion}
...
\SupplementarySolution{18}{Transverse Decomposition of Vacuum Polarization}
...
\SupplementarySolution{19}{A Once-Subtracted Cauchy Formula}
...
\SupplementarySolution{20}{How Many Subtractions Are Needed?}
...
\SupplementarySolution{21}{Positive Taylor Coefficients below a Cut}
...
\SupplementarySolution{22}{Reconstructing a Scalar Bubble from Its Cut}
...
\SupplementarySolution{23}{Lepton Vacuum Polarization by Dispersion}
...
\SupplementarySolution{24}{The Optical Theorem as a Discontinuity Formula}
...
\SupplementarySolution{25}{Compton Gauge Cancellation before Squaring}
...
\SupplementarySolution{26}{The Forward Thomson Limit}
...
\SupplementarySolution{27}{Integrating the Klein--Nishina Distribution}
With \(x=\omega/m\) and
...
\SupplementarySolution{28}{When the Covariant Polarization Sum Is Legal}
...
\SupplementarySolution{29}{Crossing the Forward Compton Amplitude}
...
\SupplementarySolution{30}{A Dispersive Compton Reconstruction}
