...
\SupplementarySolution{2}{The General Feynman-Parameter Simplex}
For \(\Re\nu_i>0\),
\[
 A_i^{-\nu_i}=\frac{1}{\Gamma(\nu_i)}
...
\SupplementarySolution{3}{The Massless Bubble in \(d\) Dimensions}
...
\SupplementarySolution{4}{Rank-Four Rotational Averaging}
...
\SupplementarySolution{5}{Tensor Reduction of a Bubble}
...
\SupplementarySolution{6}{Massless QED Self-Energy Poles}
...
\SupplementarySolution{7}{The Area of a \(d\)-Sphere}
...
\SupplementarySolution{8}{A Massive Euclidean Master Integral}
...
\SupplementarySolution{9}{Completing a Shifted Square}
Complete the square:
\[
...
\SupplementarySolution{10}{Shifted Vector and Tensor Integrals}
...
\SupplementarySolution{11}{The Spinor Vacuum-Polarization Numerator}
...
\SupplementarySolution{12}{Subtracted Vacuum Polarization at Small Momentum}
...
\SupplementarySolution{13}{Which QED Counterterms Are Allowed?}
...
\SupplementarySolution{14}{Photon Pole and Charge Normalization}
...
\SupplementarySolution{15}{Two On-Shell Conditions for a Fermion}
...
\SupplementarySolution{16}{The Equality of Vertex and Wave-Function Poles}
...
\SupplementarySolution{17}{Why Four-Photon Scattering Is Ultraviolet Finite}
...
\SupplementarySolution{18}{From the Pauli Form Factor to \(g-2\)}
...
\SupplementarySolution{19}{The One-Loop QED Beta Function}
...
\SupplementarySolution{20}{Vacuum Screening and the Running Charge}
At one loop,
\[
...
\SupplementarySolution{21}{Decoupling below a Heavy Threshold}
...
\SupplementarySolution{22}{The Euler--Heisenberg Operator Basis}
...
\SupplementarySolution{23}{Expanding the Proper-Time Determinant}
...
\SupplementarySolution{24}{Low-Energy Light-by-Light Scaling}
...
\SupplementarySolution{25}{The Pauli Operator in a Background Field}
Define
...
\SupplementarySolution{26}{Nonrelativistic Reduction with a Pauli Term}
...
\SupplementarySolution{27}{Three Denominators on a Simplex}
...
\SupplementarySolution{28}{Isolating the Pauli Numerator}
After the shift in S.11.27, terms odd in \(\ell\) vanish.  Symmetric
...
\SupplementarySolution{29}{A Finite Euclidean Vertex Integral}
...
\end{aligned}
\]
Combining this with the numerator from S.11.28 yields the finite simplex
representation
\[
 \boxed{\;
...
\SupplementarySolution{30}{Schwinger's Parameter Integral}
At \(q^2=0\), the integrand in S.11.29 becomes
\[
 \frac{x_3}{1-x_3}.
\]
