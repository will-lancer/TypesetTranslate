...
\SupplementaryExercise{4}{One-Loop Self-Energies in Massless QED}
...
\begin{enumerate}
\item Draw the one-loop electron and photon two-point graphs in massless
QED and derive their dimensionally regulated integral expressions,
including the closed-fermion-loop sign.
\item Reduce the electron numerator in Feynman gauge, perform the
Feynman-parameter integral, and extract its ultraviolet pole.
\item Trace and tensor-reduce the photon vacuum-polarization numerator,
then extract its ultraviolet pole.
\item Prove that the photon result is transverse and identify the local
\(Z_2\) and \(Z_3\) counterterms that cancel the two poles.
\end{enumerate}
