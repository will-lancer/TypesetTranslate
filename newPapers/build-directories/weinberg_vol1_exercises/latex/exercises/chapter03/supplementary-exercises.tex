...
\item
Define
\(\Omega_\pm=\lim_{t\to\mp\infty}e^{\ii Ht}e^{-\ii H_0t}\), whenever the strong
...
of the identity,
\[
 I_2=\frac1{2!}\int \dd^3\mathbf p\,\dd^3\mathbf q\,
...
\begin{enumerate}
\item
Write \(S=1-\ii\mathcal T\).  Derive the off-diagonal unitarity relation for
...
\[
 ...
 =\ii\delta_{ij}\delta^3(\mathbf x-\mathbf y).
\]
Quantize the \(N\) equal-mass real fields and show that
\(\bra{0}T\{\Phi_i(x)\Phi_j(y)\}\ket{0}
...
\[
 (-\ii\lambda)^2\frac{-\ii}{q_A^2+m^2-\ii0}.
\]
...
\[
 \ket{i_{\psi\psi}}
 =\sqrt{4\omega_{\mathbf p}\omega_{\mathbf q}}\,
...
\begin{enumerate}
\item Regard \(g(t)=\theta(t)e^{-\ii\omega_0t}\) as a tempered
...
\(S=(1-\ii K)(1+\ii K)^{-1}\) with \(S=e^{2\ii\delta}\).  Find \(K\) in terms of
...
\(S_\ell=\eta_\ell e^{2\ii\delta_\ell}\).  Prove
...
Take
\[
 S_\ell(E)=\frac{E-E_R-\ii\Gamma/2}{E-E_R+\ii\Gamma/2}.
\]
