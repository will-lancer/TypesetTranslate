...
\SupplementaryExercise{10}{Connected Two-Point Graphs from the Path Integral and Tree Four-Point Function}
...
\SupplementaryExercise{11}{The Vacuum Cumulant Expansion}
...
copy of every connected vacuum graph with its symmetry factor.  Make the
exponential formula explicit for repeated copies of each connected topology
and account for the associated factorials.
...
\SupplementaryExercise{14}{Pfaffians under a Grassmann Change of Basis}
...
Fix the sign by a continuously connected change of basis and check the
formula explicitly for one Grassmann pair.
