...
\[
 Z[J]=\int\mathcal D x\,
 \exp\left[-iS[x]-i\int dt\,J(t)x(t)\right],
 \qquad
 x(t)\longleftrightarrow i\frac{\delta}{\delta J(t)}.
\]
The action for a harmonic oscillator of unit mass is
\[
 S[x]=\int dt\left(\frac12\dot x^{\,2}(t)
...
\[
 \phi_0(x)=\int\frac{d^d\mathbf p}{(2\pi)^d\sqrt{2E_{\mathbf p}}}
 \left[a_{\mathbf p}e^{ip\cdot x}
 +a_{\mathbf p}^\dagger e^{-ip\cdot x}\right],
 \qquad E_{\mathbf p}=\sqrt{\mathbf p^2+m^2},\quad p^0=E_{\mathbf p},
\]
with
\[
