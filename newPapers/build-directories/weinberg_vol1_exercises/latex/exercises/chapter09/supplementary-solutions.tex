...
\SupplementarySolution{10}{Connected Two-Point Graphs from the Path Integral and Tree Four-Point Function}
\begin{enumerate}
\item
At first order,
\[
...
\SupplementarySolution{11}{The Vacuum Cumulant Expansion}
...
\SupplementarySolution{14}{Pfaffians under a Grassmann Change of Basis}
