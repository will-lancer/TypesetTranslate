...
\begin{enumerate}
\SupplementarySolution{1}{The Transverse Delta Distribution and Coulomb Energy from Gauss's Law}
\begin{enumerate}
\item
...
\SupplementarySolution{2}{A Covariant Polarization Replacement}
...
\SupplementarySolution{3}{Threshold Law for Pair Production and Tree-Level Electromagnetic \(R\) Ratio}
\begin{enumerate}
\item
...
\SupplementarySolution{4}{The Scalar-QED Ward Cancellation}
...
\SupplementarySolution{5}{Gauge Covariance, Current, and Vertices in Scalar QED}
\begin{enumerate}
\item
...
\SupplementarySolution{6}{Coulomb Exchange and Tree-Level Gauge Independence}
\begin{enumerate}
\item
...
\SupplementarySolution{12}{A Pauli Term Shifts the Magnetic Moment and Anapole Coupling}
\begin{enumerate}
\item
