...
\[
 ...
 -\nabla^2A^0=\rho,\qquad
 \rho=\ii q\bigl(\Phi^\dagger\pi^\dagger-\pi\Phi\bigr).
\]
Thus \(A^0\) is auxiliary:
\[
 A^0(\mathbf x)=\int \dd^3y\,
...
\[
 ...
 =\ii\delta^{T}_{ij}(\mathbf x-\mathbf y),
\]
where
\[
...
fields and set
\[
 \rho_I=\ii q\bigl(\phi^\dagger\dot\phi-\dot\phi^\dagger\phi\bigr).
\]
Expanding the spatial covariant derivatives then gives
\[
 \begin{split}
 H_I(t)={}&\int \dd^3x\left\{
 \ii q\,\mathbf a\cdot
...
\[
 W_\mu\longmapsto e^{\ii q\Lambda}W_\mu,\qquad
 A_\mu\longmapsto A_\mu+\partial_\mu\Lambda .
\]
Then
\[
 D_\mu W_\nu=(\partial_\mu-\ii qA_\mu)W_\nu,\qquad
 W_{\mu\nu}=D_\mu W_\nu-D_\nu W_\mu
\]
