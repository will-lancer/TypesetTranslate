...
\begin{enumerate}
\SupplementarySolution{1}{Canonical Dimensions in Arbitrary Dimension}
...
\SupplementarySolution{2}{A \(Z_2\)-Even Scalar Operator Census}
...
\SupplementarySolution{3}{The Jacobian of a Local Field Coordinate}
...
\SupplementarySolution{4}{Tree-Level Matching of a Heavy Scalar}
...
\SupplementarySolution{5}{Matching Is Not Merely Dropping the Heavy Field}
...
\SupplementarySolution{6}{Chiral Spurions and Dipole Suppression}
...
\SupplementarySolution{7}{Superficial Divergence in \(\phi^4\) Theory}
...
\SupplementarySolution{8}{A Momentum-Subtracted Scalar Bubble}
...
\SupplementarySolution{9}{A Nested BPHZ Forest}
...
\SupplementarySolution{10}{Integrating Out a Thin Momentum Shell}
...
\SupplementarySolution{11}{The Shell Correction to the Quartic Coupling}
...
\SupplementarySolution{12}{Why an Infinite Action Can Still Predict}
...
\SupplementarySolution{13}{Euler--Heisenberg Power Counting}
...
\SupplementarySolution{14}{The Frequency Law of Rayleigh Scattering}
...
\SupplementarySolution{15}{Fermi Theory from a Massive Vector}
...
\SupplementarySolution{16}{Loop Power Counting in an EFT}
...
\SupplementarySolution{17}{Expansion Before Integration}
...
\SupplementarySolution{18}{Scaleless Integrals and Power Counting}
For
\[
...
\SupplementarySolution{19}{Heavy-Vector Current Matching}
...
\SupplementarySolution{20}{Tree-Generated and Loop-Generated Coefficients}
...
\SupplementarySolution{21}{Infrared Physics Cancels in Matching}
...
\SupplementarySolution{22}{The Complete QED Dipole Pair}
...
\SupplementarySolution{23}{Anapoles, Charge Radii, and Equations of Motion}
...
\SupplementarySolution{24}{Decoupling Across a Mass Threshold}
...
\SupplementarySolution{25}{A Two-Region Asymptotic Integral}
...
\SupplementarySolution{26}{A Heavy Scalar and the Hierarchy Problem}
...
\SupplementarySolution{27}{Shift Symmetry as Radiative Protection}
...
\SupplementarySolution{28}{Estimating the EFT Unitarity Scale}
...
\SupplementarySolution{29}{Separating Matching from Large Logarithms}
...
\SupplementarySolution{30}{Finite Predictivity at Fixed Accuracy}
