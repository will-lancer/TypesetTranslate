...
\setcounter{figure}{2}
\begin{figure}[htbp]
\input{figures/chapter06/fig63.tex}
...
\setcounter{figure}{3}
\begin{figure}[htbp]
\input{figures/chapter06/fig64.tex}
...
\setcounter{figure}{4}
\begin{figure}[htbp]
\input{figures/chapter06/fig65.tex}
...
\setcounter{figure}{5}
\begin{figure}[htbp]
\input{figures/chapter06/fig66.tex}
...
\setcounter{figure}{6}
\begin{figure}[htbp]
\input{figures/chapter06/fig67.tex}
...
&\quad=(2\pi)^{-6}\sum_{\ell'm'k'\ell m k}
 (-i)^2 g_{\ell'm'k'}g_{\ell m k}
 u_{\ell'}^*(\mathbf p'_1\sigma'_1n'_1)
 u_\ell(\mathbf p_1\sigma_1n_1)
\notag\\
&\qquad\cdot\int d^4x\int d^4y\,
 \bigl(-i\Delta_{m'm}(y-x)\bigr)
 e^{-ip'_1\cdot y}e^{ip_1\cdot x}
\notag\\
&\qquad\cdot\Bigl[
 e^{-ip'_2\cdot y}u_{k'}^*(\mathbf p'_2\sigma'_2n'_2)
 e^{ip_2\cdot x}u_k(\mathbf p_2\sigma_2n_2)
\notag\\
&\hspace{77mm}+
 e^{-ip'_2\cdot x}u_k^*(\mathbf p'_2\sigma'_2n'_2)
 e^{ip_2\cdot y}u_{k'}(\mathbf p_2\sigma_2n_2)
 \Bigr].
\tag{6.1.27}
\label{eq:6.1.27}
\end{align}
...
&\quad=(2\pi)^{-6}\sum_{k'\ell'm'k\ell m}
 (-i)^2g_{m'\ell k'}g_{\ell'mk}
 u_{m'}^*(\mathbf p'_2\sigma'_2n'_2)
 u_{\ell'}^*(\mathbf p'_1\sigma'_1n'_1)
 u_m(\mathbf p_2\sigma_2n_2)u_\ell(\mathbf p_1\sigma_1n_1)
\notag\\
&\qquad\cdot\int d^4x\int d^4y\,
 e^{-ip'_2\cdot x}e^{-ip'_1\cdot y}
 e^{ip_2\cdot x}e^{ip_1\cdot y}
 \bigl(-i\Delta_{k'k}(x-y)\bigr)
 -[1'\rightleftarrows2'].
\tag{6.1.28}
\label{eq:6.1.28}
\end{align}
...
\setcounter{figure}{7}
\begin{figure}[htbp]
\input{figures/chapter06/fig68.tex}
...
&\quad=(-i)^2(2\pi)^{-6}
 ...
 \int d^4x\int d^4y\,
 \bigl(-i\Delta_{\ell''m''}(x,y)\bigr)
\notag\\
&\qquad\cdot\Bigl[
 u_\ell^*(\mathbf p'_1\sigma'_1n'_1)e^{-ip'_1\cdot x}
 u_{\ell'}^*(\mathbf p'_2\sigma'_2n'_2)e^{-ip'_2\cdot x}
 u_m(\mathbf p_1\sigma_1n_1)e^{ip_1\cdot y}
 u_{m'}(\mathbf p_2\sigma_2n_2)e^{ip_2\cdot y}
\notag\\
&\qquad\quad+
 u_\ell^*(\mathbf p'_1\sigma'_1n'_1)e^{-ip'_1\cdot x}
 u_{\ell'}(\mathbf p_1\sigma_1n_1)e^{ip_1\cdot x}
 u_{m'}^*(\mathbf p'_2\sigma'_2n'_2)e^{-ip'_2\cdot y}
 u_m(\mathbf p_2\sigma_2n_2)e^{ip_2\cdot y}
\notag\\
&\qquad\quad+
 u_\ell^*(\mathbf p'_2\sigma'_2n'_2)e^{-ip'_2\cdot x}
 u_{\ell'}(\mathbf p_1\sigma_1n_1)e^{ip_1\cdot x}
 u_{m'}^*(\mathbf p'_1\sigma'_1n'_1)e^{-ip'_1\cdot y}
 u_m(\mathbf p_2\sigma_2n_2)e^{ip_2\cdot y}
 \Bigr].
\tag{6.1.30}
\label{eq:6.1.30}
...
={}&\frac{ig^2}{(2\pi)^6\sqrt{16E'_1E'_2E_1E_2}}
 \int d^4x\int d^4y\,\Delta_F(x-y)
\notag\\
&\cdot\Bigl[
 \exp\bigl(-i(p'_1+p'_2)\cdot x\bigr)
 \exp\bigl(i(p_1+p_2)\cdot y\bigr)
\notag\\
&\qquad+
 \exp\bigl(i(p_1-p'_1)\cdot x\bigr)
 \exp\bigl(i(p_2-p'_2)\cdot y\bigr)
\notag\\
&\qquad+
 \exp\bigl(i(p_1-p'_2)\cdot x\bigr)
 \exp\bigl(i(p_2-p'_1)\cdot y\bigr)
 \Bigr],
\end{align*}
