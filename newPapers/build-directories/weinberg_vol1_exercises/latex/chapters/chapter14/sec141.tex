...
\begin{equation}
  ...
  =\ii\gamma^0\delta^3(\mathbf x-\mathbf y).
...
\begin{equation}
  u_N(\mathbf x,t)=e^{-\ii E_Nt}u_N(\mathbf x),\qquad
  v_N(\mathbf x,t)=e^{+\ii E_Nt}v_N(\mathbf x).
  \tag{14.1.9}\label{eq:14.1.9}
\end{equation}
The homogeneous Dirac equations \eqref{eq:14.1.6} then become
\begin{equation}
  \ii\gamma^0\left[\boldsymbol\gamma\cdot\boldsymbol\nabla+m
...
\[
  ...
  =\boldsymbol\nabla\cdot(u_N^\dagger \ii\gamma^0\boldsymbol\gamma u_M),
\]
so if $|\mathbf x|^2(u_N^\dagger \ii\gamma^0\boldsymbol\gamma u_M)$ remains
bounded as $|\mathbf x|\to0$ and $|\mathbf x|\to\infty$, then
\begin{equation}
  \int \dd^3x\,(u_N^\dagger(\mathbf x)u_M(\mathbf x))=0
  \quad\text{if}\quad E_N\ne E_M^*.
  \tag{14.1.12}\label{eq:14.1.12}
\end{equation}
With similar boundary conditions for the $v_N$, we find in the same way that
\begin{equation}
  \int \dd^3x\,(v_N^\dagger(\mathbf x)v_M(\mathbf x))=0
  \quad\text{if}\quad E_N\ne E_M^*,
  \tag{14.1.13}\label{eq:14.1.13}
\end{equation}
\begin{equation}
  \int \dd^3x\,(u_N^\dagger(\mathbf x)v_M(\mathbf x))=0
  \quad\text{if}\quad E_N\ne-E_M^*.
...
arrange that
\begin{equation}
  \int \dd^3x\,(u_N^\dagger(\mathbf x)u_M(\mathbf x))=0\quad\text{if}\quad N\ne M,
  \tag{14.1.15}\label{eq:14.1.15}
\end{equation}
\begin{equation}
  \int \dd^3x\,(v_N^\dagger(\mathbf x)v_M(\mathbf x))=0\quad\text{if}\quad N\ne M,
...
\begin{equation}
  \int \dd^3y\,(u_N^\dagger(\mathbf y)u_M(\mathbf y))
  =\int \dd^3y\,(v_N^\dagger(\mathbf y)v_M(\mathbf y))=\delta_{NM},
...
\[
  \boldsymbol\gamma=\ii\begin{pmatrix}0&-\boldsymbol\sigma\\
  \boldsymbol\sigma&0\end{pmatrix},\qquad
  \ii\gamma^0=\beta=\begin{pmatrix}0&\mathbf{1}\\\mathbf{1}&0\end{pmatrix},
\]
...
equations
\begin{equation}
  \frac{\dd G}{\dd r}+\frac{k+1}{r}G+(E+e\mathcal A^0-m)F=0,
  \tag{14.1.28}\label{eq:14.1.28}
\end{equation}
\begin{equation}
  \frac{\dd F}{\dd r}-\frac{k-1}{r}F-(E+e\mathcal A^0+m)G=0,
...
\begin{equation}
  ...
  \begin{bmatrix}(1+\ii\boldsymbol\sigma\cdot\boldsymbol\nabla/2m)f_N\\
  (1-\ii\boldsymbol\sigma\cdot\boldsymbol\nabla/2m)f_N\end{bmatrix}
  \tag{14.1.37}\label{eq:14.1.37}
\end{equation}
and Eq.~\eqref{eq:14.1.18} gives the normalization condition
\begin{equation}
  \int \dd^3x\,(f_N^\dagger f_M)\simeq\delta_{NM}-\frac14(v^2)_{NM},
  \tag{14.1.38}\label{eq:14.1.38}
\end{equation}
where
\[
  (v^2)_{NM}\equiv-\frac1{m_e^2}\int \dd^3x\,
...
\begin{equation}
  u_N(\mathbf p)\equiv(2\pi)^{-3/2}\int \dd^3p\,
  e^{-\ii\mathbf p\cdot\mathbf x}u_N(\mathbf x)
...
\[
  f_N(\mathbf p)\equiv(2\pi)^{-3/2}\int \dd^3p\,
  e^{-\ii\mathbf p\cdot\mathbf x}f_N(\mathbf x).
\]
...
\end{equation}
\begin{equation}
 \ii(\bar u_M\gamma^0u_N)\simeq(f_M^\dagger f_N)
 +\frac1{4m_e^2}(\boldsymbol\nabla f_M^\dagger\cdot\boldsymbol\sigma\,
 \boldsymbol\sigma\cdot\boldsymbol\nabla f_N),
...
\end{equation}
\begin{equation}
 (\bar u_M[\gamma^0,\gamma^i]u_N)\simeq\frac{\ii}{m_e}
 \left[(\boldsymbol\nabla f_M^\dagger\cdot\boldsymbol\sigma\,\sigma_i f_N)
 +(f_M^\dagger\sigma_i\boldsymbol\sigma\cdot\boldsymbol\nabla f_N)\right],
...
\begin{equation}
 ...
 2\ii\epsilon_{ijk}(f_M^\dagger\sigma_kf_N),
 \tag{14.1.44}\label{eq:14.1.44}
\end{equation}
\begin{equation}
 (\bar u_M\gamma_5\gamma^iu_N)\simeq-\ii(f_M^\dagger\sigma_if_N),
...
\end{equation}
\begin{equation}
 (\bar u_M\gamma_5u_N)\simeq\frac{\ii}{2m_e}
 \left[(\boldsymbol\nabla f_M^\dagger\cdot\boldsymbol\sigma f_N)
 +(f_M^\dagger\boldsymbol\sigma\cdot\boldsymbol\nabla f_N)\right].
