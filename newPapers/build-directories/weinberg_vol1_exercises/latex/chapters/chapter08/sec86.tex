...
\begin{equation}
\frac{-\ii}{(2\pi)^4}
\frac{[-\ii\sl{k}+m]_{\alpha\beta}}{k^2+m^2-\ii\epsilon}.
...
a radius parameter $\kappa$ is $\pi^2\kappa^2\dd\kappa^2$, so each loop
...
=\left(\frac{-\ii\sl{p}+m}{2p^0}\right)_{\alpha\beta},
...
\left(\frac{-\ii\sl{p'}-m}{2p'^0}\right)
\mathcal M
\left(\frac{-\ii\sl{p}+m}{2p^0}\right)
\right\}.
\end{align*}
