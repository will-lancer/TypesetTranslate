...
={}&-\int \dd\gamma\,T_{\gamma\beta}^{\mathrm{in/out}\,*}T_{\gamma\alpha}^{\mathrm{in/out}}
\nonumber\\
&\quad\cdot\left([E_\alpha-E_\gamma\pm \ii\epsilon]^{-1}
-[E_\beta-E_\gamma\mp \ii\epsilon]^{-1}\right).
\tag{3.2.9}\label{eq:3.2.9}
\end{align}
To prove the orthonormality of the `in' and `out' states, divide Eq.~\eqref{eq:3.2.9}
by $E_\alpha-E_\beta\pm2\ii\epsilon$. This gives
\begin{align*}
\left(\frac{T_{\alpha\beta}^{\mathrm{in/out}}}{E_\beta-E_\alpha\mp2\ii\epsilon}\right)^*
+\frac{T_{\beta\alpha}^{\mathrm{in/out}}}{E_\alpha-E_\beta\pm2\ii\epsilon}
={}&-\int \dd\gamma\,
\left(\frac{T_{\gamma\beta}^{\mathrm{in/out}}}{E_\beta-E_\alpha\mp \ii\epsilon}\right)^*
\frac{T_{\gamma\alpha}^{\mathrm{in/out}}}{E_\alpha-E_\beta\pm \ii\epsilon}.
\end{align*}
...
\pm \ii\epsilon)$ is unitary. With \eqref{eq:3.1.17}, this is just the statement that the
...
$\delta(E_\beta-E_\alpha)$ instead of $(E_\alpha-E_\beta\pm2\ii\epsilon)^{-1}$.
...
=-2\pi \ii M_{\beta\alpha}\delta^4(p_\beta-p_\alpha).
...
\begin{align}
[J_0^i,J_0^j]&=\ii\epsilon_{ijk}J_0^k, &&\tag{3.3.4}\label{eq:3.3.4}\\
[J_0^i,K_0^j]&=\ii\epsilon_{ijk}K_0^k, &&\tag{3.3.5}\label{eq:3.3.5}\\
[K_0^i,K_0^j]&=-\ii\epsilon_{ijk}J_0^k, &&\tag{3.3.6}\label{eq:3.3.6}\\
[J_0^i,P_0^j]&=\ii\epsilon_{ijk}P_0^k, &&\tag{3.3.7}\label{eq:3.3.7}\\
[K_0^i,P_0^j]&=\ii H_0\delta_{ij}, &&\tag{3.3.8}\label{eq:3.3.8}\\
[J_0^i,H_0]&=[P_0^i,H_0]=[P_0^i,P_0^j]=0, &&\tag{3.3.9}\label{eq:3.3.9}\\
[K_0^i,H_0]&=\ii P_0^i. &&\tag{3.3.10}\label{eq:3.3.10}
\end{align}
...
\begin{align}
[J^i,J^j]&=\ii\epsilon_{ijk}J^k, &&\tag{3.3.11}\label{eq:3.3.11}\\
[J^i,K^j]&=\ii\epsilon_{ijk}K^k, &&\tag{3.3.12}\label{eq:3.3.12}\\
[K^i,K^j]&=-\ii\epsilon_{ijk}J^k, &&\tag{3.3.13}\label{eq:3.3.13}\\
[J^i,P^j]&=\ii\epsilon_{ijk}P^k, &&\tag{3.3.14}\label{eq:3.3.14}\\
[K^i,P^j]&=\ii H\delta_{ij}, &&\tag{3.3.15}\label{eq:3.3.15}\\
[J^i,H]&=[P^i,H]=[P^i,P^j]=0, &&\tag{3.3.16}\label{eq:3.3.16}\\
[K^i,H]&=\ii P^i. &&\tag{3.3.17}\label{eq:3.3.17}
\end{align}
...
\[
[\mathbf{K}_0,\exp(\ii H_0t)]=-t\mathbf{P}_0\exp(\ii H_0t)
\]
while Eq.~\eqref{eq:3.3.21} (which is equivalent to Eq.~\eqref{eq:3.3.17}) yields
\[
[\mathbf{K},\exp(\ii Ht)]=-t\mathbf{P}\exp(\ii Ht)
=-t\mathbf{P}_0\exp(\ii Ht).
\]
...
where
\begin{equation}
\mathbf{W}(t)=\exp(\ii H_0t)\mathbf{W}\exp(-\ii H_0t).
