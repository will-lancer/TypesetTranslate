...
$\int \dd\alpha\,g(\alpha)\InKet{\alpha}\exp(-\ii E_\alpha t)$ of `in'
states has a time-dependence given by \eqref{eq:3.1.19}
\[
  \int \dd\alpha\,g(\alpha)\InKet{\alpha}e^{-\ii E_\alpha t}
  =\int \dd\alpha\,g(\alpha)\ket{\alpha}_0e^{-\ii E_\alpha t}
  +\int \dd\beta\,\ket{\beta}_0\int \dd\alpha\,
   \frac{e^{-\ii E_\alpha t}g(\alpha)T^+_{\beta\alpha}}
...
at $E_\alpha=E_R-\ii\Gamma/2$ yields a term in the \emph{amplitude} that behaves
like $\exp(-\ii E_Rt-\Gamma t/2)$, so it corresponds to a state whose
...
\begin{equation}
  T^+_{\beta\alpha}\sim(E_\alpha-E_R+\ii\Gamma/2)^{-1}+\text{constant}.
...
\begin{equation}
  ...
  =\mathcal S_{0N'N}+\frac{\mathcal R_{N'N}}{E-E_R+\ii\Gamma/2},
...
\end{equation}
\begin{equation}
  -\frac{\ii}{2}\Gamma\mathcal S_0^\dagger\mathcal R
  +\frac{\ii}{2}\Gamma\mathcal R^\dagger\mathcal S_0
  +\mathcal R^\dagger\mathcal R=0.
  \tag{3.8.7}\label{eq:3.8.7}
\end{equation}
These conditions can be put in a more transparent form by setting
\begin{equation}
  \mathcal R\equiv-\ii\Gamma\mathcal A\mathcal S_0.
...
\begin{equation}
  ...
  \left[\delta_{N'N''}-\ii\frac{\Gamma}{E-E_R+\ii\Gamma/2}
...
\begin{align}
  ...
  &\quad-\ii\frac{\Gamma}{E-E_R+\ii\Gamma/2}
...
\begin{equation}
  ...
  -\ii\delta_{jj_R}\frac{\Gamma}{E-E_R+\ii\Gamma/2}
...
\[
  \exp[2\ii\delta^{(r)}(E)]
  =1-\ii\frac{\Gamma}{E-E_R+\ii\Gamma/2}
\]
or, in other words,
\begin{equation}
...
\[
  \mathcal S_{0N'N}=\exp(2\ii\delta_{0N})\delta_{N'N}
\]
...
\[
  \mathcal S_{N'N}(E)=\delta_{N'N}
   \left[1-\frac{\ii\Gamma}{E-E_R+\ii\Gamma/2}\right]
   \exp(2\ii\delta_{0N})
  \equiv\delta_{N'N}\exp[2\ii\delta_N(E)]
\]
