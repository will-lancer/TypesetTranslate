...
\begin{align}
&\int \dd^4x_1\,\dd^4x_2\cdots \dd^4x_N\,
e^{-\ii q_1\cdot x_1}e^{-\ii q_2\cdot x_2}\cdots e^{-\ii q_N\cdot x_N}
\notag\\
...
\[
(p'+q_1+\cdots+q_r)^2+m^2-\ii\epsilon
\to2p'\cdot(q_1+\cdots+q_r)-\ii\epsilon
\to2p\cdot(q_1+\cdots+q_r)-\ii\epsilon,
\]
...
(q_1,q_2,\ldots,q_N;p)
&\to\frac{(-\ii)^{N-1}}{2p^0(2\pi)^3}(2\pi)^4
\notag\\
...
{[2p\cdot q_1-\ii\epsilon]\!\!
[2p\cdot(q_1+q_2)-\ii\epsilon]\!\cdots
[2p\cdot(q_1+\cdots+q_{N-1})-\ii\epsilon]}
\notag\\
...
(q_1,q_2,\ldots,q_N;p)
&\to
\frac{(-\ii)^{N-1}(Ze)^N p^{\mu_1}p^{\mu_2}\cdots p^{\mu_N}}
{p^0(2\pi)^3}(2\pi)^4
\notag\\
&\quad\cdot
...
\notag\\
&\quad\cdot\Biggl[
\frac{1}{[p\cdot q_1-\ii\epsilon]
[p\cdot(q_1+q_2)-\ii\epsilon]\cdots
[p\cdot(q_1+\cdots+q_{N-1})-\ii\epsilon]}
\notag\\
...
\notag\\
&\qquad=(2\ii\pi)^{N-1}\delta(p\cdot q_1)\delta(p\cdot q_2)
\cdots\delta(p\cdot q_{N-1}).
\tag{13.6.8}\label{eq:13.6.8}
\end{align}
For instance, for $N=2$ this reads:
\begin{equation*}
\frac{1}{[p\cdot q_1-\ii\epsilon]}+\frac{1}{[p\cdot q_2-\ii\epsilon]}
=\frac{1}{[p\cdot q_1-\ii\epsilon]}+\frac{1}{[-p\cdot q_1-\ii\epsilon]}
=2\ii\pi\delta(p\cdot q_1).
\end{equation*}
...
\begin{align}
&\int \dd^3p\,\dd^3p'\,\chi^*_{\sigma'}(\mathbf p')\chi_\sigma(\mathbf p)
\notag\\
&\qquad\cdot
\mathcal G^{\mu_1\mu_2\cdots\mu_N}_{\sigma',\sigma}
(q_1,q_2,\ldots,q_N;p)
\notag\\
&\qquad\to
\int \dd^3X\sum_\sigma|\psi_\sigma(\mathbf X)|^2
\prod_{r=1}^N 2\pi Ze\,n^{\mu_r}\delta(q_r^0)e^{-\ii\mathbf q_r\cdot\mathbf X}.
\tag{13.6.11}\label{eq:13.6.11}
\end{align}
where $\psi_\sigma(\mathbf X)$ is the coordinate space wave function:
\begin{equation}
\psi_\sigma(\mathbf X)=(2\pi)^{-3/2}\int \dd^3p\,
\chi_\sigma(\mathbf p)e^{\ii\mathbf p\cdot\mathbf X}.
...
photon vertex)
\begin{align}
\ii\int \dd^4q\left[\frac{-\ii}{(2\pi)^4}\frac{1}{q^2-\ii\epsilon}\right]
\left[2\pi Ze\,n_\mu\delta(q^0)e^{-\ii\mathbf q\cdot\mathbf X}\right]
...
\begin{equation}
\mathcal A^\mu(x)=\frac{1}{(2\pi)^4}\int \dd^4q\,e^{\ii q\cdot x}
\left[\frac{2\pi Ze\,n^\mu\delta(q^0)e^{-\ii\mathbf q\cdot\mathbf X}}
{q^2-\ii\epsilon}\right].
...
\input{chapters/chapter13/figures/fig13-04.tex}
\input{chapters/chapter13/figures/fig13-05.tex}
