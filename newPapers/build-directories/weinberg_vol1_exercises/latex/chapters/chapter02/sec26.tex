...
\begin{align}
P iJ^{\rho\sigma}P^{-1}
  &=\ii\mathcal{P}_\mu{}^\rho\mathcal{P}_\nu{}^\sigma J^{\mu\nu},
  \tag{2.6.3}\label{eq:2.6.3}\\
P iP^\rho P^{-1}
  &=\ii\mathcal{P}_\mu{}^\rho P^\mu,
  \tag{2.6.4}\label{eq:2.6.4}\\
T iJ^{\rho\sigma}T^{-1}
  &=\ii\mathcal{T}_\mu{}^\rho\mathcal{T}_\nu{}^\sigma J^{\mu\nu},
  \tag{2.6.5}\label{eq:2.6.5}\\
T iP^\rho T^{-1}
  &=\ii\mathcal{T}_\mu{}^\rho P^\mu.
...
$\mathbf{r}\times\mathbf{p}$ of two vectors, both of which change sign under
...
$\mathbf{J}\times\mathbf{J}=\ii\mathbf{J}$, because $T$ reverses not only
...
\[
U(R(-\hat{\mathbf{p}}))
=\exp\bigl(\ii(\phi\pm\pi)J_3\bigr)
 \exp\bigl(\ii(\pi-\theta)J_2\bigr)
\]
...
&=\exp\bigl(-\ii(\pi-\theta)J_2\bigr)\\
&\quad\cdot\exp\bigl(-\ii(\phi\pm\pi)J_3\bigr)
\exp(\ii\phi J_3)\exp(\ii\theta J_2)\exp(-\ii\pi J_2)\\
&=\exp\bigl(-\ii(\pi-\theta)J_2\bigr)
\exp(\mp \ii\pi J_3)
\exp\bigl(-\ii(\pi-\theta)J_2\bigr).
\end{aligned}
...
=U(R(-\hat{\mathbf{p}}))\exp(\pm \ii\pi J_3).
...
\begin{equation}
P\ket{p,\sigma}
=\eta_\sigma\exp(\mp \ii\pi\sigma)\ket{\mathcal{P}p,-\sigma}
...
\begin{equation}
T\ket{p,\sigma}
=\zeta_\sigma\exp(\pm \ii\pi\sigma)\ket{\mathcal{P}p,\sigma}.
...
\begin{aligned}
T^2\ket{p,\sigma}
&=T\zeta_\sigma\exp(\pm \ii\pi\sigma)
  \ket{\mathcal{P}p,\sigma}\\
&=\zeta_\sigma^*\exp(\mp \ii\pi\sigma)
  \zeta_\sigma\exp(\mp \ii\pi\sigma)\ket{p,\sigma}\\
&=\exp(\mp2\pi \ii\sigma)\ket{p,\sigma}.
\end{aligned}
\]
