...
\begin{equation}
  \frac{\dd}{\dd s}U_{\theta}(s)
    =\ii t_aU_{\theta}(s)h^a{}_{b}\bigl(\Theta_{\theta}(s)\bigr)
      \frac{\dd\Theta^b_{\theta}(s)}{\dd s}
...
\begin{align*}
  \frac{\dd}{\dd s}\delta U
  &=\ii t_a\delta U\,h^a{}_{b}(\Theta)\frac{\dd\Theta^b}{\dd s}
    +\ii t_aU h^a{}_{b,c}(\Theta)\delta\Theta^c
      \frac{\dd\Theta^b}{\dd s}\\
  &\quad+\ii t_aU h^a{}_{b}(\Theta)\frac{d\delta\Theta^b}{\dd s},
\end{align*}
...
a bit, this gives
\begin{align}
  \frac{\dd}{\dd s}\bigl(U^{-1}\delta U\bigr)
  &=\frac{\dd}{\dd s}\bigl(\ii U^{-1}t_aU h^a{}_{b}\delta\Theta^b\bigr)
  \notag\\
  &\quad+\ii U^{-1}t_aU\delta\Theta^b\frac{\dd\Theta^c}{\dd s}
...
\begin{equation}
  h(\theta)^a{}_{b,c}
    =-f^a{}_{\dd e}h(\theta)^d{}_{b}h(\theta)^e{}_{c},
  \tag{2.B.10}\label{eq:2.B.10}
\end{equation}
where $f^a{}_{\dd e}$ is the coefficient defined by \eqref{eq:2.2.19}.
...
\begin{equation*}
  U^{-1}\delta U-\ii U^{-1}t_aU h^a{}_{b}\delta\Theta^b
\end{equation*}
...
\begin{equation*}
  \widetilde U[\theta]=e^{\ii\alpha(\theta)}U[\theta]
\end{equation*}
...
\begin{equation*}
  0=\frac{\partial}{\partial\theta^b}
    ...
    +\ii\phi_b(\theta)U[\theta]^{-1}\widetilde U[\theta],
\end{equation*}
where
\begin{equation*}
...
\end{equation*}
Thus the quantity
$U[\theta]^{-1}\widetilde U[\theta]e^{\ii\beta(\theta)}$ is actually constant
in $\theta$. Setting it equal to its value at $\theta=0$, we see that
$\widetilde U$ is just proportional to $U$:
\begin{equation*}
  \widetilde U[\theta]
    =U[\theta]\exp\bigl(-\ii\beta(\theta)+\ii\beta(0)\bigr)
\end{equation*}
as claimed above.
...
$e^{\ii\phi}$, and going around loop $\bar{\mathcal{L}}$ gives a phase factor
$e^{\ii\bar\phi}$, then going around both loops gives a phase factor
$e^{\ii\phi}e^{\ii\bar\phi}$. Hence we can catalog all the possible types of
