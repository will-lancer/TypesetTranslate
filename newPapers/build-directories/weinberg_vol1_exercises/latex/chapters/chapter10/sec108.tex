...
\begin{equation}
  ...
  \left|{}_{\mathrm{out}}\bra{\beta}J(0)^\dagger\ket{\alpha}\right|^2
  \delta^4(-p_\alpha+E\ell+p_\beta),
  \tag{10.8.17}\label{eq:10.8.17}
\end{equation}
\begin{equation}
  F_-(E)=(2\pi)^4\sum_\beta
  \left|{}_{\mathrm{out}}\bra{\beta}J(0)\ket{\alpha}\right|^2
  \delta^4(p_\alpha+E\ell-p_\beta).
