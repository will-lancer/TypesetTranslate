...
\begin{equation*}
  ...
  [\partial_\mu-\ii Z_3q_\ell A_\mu]\Psi_\ell\bigr).
\end{equation*}
...
\begin{equation}
  \bra{p',\sigma'}J^\mu(0)\ket{p,\sigma}
  =\ii q(2\pi)^{-3}\bar u(p',\sigma')\Gamma^\mu(p',p)u(p,\sigma)
  \tag{10.6.9}\label{eq:10.6.9}
\end{equation}
where $\Gamma^\mu$ is a four-vector $4\times4$ matrix function of $p'^\nu$,
$p^\nu$, and $\gamma^\nu$, and $u$ is the usual Dirac coefficient function.
We have extracted a factor $\ii q$ to make the normalization of $\Gamma^\mu$ the
same as in the previous section.

Just as for any $4\times4$ matrix, we may expand $\Gamma^\mu$ in the 16
...
\begin{equation*}
  \bar u(p',\sigma')(\ii\sl{p}'+m)=0,
  \qquad
  (\ii\sl{p}+m)u(p,\sigma)=0.
\end{equation*}
...
\]
which may be replaced with $2\ii m\gamma^\mu-2p^\mu$, a linear combination of
...
\begin{align}
  ...
  =\bar u(p',\sigma')\biggl[
  &\gamma^\mu F(k^2)-\frac{\ii}{2m}(p+p')^\mu G(k^2) \notag\\
...
\begin{equation*}
  (p'-p)_\mu\gamma^\mu
  =-\ii\bigl[(\ii\sl{p}'+m)-(\ii\sl{p}+m)\bigr]
\end{equation*}
and
\begin{equation*}
...
\begin{equation*}
  \bra{p,\sigma'}J^\mu(0)\ket{p,\sigma}
  =\ii q(2\pi)^{-3}\bar u(p,\sigma')
  \left[\gamma^\mu F(0)-\frac{\ii}{m}p^\mu G(0)\right]u(p,\sigma).
\end{equation*}
Using the identity $\{\gamma^\mu,\ii\sl{p}+m\}=2m\gamma^\mu+2\ii p^\mu$,
we also have
\begin{equation*}
  \bar u(p,\sigma')\gamma^\mu u(p,\sigma)
  =-\frac{\ii p^\mu}{m}\bar u(p,\sigma')u(p,\sigma).
\end{equation*}
Recall also that
\begin{equation*}
...
\begin{align}
  &\bar u(p',\sigma')\frac{\ii}{2}[\gamma^\mu,\gamma^\nu]
  (p'-p)_\nu u(p,\sigma) \notag\\
  &\quad=\bar u(p',\sigma')\bigl[
  -\ii\sl{p}'\gamma^\mu+\tfrac{\ii}{2}\{\gamma^\mu,\sl{p}'\}
  -\ii\gamma^\mu\sl{p}+\tfrac{\ii}{2}\{\gamma^\mu,\sl{p}\}
  \bigr]u(p,\sigma) \notag\\
  &\quad=\bar u(p',\sigma')
  [\ii(p^\mu+p'^\mu)+2m\gamma^\mu]u(p,\sigma).
...
\begin{align}
  \bar u(p',\sigma')\Gamma^\mu(p',p)u(p,\sigma)
  =-\frac{\ii}{2m}\bar u(p',\sigma')\biggl[&
  (p+p')^\mu\{F(k^2)+G(k^2)\} \notag\\
...
\begin{equation*}
  ...
  =4\ii\epsilon_{ijk}(J_k^{(1/2)})_{\sigma'\sigma},
  \qquad
