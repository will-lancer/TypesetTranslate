...
only have $j=1/2$; these are the top (i.e., $\gamma^5=+1$) and bottom
($\gamma^5=-1$) two components of the Dirac spinor. A $(1/2,1/2)$ field has
...
$4\cdot4$ matrix \eqref{eq:5.4.29} provides the $\beta$-matrix for this representation.
