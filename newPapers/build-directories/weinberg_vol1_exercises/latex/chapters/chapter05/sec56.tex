...
\begin{equation}
[\mathcal{J}_i,\mathcal{J}_j]=\ii\epsilon_{ijk}\mathcal{J}_k,
\tag{5.6.4}\label{eq:5.6.4}
\end{equation}
\begin{equation}
[\mathcal{J}_i,\mathcal{K}_j]=\ii\epsilon_{ijk}\mathcal{K}_k,
\tag{5.6.5}\label{eq:5.6.5}
\end{equation}
\begin{equation}
[\mathcal{K}_i,\mathcal{K}_j]=-\ii\epsilon_{ijk}\mathcal{J}_k,
...
\begin{equation}
\mathcal{A}\equiv\frac12(\mathcal{J}+\ii\mathcal{K}),
\tag{5.6.7}\label{eq:5.6.7}
\end{equation}
\begin{equation}
\mathcal{B}\equiv\frac12(\mathcal{J}-\ii\mathcal{K}).
\tag{5.6.8}\label{eq:5.6.8}
\end{equation}
It is easy to see that the commutation relations \eqref{eq:5.6.4}--\eqref{eq:5.6.6} are
equivalent to
\begin{equation}
[\mathcal{A}_i,\mathcal{A}_j]=\ii\epsilon_{ijk}\mathcal{A}_k,
\tag{5.6.9}\label{eq:5.6.9}
\end{equation}
\begin{equation}
[\mathcal{B}_i,\mathcal{B}_j]=\ii\epsilon_{ijk}\mathcal{B}_k,
...
\end{equation}
\begin{equation}
(\mathbf J_1^{(A)}\mathbin{\pm}\ii\mathbf J_2^{(A)})_{a'a}
...
\[
F^{\mu\nu}=\mathbin{\pm}\frac{\ii}{2}\epsilon^{\mu\nu\lambda\rho}F_{\lambda\rho}
\]
