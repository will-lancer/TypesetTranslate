...
\begin{equation}
  \phi^{(+)\mu}(x)=\sum_\sigma(2\pi)^{-3/2}\int d^3p\,
  u^\mu(\mathbf{p},\sigma)a_{\mathbf{p},\sigma}e^{ip\cdot x},
  \tag{5.3.2}\label{eq:5.3.2}
\end{equation}
\begin{equation}
  \phi^{(-)\mu}(x)=\sum_\sigma(2\pi)^{-3/2}\int d^3p\,
  v^\mu(\mathbf{p},\sigma)a^\dagger_{\mathbf{p},\sigma}e^{-ip\cdot x}.
...
\end{equation}
\begin{equation}
  (\mathcal{J}_k)^i{}_j=-i\epsilon_{ijk},
...
values:
\[
  u^0(0)=i(m/2)^{1/2},\qquad v^0(0)=-i(m/2)^{1/2}.
\]
...
\begin{equation}
  u^\mu(\mathbf{p})=ip^\mu(2p^0)^{-1/2}
  \tag{5.3.16}\label{eq:5.3.16}
\end{equation}
and
\begin{equation}
  v^\mu(\mathbf{p})=-ip^\mu(2p^0)^{-1/2}.
...
effect of the raising and lowering operators $J^{(1)}_1\pm iJ^{(1)}_2$ on
$u$ and $v$. This gives:
\begin{equation}
  u^\mu(0,+1)=-v^\mu(0,-1)
  =-\frac{1}{\sqrt2}(2m)^{-1/2}
  \begin{bmatrix}0\\1\\+i\\0\end{bmatrix},
...
\begin{equation}
  ...
  \begin{bmatrix}0\\1\\+i\\0\end{bmatrix},\quad
  e^\mu(0,-1)=\frac{1}{\sqrt2}
  \begin{bmatrix}0\\1\\-i\\0\end{bmatrix}.
...
\begin{equation}
  ...
  =(2\pi)^{-3/2}\sum_\sigma\int\frac{d^3p}{\sqrt{2p^0}}
  e^\mu(\mathbf{p},\sigma)a_{\mathbf{p},\sigma}e^{ip\cdot x}.
...
\begin{equation}
  [\phi^{(+)\mu}(x),\phi^{(-)\nu}(y)]_\mp
  =\int\frac{d^3p}{(2\pi)^3 2p^0}e^{ip\cdot(x-y)}\Pi^{\mu\nu}(\mathbf{p})
...
or in more detail
\begin{align}
  v^\mu(x)={}&(2\pi)^{-3/2}\sum_\sigma\int\frac{d^3p}{\sqrt{2p^0}}
  \left[e^\mu(\mathbf{p},\sigma)a_{\mathbf{p},\sigma}e^{ip\cdot x}
  \right.\notag\\[-2pt]
  &\left.\qquad\qquad\qquad
  +e^{\mu*}(\mathbf{p},\sigma)a^{c\dagger}_{\mathbf{p},\sigma}e^{-ip\cdot x}
  \right],
