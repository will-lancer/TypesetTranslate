...
\begin{equation}
  ...
  -\bar\psi_{\mathrm B}\bigl[\gamma_\mu(\partial^\mu+i e_{\mathrm B}A_{\mathrm B}^{\mu})
...
\end{equation}
\begin{equation}
  \mathcal L_1=-i e A_\mu\bar\psi\gamma^\mu\psi,
...
\begin{align}
  ...
  -i e(Z_2-1)A_\mu\bar\psi\gamma^\mu\psi.
