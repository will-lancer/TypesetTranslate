...
\begin{align}
Z[J]
&\equiv{}_{\mathrm{out}}\!\braket{\Omega}{\Omega}_{\mathrm{in},J} \notag\\
...
&=i\,{}_{\mathrm{out}}\!\bra{\Omega}\Phi^r(x)\ket{\Omega}_{\mathrm{in},J=0}.
\label{eq:16.1.2}
\end{align}
...
\begin{equation}
\phi_J^r(x)\equiv
\frac{{}_{\mathrm{out}}\!\bra{\Omega}\Phi^r(x)\ket{\Omega}_{\mathrm{in},J}}
{{}_{\mathrm{out}}\!\braket{\Omega}{\Omega}_{\mathrm{in},J}}
