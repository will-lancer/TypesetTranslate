% Source: physical PDF pp. 91--95 (printed pp. 68--72). Coverage: Section 16.2 heading through the fermionic-determinant paragraph before Section 16.3; Eqs. (16.2.1)--(16.2.16), all intervening displays, Fig. 16.1, one citation, and one footnote. Corrected erratum: the mass in Eq. (16.2.11) is squared, consistently with Eqs. (16.2.5), (16.2.10), and (16.2.12).
...
\begin{equation}
 I[\phi] = -\int \dd^4x\left[\lambda+\frac{1}{2}\partial_\rho\phi\partial^\rho\phi
...
\input{chapters/chapter16/figures/fig16-01.tex}

\begin{equation}
 \mathcal{V}_4 = \int \dd^4x = \delta^4(p-p)(2\pi)^4
 \tag{16.2.2}
 \label{eq:16.2.2}
\end{equation}
...
\begin{align}
 ...
 -\left[m^2\phi_0+\frac{1}{6}g\phi_0^3\right]\int \dd^4x\,\phi \notag\\
 &-\int \dd^4x\left[\frac{1}{2}\partial_\rho\phi\partial^\rho\phi
 +\frac{1}{2}\mu^2(\phi_0)\phi^2\right]
 -\int \dd^4x\left[\frac{1}{6}g\phi_0\phi^3+\frac{1}{24}g\phi^4\right] ,
 \tag{16.2.4}
 \label{eq:16.2.4}
\end{align}
...
\begin{equation}
 \ii\Gamma^{(0\ \mathrm{loop})}[\phi_0]
 = -\ii\mathcal{V}_4\left(\lambda+\frac{1}{2}m^2\phi_0^2+\frac{g}{24}\phi_0^4\right) .
 \tag{16.2.6}
 \label{eq:16.2.6}
\end{equation}
...
\begin{align}
 \exp\left(\ii\Gamma^{(1\ \mathrm{loop})}[\phi_0]\right)
 = \int\prod_x \dd\phi(x)\exp\Biggl\{&-\frac{1}{2}\ii\int \dd^4x
...
given by Eq.~(9.A.18):
\begin{equation}
 \ii\Gamma^{(1\ \mathrm{loop})}[\phi_0]
 = \ln\operatorname{Det}\left(\frac{\ii K}{\pi}\right)^{-1/2}
 = -\frac{1}{2}\operatorname{Tr}\ln\left(\frac{\ii K}{\pi}\right) ,
 \tag{16.2.8}
 \label{eq:16.2.8}
\end{equation}
where here
\begin{equation}
 ...
 +\mu^2(\phi_0)-\ii\epsilon\right]\delta^4(x-y) .
 \tag{16.2.9}
 \label{eq:16.2.9}
\end{equation}
...
\begin{align}
 K_{p,q} &= \int\frac{\dd^4x}{(2\pi)^2}e^{-\ii p\cdot x}
 \frac{\dd^4y}{(2\pi)^2}e^{\ii q\cdot y}K_{x,y} \notag\\
 &= \left(p^2+\mu^2(\phi_0)-\ii\epsilon\right)\delta^4(p-q) .
 \tag{16.2.10}
 \label{eq:16.2.10}
\end{align}
...
\begin{equation}
 \left[\ln\left(\frac{\ii K}{\pi}\right)\right]_{p,q}
 = \ln\left[\frac{\ii}{\pi}\left(p^2+\mu^2(\phi_0)-\ii\epsilon\right)\right]\delta^4(p-q)
 \tag{16.2.11}
 \label{eq:16.2.11}
\end{equation}
...
\begin{align}
 \ii\Gamma^{(1\ \mathrm{loop})}[\phi_0]
 &= -\frac{1}{2}\int \dd^4p\left[\ln\left(\frac{\ii K}{\pi}\right)\right]_{p,p} \notag\\
 &= -\frac{\mathcal{V}_4}{2(2\pi)^4}\int \dd^4p\,
 \ln\left(\frac{\ii}{\pi}\left(p^2+\mu^2(\phi_0)-\ii\epsilon\right)\right) .
 \tag{16.2.12}
 \label{eq:16.2.12}
\end{align}
...
where
\begin{equation}
 \mathcal{I}(\mu^2) \equiv -\frac{\ii}{2(2\pi)^4}\int \dd^4p\,
 \ln\left(\frac{\ii}{\pi}\left[p^2+\mu^2-\ii\epsilon\right]\right) .
 \tag{16.2.14}
 \label{eq:16.2.14}
\end{equation}
...
\[
 \mathcal{I}'''(\mu^2) = -\frac{\ii}{(2\pi)^4}\int \dd^4p\,
 \left(p^2+\mu^2-\ii\epsilon\right)^{-3} .
\]
Once again, the $-\ii\epsilon$ term tells us that we must rotate the $p^0$ contour
counterclockwise, so that $p^0=\ii p_4$, with $p_4$ running from $-\infty$ to $+\infty$:
\[
 \mathcal{I}'''(\mu^2) = \frac{1}{(2\pi)^4}\int_0^\infty
 \frac{2\pi^2 k^3\,\dd k}{(k^2+\mu^2)^3} = \frac{1}{32\pi^2\mu^2} .
\]
