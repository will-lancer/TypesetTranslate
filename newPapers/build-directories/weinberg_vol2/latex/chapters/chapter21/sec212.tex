...
\begin{equation*}
 \ii\sum_{nma}\partial_\mu\phi'_n
 t^a_{nm}A_a^\mu v_m,
\end{equation*}
...
\begin{equation}
 B[f]=\exp\left(
 -\frac{\ii}{2\xi}\int \dd^4x\sum_a f_a f_a
 \right).
...
\end{equation}
(The factor $\gamma_4\equiv \ii\gamma^0$ arises from the definition
...
the propagator of this field is $\mathcal D^{-1}(\ii k)$. This gives the
propagators:
\begin{equation}
 A:\quad
 \Delta_{a\mu,b\nu}(k)
...
\begin{equation}
 \psi:\quad
 \Delta(k)=\frac{-\ii\sl{k}+m}{k^2+m^2},
