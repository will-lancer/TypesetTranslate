...
\begin{equation}
S[A]\geq\frac18\left|
\epsilon^E_{ijkl}\int F_{a ij}F_{a kl}\,d^4x
\right|
=|\mathcal I[g]|/3N,
...
\begin{equation}
S[A]\equiv\frac14\int F_{a ij}F_{a ij}\,d^4x.
...
sign), we also have
\begin{equation}
\epsilon^E_{ijkl}\int F_{a ij}F_{a kl}\,d^4x=64\pi^2.
