...
&=g-\frac{3g^2}{32\pi^2}\int_0^1\dd x
...
\begin{equation}
g_\mu=g_R+\frac{3g_R^2}{32\pi^2}\int_0^1\dd x
...
\begin{equation}
\mu\frac{\dd}{\dd\mu}g_\mu=\beta\left(g_\mu,\frac{m}{\mu}\right),
...
\begin{equation}
\mu\frac{\dd}{\dd\mu}g_\mu=\beta(g_\mu,0)\equiv\beta(g_\mu),
...
\begin{equation}
\ln(E/M)=\int_{g_M}^{g_E}\frac{\dd g}{\beta(g)}
...
\[
g_{\mu'}=g_\mu-\frac{3g_\mu^2}{32\pi^2}\int_0^1\dd x
...
\begin{equation}
\beta\left(g_\mu,\frac{m}{\mu}\right)
=+\frac{3g_\mu^2}{16\pi^2}\int_0^1\dd x
...
\begin{equation}
B(g)=-\frac{3}{2}\left[-\ii(2\pi)^4g^2\right]
\left\{\left[\frac{-\ii}{(2\pi)^4}\right]^2 2\pi^2\ii\right\}
=\frac{3g^2}{16\pi^2}.
...
order
\[
\mu\frac{\dd}{\dd\mu}g_\mu-B(g_\mu)=0
\]
...
\[
\int_\mu^\infty k^{d-4}\frac{\dd k}{k}
=\frac{\mu^{d-4}}{4-\dd}
\underset{\dd\to4}{\longrightarrow}
\left[\frac{1}{4-\dd}-\ln\mu\right].
\]
...
\begin{equation}
g=g_\mu+B(g_\mu)\left[\frac{1}{4-\dd}-\ln\mu\right]
...
\begin{equation}
\mu\frac{\dd}{\dd\mu}N_\mu^{(\mathcal O)}
...
\left(g_\mu,\frac{m}{\mu}\right)\frac{\dd\mu}{\mu}\right].
...
&=1+\frac{g_\mu}{32\pi^2}\int_0^1\dd x
\ln\left[\frac{m^2+\mu^2x(1-x)}{m^2+\mu'^2x(1-x)}\right]
+O(g_\mu^2).
\end{aligned}
\]
...
\frac{\mu^2x(1-x)}{m^2+\mu^2x(1-x)}\,\dd x+O(g_\mu^2)
\]
or for $\mu\gg m$,
\begin{equation}
...
&=1-\frac{e_\mu^2}{4\pi^2}\int_0^1\dd x\,x(1-x)
\ln\left[\frac{m^2+\mu'^2x(1-x)}{m^2+\mu^2x(1-x)}\right]
+O(e_\mu^4)
...
\begin{equation}
\gamma^{(A)}(e_\mu,m/\mu)
=-\frac{e_\mu^2}{2\pi^2}\int_0^1\dd x\,
...
&=1-\frac{e_R^2}{4\pi^2}\int_0^1\dd x\,x(1-x)
...
take $N_\mu^\phi=1$.}
\begin{equation}
\mu\frac{\dd g_\mu}{\dd\mu}=\frac{3g_\mu^2}{16\pi^2}.
