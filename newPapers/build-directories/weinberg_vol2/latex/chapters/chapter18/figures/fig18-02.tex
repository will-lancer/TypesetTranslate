...
\begin{figure}[htbp]
 ...
 \caption{A class of Feynman diagrams for the matrix element of the operator $\int \dd^4x\,\exp(-\ii p\cdot x)\,\phi^2(x)$ that exhibit an ultraviolet divergence. The notation is the same as in Figure~\ref{fig:18.1}.}
 \label{fig:18.2}
\end{figure}
