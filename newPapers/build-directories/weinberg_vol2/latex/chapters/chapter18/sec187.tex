...
In the approximation where the quark masses may be regarded as negligible compared with the energies of interest, the inversion of Eq.~(17.5.44) shows that the bare coupling constant in a general gauge theory has a pole at spacetime dimensionality $\dd\to4$ with residue given by
\[
g_B\longrightarrow
\left[
...
\begin{equation}
\mu\frac{\dd}{\dd\mu}g(\mu)=-\frac{g^3(\mu)}{4\pi^2}\left(\frac{11}{4}-\frac{1}{6}n_f\right).
