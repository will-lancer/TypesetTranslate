...
\begin{figure}[htbp]
  ...
  \caption{One-loop Feynman diagrams for the term in the quantum effective action that is quartic in a constant background gauge field $A^\mu_a$. Here solid lines represent internal gauge, ghost, or matter lines; dashed lines indicate factors of $A^\mu_a$. These three diagrams correspond to the three terms in Eq.~\eqref{eq:17.5.20}.}
  \label{fig:17.1}
\end{figure}
