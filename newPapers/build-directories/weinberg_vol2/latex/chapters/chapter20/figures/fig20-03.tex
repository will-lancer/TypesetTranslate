...
\begin{figure}[htbp]
 ...
 \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
  ...
  % The diagonal gauge-boson line that carries the chain of vacuum-polarization
  % bubbles. The domain endpoints are where the line y=-0.205x meets the
  % fermion ellipse, so the gauge line terminates on the loop at both ends.
  \draw[line width=0.8pt,smooth,samples=190,domain=-4.308:4.308]
   plot (\x,{-0.205*\x+0.075*sin(940*(\x+4.308))});
