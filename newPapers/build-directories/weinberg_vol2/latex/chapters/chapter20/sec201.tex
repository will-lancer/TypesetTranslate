...
\begin{equation}
 \int \dd^4x\,e^{-\ii k\cdot x}A(x)B(0)
 \longrightarrow \sum_C V_C^{AB}(k)C(0)
 \tag{20.1.2}\label{eq:20.1.2}
\end{equation}
and correspondingly
\begin{equation}
 \int \dd^4x\,e^{-\ii k\cdot x}T\{A(x)B(0)\}
...
\begin{align}
 ...
 \notag\\
 &\qquad={}
 \int\left[\prod_{\ell,z}\dd\phi_\ell(z)\right]
...
be written as
\begin{equation}
 I=\int_{z\in B(R)}\dd^4z\,\mathcal L(z)
  +\int_{z\notin B(R)}\dd^4z\,\mathcal L(z).
...
\begin{align}
 ...
 \notag\\
 &\quad={}
 \int\left[\prod_{\substack{z\notin B(R)\\ \ell}}\dd\phi_\ell(z)\right]
 b_1(y_1)b_2(y_2)\cdots
 \exp\left(\ii\int_{z\notin B(R)}\mathcal L(z)\right)
 \notag\\
 &\qquad{}\cdot
 \int\left[\prod_{\substack{z\in B(R)\\ \ell}}\dd\phi_\ell(z)\right]
 a_1(x_1)a_2(x_2)\cdots
 \exp\left(\ii\int_{z\in B(R)}\mathcal L(z)\right),
...
\begin{align}
 ...
 \exp\left(\ii\int\mathcal L(z)\right)
 \cdot\sum_O
