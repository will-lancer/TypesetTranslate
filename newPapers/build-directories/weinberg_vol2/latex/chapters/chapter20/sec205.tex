...
\Delta_+(x;\mu^2)\equiv
\frac{1}{(2\pi)^3}
\int \dd^4p\,\theta(p^0)\delta(p^2+\mu^2)e^{\ii p\cdot x}.
...
\notag\\
&-\frac{\eta_{\mu\nu}}{4\pi^2x^2}
\int \dd\mu^2\,\rho_{ab}^{(0)}(\mu^2)\mu^2
\notag\\
&+\frac{x_\mu x_\nu}{2\pi^2(x^2)^2}
\int \dd\mu^2
\left(
...
\begin{equation}
\sum_{ab}c_{ab}
\int \dd\mu^2\,\rho_{ab}^{(1)}(\mu^2)=0
\tag{20.5.7}\label{eq:20.5.7}
\end{equation}
and
\begin{equation}
\sum_{ab}c_{ab}
\int \dd\mu^2\,\rho_{ab}^{(0)}(\mu^2)\mu^2=0.
...
=\frac{\ii F_{a r}p_B^\mu}{(2\pi)^{3/2}\sqrt{2p_B^0}}.
...
\begin{equation}
J_{La}^\mu(x)
=-\ii\bar\psi(x)\gamma^\mu(1+\gamma_5)\lambda_a\psi(x),
\qquad
J_{Ra}^\mu(x)
=-\ii\bar\psi(x)\gamma^\mu(1-\gamma_5)\lambda_a\psi(x),
...
\begin{equation}
J_{Va}^\mu=-\ii\bar\psi\gamma^\mu\lambda_a\psi,
\qquad
J_{Aa}^\mu=-\ii\bar\psi\gamma^\mu\gamma_5\lambda_a\psi,
...
=\frac{\ii F\delta_{ab}p_B^\mu}{(2\pi)^{3/2}\sqrt{2p_B^0}},
