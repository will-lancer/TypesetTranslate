...
\begin{equation}
  \frac{\dd^2x^\mu}{\dd t^2}
  +\sum_{\sigma,\nu}\Gamma^\mu{}_{\sigma\nu}
  \frac{\dd x^\sigma}{\dd t}\frac{\dd x^\nu}{\dd t}=0.
...
given initial value of $x^\mu$ and $\dd x^\mu/\dd t$. This means that given $p\in M$ and any tangent
...
new tangent will be $S^a=(\dd t/\dd s)T^a$ and the new length will be
\begin{equation}
  l'=\int[g_{ab}S^aS^b]^{1/2}\,\dd s
  =\int[g_{ab}T^aT^b]^{1/2}\frac{\dd t}{\dd s}\,\dd s=l.
...
\begin{equation}
  \begin{aligned}
    ...
    g_{\alpha\beta}\frac{\dd x^\alpha}{\dd t}\frac{\dd(\delta x^\beta)}{\dd t}\\
    &\qquad\qquad+\frac{1}{2}\sum_\sigma
    \frac{\partial g_{\alpha\beta}}{\partial x^\sigma}
    \delta x^\sigma\frac{\dd x^\alpha}{\dd t}\frac{\dd x^\beta}{\dd t}
    \biggr\}\,\dd t.
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
    ...
    \frac{\dd x^\alpha}{\dd t}\frac{\dd x^\lambda}{\dd t}\delta x^\beta
    \biggr\}\,\dd t\\
    ={}&\int_a^b\sum_{\alpha,\beta}\biggl\{
    -\frac{\dd}{\dd t}\left(g_{\alpha\beta}\frac{\dd x^\alpha}{\dd t}\right)
    +\frac{1}{2}\sum_\lambda
    \frac{\partial g_{\alpha\lambda}}{\partial x^\beta}
    \frac{\dd x^\alpha}{\dd t}\frac{\dd x^\lambda}{\dd t}
    \biggr\}\delta x^\beta\,\dd t.
  \end{aligned}
...
\begin{equation}
  -\sum_\alpha g_{\alpha\beta}\frac{\dd^2x^\alpha}{\dd t^2}
  -\sum_{\alpha,\lambda}\frac{\partial g_{\alpha\beta}}{\partial x^\lambda}
  \frac{\dd x^\lambda}{\dd t}\frac{\dd x^\alpha}{\dd t}
  +\frac{1}{2}\sum_{\alpha,\lambda}
  \frac{\partial g_{\alpha\lambda}}{\partial x^\beta}
  \frac{\dd x^\alpha}{\dd t}\frac{\dd x^\lambda}{\dd t}=0.
