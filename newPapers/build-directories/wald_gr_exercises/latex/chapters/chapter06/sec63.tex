...
\(\dd\rho/\dd r\leq0\) everywhere inside the body) is \(4/9\). Thus, by
...
\begin{equation}
  u^\mu=\frac{\dd x^\mu}{\dd\tau}\equiv\dot x^\mu.
...
\(r\) and \(\dot\phi=\dd\phi/\dd\tau\)) remains exactly valid in the strong field
regime.
...
\begin{equation}
  ...
  =\left.\frac{\dd^2V}{\dd r^2}\right|_{R_+}
...
\begin{equation}
  \Delta\phi=2\int_0^{1/R_0}
  \frac{\dd u}{(R_0^{-2}-2MR_0^{-3}-u^2+2Mu^3)^{1/2}}.
...
\begin{align}
  \left.\frac{\partial(\Delta\phi)}{\partial M}\right|_{M=0}
    ...
    &=2\int_0^{1/b}\frac{(b^{-3}-u^3)\,\dd u}{(b^{-2}-u^2)^{3/2}}
      =4b^{-1}.
...
\begin{equation}
  \frac{\dd t}{\dd r}=\left(1-\frac{2M}{r}\right)^{-1}
