...
\begin{equation}
  \dd s^2=-\frac{1}{t^4}\dd t^2+\dd x^2
...
\begin{equation}
  E=-g_{ab}k^a(\partial/\partial t)^b=x^2\,\dd t/\dd\lambda
...
find
\begin{equation}
  \lambda=\frac{1}{2E}\int e^{v-u}\,\dd v
...
\(\dd s^2=-y\,\dd t^2+4y^{-1}\dd y^2\).) Therefore, it should not be surprising that the
...
which implies
\begin{equation}
  (\dd t/\dd r)^2=\left(\frac{r}{r-2M}\right)^2.
...
\end{equation}
so that \(\dd r_*/\dd r=(1-2M/r)^{-1}\). We define the null coordinates \(u,v\) by
\begin{align}
  u&=t-r_*,
...
\begin{equation}
  \dd s^2=-\left(1-\frac{2M}{r}\right)\dd u\,\dd v,
...
\begin{equation}
  \dd s^2=-\frac{2Me^{-r/2M}}{r}e^{(v-u)/4M}\,\dd u\,\dd v,
...
\begin{equation}
  \dd s^2=-\frac{32M^3e^{-r/2M}}{r}\,\dd U\,\dd V.
...
Szekeres 1960),
\begin{equation}
  \dd s^2=\frac{32M^3e^{-r/2M}}{r}(-\dd T^2+\dd X^2)
