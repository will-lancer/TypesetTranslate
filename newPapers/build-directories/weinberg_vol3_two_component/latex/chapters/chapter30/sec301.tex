...
\begin{align}
  ...
  &\qquad={}
  \int\left[\prod_{n,x,\theta,\bar\theta}
      dS_n(x,\theta,\bar\theta)\right]
    \exp\bigl(iI[\bar D^2S]\bigr)
...
\begin{equation}
  ...
  =\frac12\int d^4x\sum_n
   ...
   -4\operatorname{Re}\int d^4x\,[\widetilde f(S)]_D\,.
...
\begin{equation}
  ...
  =-\frac14\int d^4x\int d^4\theta
   ...
   +2\operatorname{Re}\int d^4x\int d^4\theta\,\widetilde f(S).
