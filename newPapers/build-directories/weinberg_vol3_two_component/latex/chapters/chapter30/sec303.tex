...
single full \(\dd^4\theta\) integral, with all \(D\)s and \(\bar D\)s acting
...
\(\dd^4\theta\) integral of a functional only of the \(\Phi_n\) and/or
...
\(\Gamma[S,S^*]\) may be written as a full \(\dd^4\theta\) integral
...
as a full \(\dd^4\theta\) integral of a functional only of the \(\Phi_n\)
...
full \(\dd^4\theta\) integral---in other words the \(D\)-term---of a
