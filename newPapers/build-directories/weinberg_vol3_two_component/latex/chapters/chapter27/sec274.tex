...
% The theta^2 expansion and the same identity visibly omit D_A in the
...
\begin{equation}
  D_\mu\psi_\alpha
  \equiv\partial_\mu\psi_\alpha-i\sum_A t_A V_{A\mu}\psi_\alpha\,,
...
=i\langle D_A\rangle_{\mathrm{VAC}}\alpha_\alpha\).
...
\begin{equation}
  ...
  \\
  &-i\sum_{Anm}(t_A)_{nm}
    \bigl[-i\sigma^\mu\bar\lambda_A\bigr]_\alpha\phi_n^*\phi_m
  \\
  &+\frac1{\sqrt{2}}\sum_n\left[
    (D_\nu\phi)_n^*
      (\sigma^\mu\bar\sigma^\nu\psi_n)_\alpha
...
\[
  ...
  -i\theta^2(\sigma^\mu\partial_\mu\bar\lambda_A)_\alpha(x_+)
...
\[
  ...
  \sum_{AB}h_{AB}(\phi)
  \left[
    2i\lambda_A\sigma^\mu\partial_\mu\bar\lambda_B
    -\frac12f_{A\mu\nu}f_B^{\mu\nu}
  \right.
  \\
  &\hspace{47mm}\left.
...
\[
  ...
  &\left(\theta\psi_n\right)
  \left[
    -\left(\psi_B\sigma^\mu\bar\sigma^\nu\theta\right)f_{A\mu\nu}
    -2i\left(\psi_B\theta\right)
  \right]
  \\
  &\qquad
  =\frac12\theta^2
...
\begin{equation}
  ...
  \left[
    i\bar\psi_m\bar\sigma^\mu(D_\mu\psi)_n
  ...
  &+\operatorname{Re}\sum_{nm\ell}
    \frac{\partial^3K(\phi,\phi^*)}
         {\partial\phi_n\partial\phi_m\partial\phi_\ell^*}
    \left[-i\psi_m\sigma^\mu\bar\psi_\ell\right]D_\mu\phi_n
  \\
  ...
  \left[
    +i\lambda_A\sigma^\mu(D_\mu\bar\lambda)_B
    -\frac14f_{A\mu\nu}f_B^{\mu\nu}
  ...
  &+\frac{\sqrt{2}}4\operatorname{Re}\sum_{ABn}
    ...
    \left[
      +\left(\lambda_B\sigma^\mu\bar\sigma^\nu\psi_n\right)
       f_{A\mu\nu}
      +2i\left(\lambda_B\psi_n\right)D_A
    \right].
  \end{aligned}
