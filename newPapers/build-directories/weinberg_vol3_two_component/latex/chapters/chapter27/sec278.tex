...
% Corrected duplicated scalar factors in Eqs. (27.8.1) and (27.8.4), and a
% missing plus sign in Eq. (27.8.3).
% Uncertainties: none.
...
\begin{equation}
  \begin{aligned}
    \delta\psi_\alpha
    &=-\ii\sqrt{2}\,\partial_\mu\phi\,
      (\sigma^\mu\bar\alpha)_\alpha
...
\begin{equation}
  \begin{aligned}
    ...
    &=-\ii\sqrt{2}\bar\alpha\bar\sigma^\mu D_\mu\psi
      -2\ii q\phi\bigl(\bar\alpha\bar\lambda\bigr)\,,\\
    \widetilde{\delta}\phi
    &=\sqrt{2}\bigl(\alpha\psi\bigr)\,.
  \end{aligned}
...
\begin{equation}
  \delta C=0,\qquad
  \delta\omega_\alpha=-\ii(V_\mu\sigma^\mu\bar\alpha)_\alpha,\qquad
  \delta M=-\bigl(\alpha\lambda+\bar\alpha\bar\lambda\bigr),\qquad
  \delta N=\ii\bigl(\alpha\lambda-\bar\alpha\bar\lambda\bigr)\,.
...
\begin{equation}
  \phi^\Omega=0,\qquad
  \psi_\alpha^\Omega
    =\ii\sqrt{2}(V_\mu\sigma^\mu\bar\alpha)_\alpha,\qquad
  \mathcal{F}^\Omega
