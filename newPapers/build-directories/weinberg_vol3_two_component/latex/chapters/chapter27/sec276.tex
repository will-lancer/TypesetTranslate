...
% Source notation preserved: Eq. (27.6.16) visibly uses X^* and Y^*, although
% Eqs. (27.6.5) and (27.6.13) use daggers for the corresponding adjoint
% superfields; Eq. (27.6.4) visibly has a factor 1/2 on its first D-term,
% unlike Eq. (27.6.1).
% Uncertainties: none.
...
\begin{equation}
  \mathcal{L}^{\#}
  =
  \frac12\left[\Phi^\dagger e^{-V}\Phi\right]_D
