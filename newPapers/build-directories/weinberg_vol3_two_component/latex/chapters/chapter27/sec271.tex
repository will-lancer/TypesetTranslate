...
\begin{equation}
  ...
  \\
  &-\ii\theta\sigma^\mu\bar\theta\,\partial_\mu W^A(x)
  +\frac{\ii}{\sqrt{2}}\theta^2
...
\begin{equation}
  ...
  -\ii\theta\omega^A(x)+\ii\bar\theta\bar\omega^A(x)
  -\frac{\ii}{2}\bigl(\theta^2-\bar\theta^2\bigr)M^A(x)
  -\frac12\bigl(\theta^2+\bar\theta^2\bigr)N^A(x)
  \\
  &+\theta\sigma^\mu\bar\theta\,V^A_\mu(x)
  -\ii\theta^2\bar\theta
    \left[\bar\lambda^A(x)
      -\frac{\ii}{2}\bar\sigma^\mu\partial_\mu\omega^A(x)\right]
  \\
  &+\ii\bar\theta^2\theta
    \left[\lambda^A(x)
      -\frac{\ii}{2}\sigma^\mu\partial_\mu\bar\omega^A(x)\right]
...
\begin{equation}
  ...
  V^A(x,\theta,\bar\theta)={}&
  \theta\sigma^\mu\bar\theta\,V^A_\mu(x)
  +\ii\bar\theta^2\theta\lambda^A(x)
  -\ii\theta^2\bar\theta\bar\lambda^A(x)
...
\begin{equation}
  ...
  -\ii\theta\sigma^\mu\bar\theta\,\partial_\mu\Lambda^A(x)
...
\[
  ...
  \\
  &\quad-2\ii\bar\theta^2\sum_A t_A(\theta\lambda^A(x))
    +2\ii\theta^2\sum_A t_A(\bar\theta\bar\lambda^A(x))
...
\[
  ...
  \\
  &-\ii\theta\sigma^\mu\bar\theta\,\partial_\mu\phi_n(x)
  +\frac{\ii}{\sqrt{2}}\theta^2\bar\theta\bar\sigma^\mu
    \partial_\mu\psi_n(x)
...
\[
  ...
  \\
  &+\ii\theta\sigma^\mu\bar\theta\,\partial_\mu\phi_n^*(x)
  +\frac{\ii}{\sqrt{2}}\bar\theta^2\theta\sigma^\mu
...
\[
  ...
  \\
  &+2\ii(\theta\sigma^\mu\bar\theta)(\theta\sigma^\nu\bar\theta)
    \sum_A V^A_\mu
    \left\{
...
\[
  ...
  \\
  &+\frac{\ii}{2}[\bar\psi\bar\sigma^\mu\partial_\mu\psi]
  -\frac{\ii}{2}[(\partial_\mu\bar\psi)\bar\sigma^\mu\psi]
  \\
  ...
  \\
  &+\ii\sqrt{2}\sum_A[(\bar\psi t_A\bar\lambda^A)\phi]
  -\ii\sqrt{2}\sum_A[\phi^\dagger(\lambda^At_A\psi)]
  \\
  &-\sum_A D_A[\phi^\dagger t_A\phi]
  \biggr\}.
  \end{aligned}
...
\[
  ...
  -\ii[(\partial_\mu\bar\psi)\bar\sigma^\mu\psi]
  ...
  \\
  &+2\ii\sqrt{2}\sum_A[(\bar\psi t_A\bar\lambda^A)\phi]
  -2\ii\sqrt{2}\sum_A[\phi^\dagger(\lambda^At_A\psi)]
  \\
...
\begin{equation}
  ...
  +\frac{\ii}{2}[\bar\psi\bar\sigma^\mu D_\mu\psi]
  -\frac{\ii}{2}[(D_\mu\bar\psi)\bar\sigma^\mu\psi]
  +[\mathcal{F}^\dagger\mathcal{F}]
  \\
  &+\ii\sqrt{2}\sum_A[(\bar\psi t_A\bar\lambda^A)\phi]
  -\ii\sqrt{2}\sum_A[\phi^\dagger(\lambda^At_A\psi)]
...
\begin{equation}
  ...
  \partial_\mu\psi_\alpha-\ii\sum_A t_AV^A_\mu\psi_\alpha,
  \qquad
  D_\mu\phi\equiv
