...
\begin{equation}
  ...
  =i\epsilon_{\dot\alpha\dot\beta}D_\nu X^{\mu\nu}\,.
...
\begin{equation}
  ...
  =i\epsilon_{\dot\alpha\dot\beta}\int dS_i\,X^{0i}\,,
...
\begin{equation}
  ...
  -\sum_A(D_\mu\phi)_A^*(D^\mu\phi)_A
  \\
  &+i\sum_n\bar\psi'_n\bar\sigma^\mu(D_\mu\psi')_n
  +i\sum_n\bar\psi''_n\bar\sigma^\mu(D_\mu\psi'')_n
  +i\sum_A\bar\psi_A\bar\sigma^\mu(D_\mu\psi)_A
  +i\sum_A\bar\lambda_A\bar\sigma^\mu(D_\mu\lambda)_A
  \\
...
\begin{equation}
  ...
  -\sum_A(D_\mu\phi)_A^*(D^\mu\phi)_A
  \\
  &+i\sum_A\bar\psi'_A\bar\sigma^\mu(D_\mu\psi')_A
  +i\sum_A\bar\psi''_A\bar\sigma^\mu(D_\mu\psi'')_A
  +i\sum_A\bar\psi_A\bar\sigma^\mu(D_\mu\psi)_A
  +i\sum_A\bar\lambda_A\bar\sigma^\mu(D_\mu\lambda)_A
  \\
