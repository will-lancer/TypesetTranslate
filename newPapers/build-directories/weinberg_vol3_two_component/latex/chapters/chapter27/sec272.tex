...
\(i\bar\lambda\bar\sigma^\mu\partial_\mu\lambda\), and \(D^2\). We can
make \(V^\mu\) a
...
\[
  ...
  \\
  \delta\!\left(2i\bar\lambda\bar\sigma^\rho
...
\begin{equation}
  ...
  \frac{\partial W_\alpha}{\partial\theta^\beta}
    ...
    &=-(\sigma^{\mu\nu})_\alpha{}_\beta f_{\mu\nu}(x)
      -i\delta_\alpha{}^\beta D(x),\\
  W_\alpha\big|_{\theta^2}
    &=-i\bigl(\sigma^\mu\partial_\mu\bar\lambda\bigr)_\alpha .
  \end{aligned}
...
Writing \(x_+^\mu=x^\mu-i\theta\sigma^\mu\bar\theta\), the full superfield
takes the form
\begin{equation}
  ...
  =\exp\!\left(-i\theta\sigma^\mu\bar\theta\,\partial_\mu\right)
   \left[
    ...
    -i\theta_\alpha D
    -i\theta^2(\sigma^\mu\partial_\mu\bar\lambda)_\alpha
   \right](x).
...
\begin{equation}
  ...
  ={}&\lambda_\alpha(x_+)
    -(\sigma^{\mu\nu}\theta)_\alpha f_{\mu\nu}(x_+)
    -i\theta_\alpha D(x_+)
    -i\theta^2(\sigma^\mu\partial_\mu\bar\lambda)_\alpha(x_+).
  \end{aligned}
...
\[
  ...
  =\theta^2\left[
    2i\bar\lambda\bar\sigma^\mu\partial_\mu\lambda
    -\frac12f_{\mu\nu}f^{\mu\nu}
    +\frac{i}{4}\epsilon^{\mu\nu\rho\sigma}
       f_{\mu\nu}f_{\rho\sigma}
    +D^2\right].
...
\begin{equation}
  W_\alpha(x,\theta,\bar\theta)
  =\frac{i}{4}\bar D^2D_\alpha V(x,\theta,\bar\theta),
...
\begin{equation}
  ...
  \\
  \bar W_{\dot\alpha}(x,\theta,\bar\theta)
  &=\frac{i}{4}D^2\bar D_{\dot\alpha}V(x,\theta,\bar\theta).
  \end{aligned}
