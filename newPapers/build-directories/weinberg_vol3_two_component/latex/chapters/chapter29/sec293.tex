...
% R=2 to W_{A alpha}; Eqs. (29.3.9) and (29.3.32) visibly print
% W_{B beta B} in the source; Eq. (29.3.15) gives its last F-term without a preceding
...
\begin{equation}
  \theta\longrightarrow e^{i\varphi}\theta\,,
  \qquad
...
\end{equation}
Because \(W_{A\alpha}\) has \(R=2\), the whole theory including
