...
\begin{equation}
  ...
  +\sum_X
    ...
    \langle X,\mathrm{Box}\lvert Q_\alpha\rvert\mathrm{VAC}\rangle
  \\
  &\hspace{30mm}
...
\[
  ...
  =(2\pi)^{-3/2}\exp(ip\mathbin{\cdot}x)
...
\begin{equation}
  ...
  \langle\mathrm{VAC}\lvert S^\mu_\alpha(0)
    \rvert\mathbf p,\lambda\rangle
  &=(2\pi)^{-3/2}\left[
    -iF\sigma^\mu_{\alpha\dot\beta}
      \bar u^{\dot\beta}(\mathbf p,\lambda)
    +ip^\mu F'u_\alpha(\mathbf p,\lambda)\right],
  \\
  \langle\mathrm{VAC}\lvert\bar S^\mu_{\dot\alpha}(0)
    \rvert\mathbf p,\lambda\rangle
  &=(2\pi)^{-3/2}\left[
    -iF^*\bar\sigma^\mu_{\dot\alpha\beta}
      u^\beta(\mathbf p,\lambda)
    +ip^\mu F'{}^*\bar u_{\dot\alpha}(\mathbf p,\lambda)\right],
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
  \langle X\lvert S^\mu_\alpha(0)\rvert Y\rangle
  ={}&\frac{i}{p^2}\left[
    F(\sigma^\mu p_\nu\bar\sigma^\nu)_\alpha{}^\beta
      \mathcal M_\beta
    -p^\mu F'p_\nu\sigma^\nu_{\alpha\dot\beta}
  ...
  \\
  \langle X\lvert\bar S^\mu_{\dot\alpha}(0)\rvert Y\rangle
  ={}&\frac{i}{p^2}\left[
...
\(\langle X\lvert S^\mu_\alpha(0)\rvert Y\rangle_{\text{no pole}}\),
...
\begin{equation}
  ...
  \equiv
  \sum_X\delta^4(p-p_X)
  \langle\mathrm{VAC}\lvert\psi_\alpha(0)\rvert X\rangle
  \langle X\lvert\mathscr S^{\mu I}(0)\rvert\mathrm{VAC}\rangle\,,
...
\begin{equation}
  ...
  \equiv
  \sum_X\delta^4(p-p_X)
  \langle\mathrm{VAC}\lvert\mathscr S^{\mu I}(0)\rvert X\rangle
  \langle X\lvert\psi_\alpha(0)\rvert\mathrm{VAC}\rangle\,.
...
\begin{equation}
  i\langle\delta\psi_\alpha\rangle_{\mathrm{VAC}}
  =(2\pi)^3\xi_\alpha
  \int_0^\infty dm^2
  \left[G^{(3)}(m^2)+G^{(4)}(m^2)\right]\,.
...
\begin{equation}
  ...
  \langle X\lvert\bar S^\nu_{\dot\beta}(0)\rvert\mathrm{VAC}\rangle
  \\
  &\quad
  =-i\bigl[
...
\begin{equation}
  ...
  \rvert\mathrm{VAC}\rangle
  ={}&(2\pi)^3\sigma^0_{\alpha\dot\beta}\int dm^2
  \bigl[
    H^{(1)}(m^2)+H^{(2)}(m^2)
  \\
  &\qquad
