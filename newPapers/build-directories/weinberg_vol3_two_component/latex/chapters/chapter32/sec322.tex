...
particle states in \(\dd\geq4\) spacetime dimensions. The momentum operator
...
\(J_{01}=\ii J_{d1}\).) The fermionic supersymmetry generators have weights
...
\(j\), and consider any state \(\ket{\lambda}\) that is an
...
\(J_{23}=\lambda-k/2\) by acting on \(\ket{\lambda}\) with \(k\)
...
generators gives back the state \(\ket{\lambda}\).) If there is a
...
by multiplying the state \(\ket{\lambda}\) by \(k=\mathcal N/4\)
...
acting on the state \(\ket{2}\) with products of supersymmetry
...
by acting on an eigenstate \(\ket{2}\) of \(J_{23}\) having
...
\(2+\ii3,2-\ii3\) component because it is related to the \(k,\ell\)
...
on \(\ket{2}\) with supersymmetry generators, we see that we need
...
\[
  \begin{aligned}
    \binom{7}{p}
      ...
      &&\text{with }J_{23}=0\,,\\
    \binom{7}{p-1}
      &\ \text{components }T_{2\pm \ii3\,k_2\cdots k_p}
      &&\text{with }J_{23}=\pm1\,,\\
    \binom{7}{p-2}
      &\ \text{components }T_{2+\ii3\,2-\ii3\,k_3\cdots k_p}
      &&\text{with }J_{23}=0\,,
  \end{aligned}
\]
...
supersymmetry generators on one state \(\ket{2}\), six states
\(\ket{1}\), and one state \(\ket{0}\), giving altogether
...
supersymmetry generators on a state \(\ket{1}\), and contain one
