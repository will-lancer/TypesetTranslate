...
\begin{equation}
  \delta b_\mu
  =\frac{3i}{4}\left(\alpha L_\mu-\bar\alpha\bar L_\mu\right)
   +\frac{i}{4}\left(
...
\begin{multline}
  ...
  +\left[
      ...
      +2i\delta_\alpha{}^\beta b_\mu(x)\right.\\
  \left.
      +\frac{2i}{3}
...
\begin{equation}
  ...
  \equiv i(\sigma^{bc})_\alpha{}^\beta,
  \qquad
  (\bar{\mathscr J}^{bc})^{\dot\alpha}{}_{\dot\beta}
  \equiv i(\bar\sigma^{bc})^{\dot\alpha}{}_{\dot\beta},
