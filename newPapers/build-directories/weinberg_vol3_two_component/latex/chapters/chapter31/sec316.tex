...
% Corrected the Weyl factor in Eq. (31.6.63) and the logarithm arguments in
% the following unnumbered display.
...
\begin{multline}
  ...
  -\frac{\ii\kappa}{2}b_\nu
    \left(\alpha\sigma^\nu\bar\psi_\mu
          +\bar\alpha\bar\sigma^\nu\psi_\mu\right)
  +\frac{\ii\kappa}{2}
    \left[(s-\ii p)\psi_\mu\alpha
          +(-s-\ii p)\bar\psi_\mu\bar\alpha\right]\\
  -\frac{\ii\kappa}{4}\epsilon_{\mu\nu\kappa\sigma}b^\nu
    \left[-\ii\left(
...
\begin{equation}
  \delta C=\ii\left(\alpha\omega-\bar\alpha\bar\zeta\right),
...
\begin{equation}
  ...
  &{}
   -\sigma^a_{\alpha\dot\alpha}
     (\mathcal D_aC+\ii V_a)\bar\alpha^{\dot\alpha},
  \end{aligned}
...
\begin{equation}
  ...
  \delta M
  ={}&-\left[
    \alpha\bigl(\lambda-\ii\sigma^a\mathcal D_a\bar\zeta\bigr)
    +\bar\alpha\bigl(
      \bar\rho-\ii\bar\sigma^a\mathcal D_a\omega\bigr)
  \right]\\
  &+\frac{2\kappa}{3}\left\{
    \alpha\left[(s-\ii p)\omega+\sigma^ab_a\bar\zeta\right]
    +\bar\alpha\left[
      (s+\ii p)\bar\zeta-\bar\sigma^ab_a\omega\right]
  \right\},
  \end{aligned}
...
\begin{multline}
  ...
  =e_a{}^\mu\left[
    ...
    -\ii\kappa b_\mu\omega_\alpha\right.\\
  \left.
    {}-\frac{\kappa}{2}
      \left\{
        (-M+\ii N)\psi_{\mu\alpha}
        -\left[\sigma^c(\mathcal D_cC+\ii V_c)
...
\begin{multline}
  ...
  =e_a{}^\mu\left[
    ...
    +\ii\kappa b_\mu\lambda_\alpha
    -\frac{\kappa}{2}
      (\sigma_{bc})_\alpha{}^\beta\psi_{\mu\beta}F^{bc}\right.\\
  \left.
    {}-\frac{\ii\kappa}{2}D\psi_{\mu\alpha}
  \right],
...
\begin{multline}
  ...
  +\frac{1}{2}(N_1-\ii M_1)\omega_{2\alpha}
  +\frac{1}{2}(N_2-\ii M_2)\omega_{1\alpha},
...
\begin{multline}
  ...
  -\left[
    \zeta_1\left(\lambda_2
      -\frac{\ii}{2}\sigma^a\mathcal D_a\bar\zeta_2\right)
    +\bar\omega_1\left(\bar\rho_2
      -\frac{\ii}{2}\bar\sigma^a\mathcal D_a\omega_2\right)
  \right]\\
  -\left[
    \zeta_2\left(\lambda_1
      -\frac{\ii}{2}\sigma^a\mathcal D_a\bar\zeta_1\right)
    +\bar\omega_2\left(\bar\rho_1
      -\frac{\ii}{2}\bar\sigma^a\mathcal D_a\omega_1\right)
  \right]
  -V_{1a}V_2^a.
...
\begin{equation}
  C=A,\qquad
  \omega_\alpha=-\ii\psi_\alpha,\quad
  \bar\zeta^{\dot\alpha}=\ii\bar\psi^{\dot\alpha},\qquad
  M=G,\qquad
  N=-F,\qquad
  Z=B.
...
\begin{multline}
  ...
  e\Bigl[
    ...
    {}+\frac{\ii\kappa^2}{4}\epsilon^{\mu\rho\sigma\tau}V_\sigma^S
      \left(
        \psi_\rho\sigma_\tau\bar\psi_\mu
        +\bar\psi_\rho\bar\sigma_\tau\psi_\mu\right)\\
    +\frac{\ii\kappa^2}{8}\epsilon^{\mu\rho\sigma\tau}
...
\begin{multline}
  ...
  =e\left[
    \mathcal F^X
    -\frac{\ii\kappa}{\sqrt{2}}
      \bar\psi_\mu\bar\sigma^\mu\psi^X
    -\kappa^2\bar\psi_\mu
      \bar\sigma^{\mu\nu}\bar\psi_\nu\phi^X\right.\\
  \left.
    {}+2\kappa(s-\ii p)\phi^X
  \right].
...
\end{equation}
If a term \(c\int \dd^4x\,\operatorname{Re}[\mathrm I]_{\mathcal F}\)
...
\(\delta^4(0)=(2\pi)^{-4}\int \dd^4k\,1\). Such terms can be eliminated
by using dimensional regularization, for which \(\int \dd^4k\,1=0\).}
  ...
  =\left(1-\frac{\kappa^2}{3}K\right)^{-1}
    ...
    \left[
      ...
      +\frac{3}{2}\partial_\mu
        \ln\left(1-\frac{\kappa^2}{3}K\right)
        \partial_\nu
        \ln\left(1-\frac{\kappa^2}{3}K\right)
    \right],
\]
...
\begin{equation}
  1-\frac{\kappa^2}{3}K
  \equiv\exp\left(-\frac{\kappa^2\dd}{3}\right).
  \tag{31.6.65}\label{eq:31.6.65}
\end{equation}
We also introduce a new metric on the scalar field space
\begin{equation}
  g_{nm}\equiv
  \frac{\partial^2\dd}{\partial\phi_n\partial\phi_m^*}.
...
\begin{equation}
  L_m\equiv
  \frac{\partial f}{\partial\phi_m}
  +\kappa^2f\frac{\partial \dd}{\partial\phi_m}.
...
\begin{multline}
  ...
  +\frac{1}{2}\operatorname{Re}\sum_{AB}f^{-1}_{AB}
    \left(
      \sum_{nm}\frac{\partial \dd}{\partial\phi_n}
      (t_A)_{nm}\phi_m
    \right)^*
    \left(
      \sum_{k\ell}\frac{\partial \dd}{\partial\phi_k}
...
\begin{multline}
  ...
  \equiv
  \frac{\ii}{2}\operatorname{Re}\sum_{AB}f_{AB}
    \left(
