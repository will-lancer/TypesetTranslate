...
\begin{equation}
  -\ii\sigma^\rho_{\alpha\dot\alpha}
  \partial_\rho\bar\psi^{\lambda\dot\alpha}
  +m_g\psi^\lambda_\alpha=0\,,
  \qquad
  -\ii\bar\sigma^{\rho\dot\alpha\alpha}
...
\begin{equation}
  ...
  ={}&\frac14(8\pi G)
  \Bigl\{
  \OutBra{C}S_\mu^\alpha\InKet{A}\!{}_{N}
    \Delta^{\mu\nu}_{\alpha}{}^\beta(q)
    \OutBra{D}S_{\nu\beta}\InKet{B}\!{}_{N}\\
  &\quad+
  \OutBra{C}S_\mu^\alpha\InKet{A}\!{}_{N}
    \Delta^{\mu\nu}_{\alpha\dot\beta}(q)
    \OutBra{D}\bar S_\nu^{\dot\beta}\InKet{B}\!{}_{N}\\
  &\quad+
  \OutBra{C}\bar S_{\mu\dot\alpha}\InKet{A}\!{}_{N}
    \Delta^{\mu\nu\,\dot\alpha\beta}(q)
    \OutBra{D}S_{\nu\beta}\InKet{B}\!{}_{N}\\
  &\quad+
  \OutBra{C}\bar S_{\mu\dot\alpha}\InKet{A}\!{}_{N}
...
\begin{equation}
  \widetilde m_g\equiv
  \frac{2\kappa}{3}\bigl(\langle s\rangle+\ii\langle p\rangle\bigr),
