...
% Corrected the opening section range.
% Direct products of gauge groups use \times, as in the scan; \cdot is
% reserved for ordinary or scalar multiplication and inner products.
% Uncertainties: none.

\subsection{The Gravitino}

In this section we will use the weak field formalism developed in Sections
31.1--31.2 to derive some properties of the gravitino. In particular, by
...
\(SU(2)\times U(1)\) gauge symmetry of the electroweak interactions.
...
\begin{equation}
  ...
  ={}&\frac14(8\pi G)
  \Bigl\{
  {}_{\mathrm{out}}\!\bra{C}S_\mu^\alpha\ket{A}_{\mathrm{in}}\!{}_{N}
    \Delta^{\mu\nu}_{\alpha}{}^\beta(q)
    {}_{\mathrm{out}}\!\bra{D}S_{\nu\beta}\ket{B}_{\mathrm{in}}\!{}_{N}\\
  &\quad+
  {}_{\mathrm{out}}\!\bra{C}S_\mu^\alpha\ket{A}_{\mathrm{in}}\!{}_{N}
    \Delta^{\mu\nu}_{\alpha\dot\beta}(q)
    {}_{\mathrm{out}}\!\bra{D}\bar S_\nu^{\dot\beta}\ket{B}_{\mathrm{in}}\!{}_{N}\\
  &\quad+
  {}_{\mathrm{out}}\!\bra{C}\bar S_{\mu\dot\alpha}\ket{A}_{\mathrm{in}}\!{}_{N}
    \Delta^{\mu\nu\,\dot\alpha\beta}(q)
    {}_{\mathrm{out}}\!\bra{D}S_{\nu\beta}\ket{B}_{\mathrm{in}}\!{}_{N}\\
  &\quad+
  {}_{\mathrm{out}}\!\bra{C}\bar S_{\mu\dot\alpha}\ket{A}_{\mathrm{in}}\!{}_{N}
