...
\begin{equation}
  ...
  =-i\partial_\mu
     (\sigma^\nu\bar\omega_\nu^E)_\alpha
   +i(\sigma^\rho\partial_\rho\bar\omega_\mu^E)_\alpha\,,
  \qquad\text{and its complex conjugate},
...
\[
  \begin{aligned}
  \delta C^{E\sigma}
  =i\bigl(\alpha^\beta K^\sigma_\beta
  -\bar\alpha_{\dot\beta}\bar K^{\sigma\dot\beta}\bigr),\qquad
  K^\sigma_\alpha={}&
    -i(\sigma^\rho\partial_\rho\bar\lambda^{H\sigma})_\alpha\\
  &-\frac12\epsilon^{\nu\mu\kappa\sigma}
    \sigma_{\mu\,\alpha\dot\alpha}
...
\[
  ...
  =-i(\sigma^\rho\partial_\rho\bar\psi_\sigma)_\alpha
   +i\partial_\sigma
