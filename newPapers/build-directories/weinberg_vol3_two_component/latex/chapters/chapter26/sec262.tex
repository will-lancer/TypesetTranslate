...
\begin{equation}
  \gradedbracket{Q_\alpha}{S}=\ii\SuperQ_\alpha S,
  \qquad
  \gradedbracket{\bar Q_{\dot\alpha}}{S}
  =\ii\bar{\SuperQ}_{\dot\alpha}S\,,
...
\begin{equation}
  ...
  =-\ii\sigma^\mu_{\alpha\dot\beta}\partial_\mu
   -\ii\sigma^\mu_{\alpha\dot\beta}\partial_\mu .
...
\begin{equation}
  ...
  =2\ii\sigma^\mu_{\alpha\dot\beta}\partial_\mu S
...
\begin{equation}
  \begin{aligned}
  S(x,\theta,\bar\theta)={}&C
  -\ii(\theta\omega-\bar\theta\bar\omega)
  -\frac{\ii}{2}(\theta\theta-\bar\theta\bar\theta)M
  -\frac12(\theta\theta+\bar\theta\bar\theta)N\\
  &+\theta\sigma_\mu\bar\theta\,V^\mu
  -\ii\theta\theta\,
    \bar\theta\left(\bar\lambda
      -\frac{\ii}{2}\bar\sigma^\mu\partial_\mu\omega\right)\\
  &+\ii\bar\theta\bar\theta\,
    \theta\left(\lambda
      -\frac{\ii}{2}\sigma^\mu\partial_\mu\bar\omega\right)
...
\[
  ...
  \biggl\{&
    C-\ii(\theta\omega-\bar\theta\bar\omega)
    -\frac{\ii}{2}(\theta^2-\bar\theta^2)M\\
...
\[
  \begin{aligned}
  \delta S\big|_{0,1}
  ={}&\ii(\xi\omega-\bar\xi\bar\omega)\\
   &-\ii\theta^\alpha
    \left[(-M+\ii N)\xi_\alpha
      -(\sigma^\mu\bar\xi)_\alpha(\partial_\mu C+\ii V_\mu)\right]
    +\mathrm{c.c.}
  \end{aligned}
\]
...
\[
  \delta S\big|_2
  =-\frac{\ii}{2}(\theta^2-\bar\theta^2)\delta M
...
\[
  ...
  \delta S\big|_{3,4}={}&
  -\ii\theta^2\bar\theta\,
   \delta\left(\bar\lambda-\frac{\ii}{2}
     \bar\sigma^\mu\partial_\mu\omega\right)\\
  &+\ii\bar\theta^2\theta\,
   \delta\left(\lambda-\frac{\ii}{2}
...
\begin{equation}
  \delta\omega_\alpha
  =(-M+\ii N)\xi_\alpha
   -(\sigma^\mu\bar\xi)_\alpha(\partial_\mu C+\ii V_\mu)\,,
  \tag{26.2.12}\label{eq:26.2.12}
\end{equation}
\begin{equation}
  \delta M=-\xi\left(\lambda-\ii\sigma^\mu\partial_\mu\bar\omega\right)
  -\bar\xi\left(\bar\lambda
    -\ii\bar\sigma^\mu\partial_\mu\omega\right)\,,
  \tag{26.2.13}\label{eq:26.2.13}
\end{equation}
\begin{equation}
  \delta N=\ii\xi\left(\lambda-\ii\sigma^\mu\partial_\mu\bar\omega\right)
  -\ii\bar\xi\left(\bar\lambda
    -\ii\bar\sigma^\mu\partial_\mu\omega\right)\,,
  \tag{26.2.14}\label{eq:26.2.14}
\end{equation}
\begin{equation}
  \delta V_\mu
  =-\ii\left(\xi\sigma_\mu\bar\lambda
...
\begin{equation}
  ...
  =\left[(\sigma^{\mu\nu})_\alpha{}^\beta
    (\partial_\mu V_\nu-\partial_\nu V_\mu)
    +\ii D\delta_\alpha{}^\beta\right]\xi_\beta\,,
...
\begin{equation}
  \begin{aligned}
  \delta S&=-\ii[\xi Q+\bar\xi\bar Q,S_1S_2]
...
\begin{equation}
  M=C_1M_2+C_2M_1
  +\frac{\ii}{2}(\omega_1\omega_2-\bar\omega_1\bar\omega_2)\,,
...
\begin{equation}
  ...
  +\frac{\ii}{2}(\sigma^\mu\bar\omega_1)_\alpha\partial_\mu C_2
  +\frac{\ii}{2}(\sigma^\mu\bar\omega_2)_\alpha\partial_\mu C_1\\
  &-\frac12V_{1\mu}(\sigma^\mu\bar\omega_2)_\alpha
  -\frac12V_{2\mu}(\sigma^\mu\bar\omega_1)_\alpha\\
  &+\frac12(N_1-\ii M_1)\omega_{2\alpha}
  +\frac12(N_2-\ii M_2)\omega_{1\alpha}\,,
  \end{aligned}
...
\begin{equation}
  ...
  &-\omega_1\left(\lambda_2
      -\frac{\ii}{2}\sigma^\mu\partial_\mu\bar\omega_2\right)
   -\bar\omega_1\left(\bar\lambda_2
      -\frac{\ii}{2}\bar\sigma^\mu\partial_\mu\omega_2\right)\\
  &-\omega_2\left(\lambda_1
      -\frac{\ii}{2}\sigma^\mu\partial_\mu\bar\omega_1\right)
   -\bar\omega_2\left(\bar\lambda_1
      -\frac{\ii}{2}\bar\sigma^\mu\partial_\mu\omega_1\right)
  -V_{1\mu}V_2^\mu\,.
  \end{aligned}
...
\begin{equation}
  \delta D_\beta S
  \equiv-\ii[\xi Q+\bar\xi\bar Q,D_\beta S]
...
\begin{equation}
  \begin{aligned}
  -\ii\gradedbracket{\bar Q_{\dot\alpha}}
...
\begin{equation}
  P^{-1}S(x,\theta,\bar\theta)P
  =\eta S(\Lambda_Px,-\ii\bar\theta,-\ii\theta)\,,
...
\[
  \begin{aligned}
  \SuperQ_\alpha\,
   S(\Lambda_Px,-\ii\bar\theta,-\ii\theta)
...
\begin{equation}
  ...
  P^{-1}\omega_\alpha(x)P
    &=-\ii\eta(\sigma^0)_{\alpha\dot\alpha}
