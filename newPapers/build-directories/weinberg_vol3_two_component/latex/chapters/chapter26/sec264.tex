...
% Corrected source slips in Eqs. (26.4.4) and (26.4.15).
% Uncertainties: none.
...
\[
  ...
  =\theta\theta\bar\theta\bar\theta\biggl[
    ...
    &+\frac{\ii}{2}\bar\psi_n\bar\sigma^\mu\partial_\mu\psi_m
    -\frac{\ii}{2}(\partial_\mu\bar\psi_n)\bar\sigma^\mu\psi_m
...
\begin{equation}
  ...
  \\
    &+\ii\bar\psi_n\bar\sigma^\mu\partial_\mu\psi_m
  \biggr]\,.
  \end{aligned}
...
transformation rule
\(\delta\mathcal{F}_n
=-\ii\sqrt2\bar\xi\bar\sigma^\mu\partial_\mu\psi_n\) for
...
\(-\ii(\xi Q+\bar\xi\bar Q)\) with any Heisenberg-picture quantum field
...
\(-\ii(\xi Q+\bar\xi\bar Q)\) with \(\mathcal{F}_n\) is given by
\(\delta\mathcal{F}_n
=-\ii\sqrt2\bar\xi\bar\sigma^\mu\partial_\mu\psi_n\), because in
the Heisenberg picture the Weyl field \(\psi_n\) satisfies the field
equation derived from the Lagrangian \eqref{eq:26.4.7}:
\[
  \ii\bar\sigma^\mu\partial_\mu\psi_n
  =\sum_m
    \left(\frac{\partial^2f(\phi)}
      {\partial\phi_n\partial\phi_m}\right)^*
    \bar\psi_m\,.
...
\[
  ...
  =\ii\bar\psi_n\bar\sigma^\mu\partial_\mu\psi_n
  +\frac{\ii}{2}\partial_\mu(\psi_n\sigma^\mu\bar\psi_n).
\]
...
\begin{equation}
  ...
  -\ii\lambda B(\psi\psi-\bar\psi\bar\psi)
  \\
  &-m\lambda A(A^2+B^2)
