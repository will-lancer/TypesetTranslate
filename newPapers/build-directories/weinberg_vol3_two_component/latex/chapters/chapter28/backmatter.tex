...
\begin{enumerate}
  \item Suppose that the interactions \eqref{eq:28.1.4} and
  ...
  \item Suppose that the typical mass $m$ of the gauginos, higgsinos,
  ...
  \item Give formulas for the couplings of the quarks and leptons to
  ...
  \item Use holomorphy arguments to derive the one-loop formula for the
  ...
  \item Taking account of the possibility of a small flavor dependence
...
\begin{enumerate}
  ...
  defined in terms of an $R$ quantum number as $\exp(i\pi R)$, and may
