...
% Corrections: I_f counts internal fermion lines; C_1=2; the additive-
% constant relation ends in -a; Eq. (29.5.75) contains the required
% -(u+u_0) logarithmic factor; Eq. (29.5.79) has 4/pi; and the final
% behavior at u=-1 is O(u+1).
...
\begin{equation}
  ...
  &-2\sqrt{2}\operatorname{Re}\sum_{ABC}
    \epsilon_{ABC}
    \left(\lambda_{AL}^{\mathsf T}\epsilon\psi_{CL}\right)\phi_B^*
...
\begin{equation}
  ...
  -\frac12\operatorname{Re}
    \left[T(\Phi)\left(W_L^{\mathsf T}\epsilon W_L\right)\right]_{\mathcal F}.
...
\begin{equation}
  ...
  &+\frac14\operatorname{Re}\left\{
    ...
    \left(\bar\psi\psi_L\right)\frac{\dd^2T(a)}{\dd a^2}
  \right\}
  -\frac12\operatorname{Re}\left\{
    \left(\bar\lambda\lambda_L\right)\mathcal{F}\frac{\dd T(a)}{\dd a}
  \right\}
  \\
  &+\operatorname{Re}\left\{
    T(a)\left[
  ...
  &+\frac{\sqrt{2}}{4}\operatorname{Re}\left\{
    \frac{\dd T(a)}{\dd a}\left[
      ...
      +2\ii\left(\bar\lambda\psi_L\right)D
    \right]
  \right\}.
  \end{aligned}
...
\begin{equation}
  ...
  &+\frac{1}{4\pi}\operatorname{Im}\Biggl\{
    \left[\frac{\dd^2h}{\dd a^2}\right]\Biggl[
      ...
      +\frac{\sqrt{2}}{2}\ii\left(\bar\lambda\psi_L\right)D
  \\
  &\hspace{43mm}
      -\frac{\sqrt{2}}{4}
        \left(\bar\lambda\gamma^\mu\gamma^\nu\psi_L\right)f_{\mu\nu}
...
\begin{equation}
  ...
  -\frac{1}{8\pi}\operatorname{Im}
    \left[h'(\Phi)\left(W_L^{\mathsf T}\epsilon W_L\right)\right]_{\mathcal F}.
...
equations:
\begin{equation}
  \operatorname{Re}\left(\mathcal{D}_L^{\mathsf T}\epsilon W_L\right)=0.
...
\begin{equation}
  W_L=\frac{\ii}{4}
  \left(\mathcal{D}_R^{\mathsf T}\epsilon\mathcal{D}_R\right)
  \mathcal{D}_LV\,,
...
\begin{equation}
  ...
  =\frac{1}{8\pi}\operatorname{Re}\int \dd^4x\,
    \left[
      \widetilde V
      \left(\mathcal{D}_L^{\mathsf T}\epsilon W_L\right)
    \right]_D,
...
\begin{equation}
  ...
  =-\frac{1}{8\pi}\operatorname{Re}\int \dd^4x\,
    \left[
      \left(\mathcal{D}_L\widetilde V\right)^{\mathsf T}
      \epsilon W_L
    \right]_D,
...
\begin{equation}
  ...
  =\operatorname{Re}\left[
    ...
    \left[
      \left(\widetilde W_L^{\mathsf T}\epsilon W_L\right)
    \right]_{\mathcal F}
  \right],
...
\begin{equation}
  ...
  \left[
    -\frac{1}{8\pi}h'(\Phi)
      \left(W_L^{\mathsf T}\epsilon W_L\right)
    -\frac{1}{4\pi}
      \left(\widetilde W_L^{\mathsf T}\epsilon W_L\right)
  \right]_{\mathcal F}
  \\
...
\begin{equation}
  ...
  ={}&+\frac{1}{8\pi}\operatorname{Im}\int \dd^4x\,
    \left[
      \frac{1}{h'(\Phi)}
      \left(\widetilde W_L^{\mathsf T}\epsilon\widetilde W_L\right)
    \right]_{\mathcal F}
  \\
  &+\frac{1}{8\pi}\operatorname{Im}\int \dd^4x\,
    \left[\Phi^*h(\Phi)\right]_D.
...
\begin{equation}
  ...
  -\frac{b}{8\pi}\operatorname{Im}
    \left[\left(W_L^{\mathsf T}\epsilon W_L\right)\right]_{\mathcal F},
...
\begin{equation}
  \mathcal{L}_{\mathrm{eff}}\longrightarrow\mathcal{L}_{\mathrm{eff}}
  -\frac{b}{8\pi}\left[
    \ii\left(\bar\lambda\sl{\partial}\gamma_5\lambda\right)
    +\frac14\epsilon^{\mu\nu\rho\sigma}f_{\mu\nu}f_{\rho\sigma}
  \right].
...
\begin{equation}
  \theta_L\longrightarrow\exp(\ii\alpha)\theta_L\,,
  \qquad
  W_{AL}\longrightarrow\exp(\ii\alpha)W_{AL}\,,
  \qquad
...
\begin{equation}
  \psi_{AL}\longrightarrow\sqrt{\ii}\,\psi_{AL}\,,
  \qquad
  \lambda_{AL}\longrightarrow\sqrt{\ii}\,\lambda_{AL}\,,
  \qquad
...
\(-\tfrac12(\bar\psi\sl{\partial}\psi)\),
\(-\tfrac12(\bar\lambda\sl{\partial}\lambda)\),
...
consisting of a pair of Majorana spinors and a pair of complex scalars.
