...
% Corrected the R charge of W, field-strength indices, the reality factor in
% Eq. (29.3.15), the instanton condition, and a mistyped cross-reference.
% Uncertainties: none.
...
\end{equation}
Because \(W_{A\alpha L}\) has \(R=1\), the whole theory including
