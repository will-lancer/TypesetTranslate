...
$j$ have parities $+i\eta$ and $-i\eta$. Here $j$ is any integer or
...
parity is conserved the particles of spin zero have parities $i\eta$ and
$-i\eta$, where $\eta$ is the parity of the particle of spin $1/2$.
...
\begin{equation}
 \ket{j,\sigma}^{\pm}
 \equiv\frac{1}{\sqrt{2}}
 \left(\ket{j,\sigma}\pm i\ket{j,\sigma}^{\mathrm b}\right),
\tag{25.5.17}\label{eq:25.5.17}
\end{equation}
with definite parity
\begin{equation}
 P\ket{j,\sigma}^{\pm}=\pm i\eta\ket{j,\sigma}^{\pm}.
...
\end{equation}
where $U_{rs}$ is an arbitrary $N\cdot N$ unitary matrix. The left-hand side
