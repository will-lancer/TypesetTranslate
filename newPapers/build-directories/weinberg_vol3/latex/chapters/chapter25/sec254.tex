...
$SU(2)\cdot U(1)$ gauge group, and hence of the same order of magnitude as the
...
of the $SU(3)\cdot SU(2)\cdot U(1)$ gauge group\footnote{In simple
supersymmetry the generator $\WeylQ_\alpha$ must in any case commute with the
$SU(3)\cdot SU(2)$ generators, because semi-simple algebras like
$SU(3)\cdot SU(2)$ have no non-trivial one-dimensional representations.}.
...
to conclude then that in the limit of high energy where $SU(2)\cdot U(1)$
...
comprising an adjoint representation of $SU(3)\cdot SU(2)\cdot U(1)$.
...
representation of $SU(3)\cdot SU(2)\cdot U(1)$ which is \emph{chiral}---that
