...
\begin{equation}
  ...
  -\frac12\operatorname{Re}\sum_A
    \left(W_{AL}^{\mathsf T}\epsilon W_{AL}\right)_{\mathcal{F}}
  \\
  ...
  &-\operatorname{Re}\sum_{nm}
    ...
    \left(\psi_{nL}^{\mathsf T}\epsilon\psi_{mL}\right)
...
\begin{equation}
  D_\mu\psi_L
  \equiv\partial_\mu\psi_L-\ii\sum_A t_A V_{A\mu}\psi_L\,,
...
=\ii\langle D_A\rangle_{\mathrm{VAC}}\gamma_5\alpha\).
...
\begin{equation}
  ...
  -\ii\sqrt{2}\sum_{Am}(t_A\phi_0)_m^*
    \left(\lambda_{LA}^{\mathsf T}\epsilon\psi_{mL}\right)
  +\mathrm{H.c.}
...
\begin{equation}
  \mathcal{L}_{1/2}
  =-\frac12\left(\chi_L^{\mathsf T}\epsilon M\chi_L\right)
  +\mathrm{H.c.}\,,
...
\begin{equation}
  ...
  -\frac12\ii\sum_AD_A\gamma_5\gamma^\mu\lambda_A
  \\
...
\begin{equation}
  ...
  \left[
    h_{AB}(\Phi)
    \left(W_{AL}^{\mathsf T}\epsilon W_{BL}\right)
  \right]_{\mathcal{F}}\,,
  \end{aligned}
...
\[
  ...
  \Phi_n(x,\theta)={}&
  \phi_n(x_+)
  -\sqrt{2}\left(\theta_L^{\mathsf T}\epsilon\psi_{nL}(x_+)\right)
  +\mathcal{F}_n(x_+)
...
\(\sum_{AB}h_{AB}(\Phi)(W_{AL}^{\mathsf T}\epsilon W_{BL})\) are then
\[
  \begin{aligned}
  -\left[
    \sum_{AB}h_{AB}(\Phi)
  ...
  ={}&
  (\theta_L^{\mathsf T}\epsilon\theta_L)
  \sum_{AB}\left(\lambda_{AL}^{\mathsf T}\epsilon\lambda_{BL}\right)
  \left[
    \frac12\sum_{nm}
      \left(\psi_{nL}^{\mathsf T}\epsilon\psi_{mL}\right)
  ...
  &+\sqrt{2}\sum_{ABn}
  \frac{\partial h_{AB}(\phi)}{\partial\phi_n}
  \left(\theta_L^{\mathsf T}\epsilon\psi_{nL}\right)
  \left[
    -\left(\lambda_{BL}^{\mathsf T}
      \epsilon\gamma^\mu\gamma^\nu\theta_L\right)f_{A\mu\nu}
  \right.
  \\
  &\hspace{54mm}\left.
    +2\ii\left(\lambda_{BL}^{\mathsf T}\epsilon\theta_L\right)D_A
  \right],
  \end{aligned}
\]
...
(\theta_L^{\mathsf T}\epsilon\theta_L)\), the third term on the right-hand
...
\[
  ...
  \left[
    ...
    -2\ii\left(\bar\lambda_B\theta_L\right)D_A
  \right]
  \\
  &\qquad
  =\frac12\left(\theta_L^{\mathsf T}\epsilon\theta_L\right)
  \left[
    \left(\bar\lambda_B\gamma^\mu\gamma^\nu\psi_{nL}\right)f_{A\mu\nu}
    -2\ii\left(\bar\lambda_B\psi_{nL}\right)D_A
  \right].
  \end{aligned}
\]
The \(\mathcal{F}\)-term is the coefficient of
\((\theta_L^{\mathsf T}\epsilon\theta_L)\), so
\[
  \begin{aligned}
  -\left[
    \sum_{AB}h_{AB}(\Phi)
