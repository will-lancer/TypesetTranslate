...
\begin{equation}
  \delta D=\ii\bigl(\bar\alpha\gamma_5\sl{\partial}\lambda\bigr).
...
\[
  ...
  &=2\left(
    \bar\alpha\left[-\frac14f_{\mu\nu}[\gamma^\mu,\gamma^\nu]
      +\ii\gamma_5D\right]\sl{\partial}\lambda
  \right),
  \\
  \delta D^2&=2\ii D\bigl(\bar\alpha\gamma_5\sl{\partial}\lambda\bigr),
  \end{aligned}
\]
...
\[
  ...
  =-f^{\mu\nu}
    \bigl(\bar\alpha(\gamma_\nu\partial_\mu
      -\gamma_\mu\partial_\nu)\lambda\bigr)
  +2\ii D\bigl(\bar\alpha\gamma_5\sl{\partial}\lambda\bigr).
\]
...
\begin{equation}
  ...
  \\
  V_{(\alpha)\mu}(x)
  &=-\ii\partial_\mu\bigl(\gamma_5\lambda(x)\bigr)_\alpha,
  \\
  M_{(\alpha)}(x)
  &=-\ii\bigl(\sl{\partial}\gamma_5\lambda(x)\bigr)_\alpha,
  \qquad
...
\begin{equation}
  ...
  \\
  &+\frac{\ii}{2}(\theta^{\mathsf T}\epsilon\theta)
...
\begin{equation}
  W_\alpha(x,\theta)
  =\frac{\ii}{4}(\SuperD^{\mathsf T}\epsilon\SuperD)
...
\begin{equation}
  \begin{aligned}
  W_{L\alpha}(x,\theta)
  &=\frac{\ii}{4}(\SuperD_R^{\mathsf T}\epsilon\SuperD_R)
    \SuperD_{L\alpha}V(x,\theta),
  \\
  W_{R\alpha}(x,\theta)
  &=\frac{\ii}{4}(\SuperD_L^{\mathsf T}\epsilon\SuperD_L)
