...
that any \(4\times4\) matrix may be expressed as a linear combination of
...
\begin{equation}
  ...
  W_\alpha(x,\theta)=\Bigl[&
    ...
    -i\gamma_5\theta D(x)
    -\frac12(\theta^{\mathsf T}\epsilon\theta)
      \sl{\partial}\gamma_5\lambda(x)
  \\
  &+\frac12(\theta^{\mathsf T}\epsilon\gamma_5\theta)
      \sl{\partial}\lambda(x)
    +\frac12(\theta^{\mathsf T}\epsilon\gamma^\mu\theta)
      \gamma_5\partial_\mu\lambda(x)
  \\
  &-\frac14(\theta^{\mathsf T}\epsilon\theta)
      \gamma_5\gamma^\mu\gamma^\nu\gamma^\sigma\theta\,
      \partial_\sigma f_{\mu\nu}(x)
  \\
  &+\frac{i}{2}(\theta^{\mathsf T}\epsilon\theta)
      \gamma^\sigma\theta\,\partial_\sigma D(x)
    -\frac18(\theta^{\mathsf T}\epsilon\theta)^2\Box\lambda(x)
  \Bigr]_\alpha.
  \end{aligned}
...
\[
  ...
  ={}&(\theta_L^{\mathsf T}\epsilon\theta_L)
    \left[
      -2\bigl(\lambda_L^{\mathsf T}(x)\epsilon
...
\begin{equation}
  W_\alpha(x,\theta)
  =\frac{i}{4}(\SuperD^{\mathsf T}\epsilon\SuperD)
...
\begin{equation}
  (\SuperD^{\mathsf T}\epsilon\SuperD)\SuperD
  =(\SuperD_L^{\mathsf T}\epsilon\SuperD_L)\SuperD_R
  +(\SuperD_R^{\mathsf T}\epsilon\SuperD_R)\SuperD_L.
  \tag{27.2.16}\label{eq:27.2.16}
\end{equation}
Because
\(\SuperD_L(\SuperD_L^{\mathsf T}\epsilon\SuperD_L)
=\SuperD_R(\SuperD_R^{\mathsf T}\epsilon\SuperD_R)=0\), the superfield
\eqref{eq:27.2.15} is chiral, with
\begin{equation}
  \begin{aligned}
  W_{L\alpha}(x,\theta)
  &=\frac{i}{4}(\SuperD_R^{\mathsf T}\epsilon\SuperD_R)
    \SuperD_{L\alpha}V(x,\theta),
  \\
  W_{R\alpha}(x,\theta)
  &=\frac{i}{4}(\SuperD_L^{\mathsf T}\epsilon\SuperD_L)
...
\((\SuperD_R^{\mathsf T}\epsilon\SuperD_R)\SuperD_{L\alpha}\Omega\). But
\(\SuperD_R\Omega=0\) and
\[
  \left[(\SuperD_R^{\mathsf T}\epsilon\SuperD_R),\SuperD_{L\alpha}\right]
