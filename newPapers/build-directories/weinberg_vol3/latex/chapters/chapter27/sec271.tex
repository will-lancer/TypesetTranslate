...
\begin{equation}
  \begin{aligned}
  V^A(x,\theta)={}&C^A(x)
  -i\bigl(\bar\theta\gamma_5\omega^A(x)\bigr)
  -\frac{i}{2}(\bar\theta\gamma_5\theta)M^A(x)
  -\frac12(\bar\theta\theta)N^A(x)
  \\
  &+\frac{i}{2}(\bar\theta\gamma_5\gamma^\mu\theta)V^A_\mu(x)
...
\begin{equation}
  ...
  V^A(x,\theta)={}&
  \frac{i}{2}(\bar\theta\gamma_5\gamma^\mu\theta)V^A_\mu(x)
  -i(\bar\theta\gamma_5\theta)\bigl(\bar\theta\lambda^A(x)\bigr)
...
\[
  ...
  &=2\sum_A t_A\operatorname{Im}\Lambda^A(x_+)
   =-i(\bar\theta\gamma_5\gamma_\mu\theta)
  ...
  &=-2\sum_A t_A\left[
     \frac{i}{2}(\bar\theta\gamma_5\gamma^\mu\theta)V^A_\mu(x)
     -i(\bar\theta\gamma_5\theta)(\bar\theta\lambda^A(x))
     -\frac14(\bar\theta\gamma_5\theta)^2D^A(x)
   \right].
  \end{aligned}
\]
...
\[
  ...
  \\
  &=\mathbf{1}
  -i(\bar\theta\gamma_5\gamma^\mu\theta)
    \sum_A t_AV^A_\mu(x)
  \\
...
\[
  ...
  \\
  &-2i(\bar\theta\gamma_5\gamma_\mu\theta)
    \sum_A V^{A\mu}
    [(\overline{\psi_L}\theta)t_A(\bar\theta\psi_L)]
  \\
  &-2i\sqrt{2}(\bar\theta\gamma_5\theta)
...
\[
  ...
  +2i\sum_A V^A_\mu
    [(\overline{\psi_L}\gamma^\mu t_A\psi_L)]
  \\
  &+2i\sqrt{2}\sum_A[(\overline{\psi_L}t_A\lambda^A)\phi]
  -2i\sqrt{2}\sum_A[\phi^\dagger(\overline{\lambda^A}t_A\psi_L)]
  \\
...
\begin{equation}
  ...
  +[\mathcal{F}^\dagger\mathcal{F}]
  \\
  &+i\sqrt{2}\sum_A[(\overline{\psi_L}t_A\lambda^A)\phi]
  -i\sqrt{2}\sum_A[\phi^\dagger(\overline{\lambda^A}t_A\psi_L)]
  -\sum_A D_A[\phi^\dagger t_A\phi],
  \end{aligned}
...
\begin{equation}
  D_\mu\psi_L\equiv
  \partial_\mu\psi_L-i\sum_A t_AV^A_\mu\psi_L,
  \qquad
  D_\mu\phi\equiv
