...
% visibly contain a second \phi after \alpha_R, unlike the cited Eq. (26.3.15).
% Uncertainties: none.
...
\begin{equation}
  \begin{aligned}
    \delta\psi_L
    &=\sqrt{2}\,\partial_\mu\phi\,\gamma^\mu\alpha_R\phi
...
\begin{equation}
  \begin{aligned}
    ...
    \widetilde{\delta}D
    &=i\bigl(\bar\alpha\gamma_5\sl{\partial}\lambda\bigr)\,,
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
    ...
    &=\sqrt{2}\,D_\mu\phi\,\gamma^\mu\alpha_R\phi
      +\sqrt{2}\mathcal{F}\alpha_L\,,\\
    \widetilde{\delta}\mathcal{F}
    &=\sqrt{2}\bigl(\bar\alpha_L\sl{D}\psi_L\bigr)
      -2iq\phi\bigl(\bar\alpha_L\lambda_R\bigr)\,,\\
    \widetilde{\delta}\phi
    &=\sqrt{2}\bigl(\bar\alpha_R\psi_L\bigr)\,.
  \end{aligned}
...
\begin{equation}
  ...
  \delta N=i\bigl(\bar\alpha\gamma_5\lambda\bigr)\,.
...
\begin{equation}
  \begin{aligned}
    \delta'\psi_L
    &=-i\sqrt{2}q\phi\,\sl{V}\alpha_R\,,\\
    \delta'\mathcal{F}
    &=-2iq\phi\bigl(\bar\alpha_L\lambda_R\bigr)
      -i\sqrt{2}q\bigl(\bar\alpha_L\sl{V}\psi_L\bigr)\,,\\
    \delta'\phi&=0\,.
  \end{aligned}
