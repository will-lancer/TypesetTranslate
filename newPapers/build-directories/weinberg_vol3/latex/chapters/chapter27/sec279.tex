...
% Corrected two missing gauge-index sums in Eq. (27.9.33) and the coupling
% power in Eq. (27.9.50).
% Uncertainties: none.
...
\begin{equation}
  ...
  &-2\sqrt{2}\operatorname{Re}\sum_{ABC}
    C_{ABC}\left(\lambda_{AL}^{\mathsf T}\epsilon\psi_{CL}\right)\phi_B^*
...
\begin{equation}
  ...
  =\ii\left[\epsilon\left(\frac{1-\gamma_5}{2}\right)\right]_{\alpha\beta}
    D_\nu X^{\mu\nu}\,.
