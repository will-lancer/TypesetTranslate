...
% in Section 31.2.
% Source-visible anomaly preserved: Eq. (31.2.16) leaves its numerical
% coefficients in the unsimplified forms 6/8 and 6/16; Eq. (31.2.27) prints
% its integration measure as delta^4 x rather than d^4 x, and its right-hand
% side has no spacetime integral even though the left-hand side does.
% Uncertainties: none.
...
\begin{equation}
  \omega_\mu^E
  =\frac32L_\mu-\frac12\gamma_\mu\gamma^\nu L_\nu\,,
...
\begin{equation}
  L^\nu\equiv
  i\epsilon^{\nu\mu\kappa\rho}\gamma_5\gamma_\mu
...
\[
  ...
  =i\left(
    \bar\alpha\gamma_5
    \left[
      \sl{\partial}\lambda^{H\sigma}
      -\frac12i\epsilon^{\nu\mu\kappa\sigma}
       \gamma_5\gamma_\mu\partial_\kappa\lambda_\nu^H
...
\[
  \lambda_\mu^H
  =\psi_\mu-\gamma_\mu\gamma^\rho\psi_\rho
   -\gamma_\mu\partial^\rho\omega_\rho^H\,,
\]
and find that \(\omega_\sigma^E\) may be written in terms of \(\psi_\sigma\)
alone
\[
  \omega_\sigma^E
  =\sl{\partial}\psi_\sigma
   -\partial_\sigma\gamma^\rho\psi_\rho
   -\frac12i\epsilon_{\nu\mu\kappa\sigma}
    \gamma_5\gamma^\mu\partial^\kappa\psi^\nu\,.
\]
Using the identity
\[
  \eta_{\mu\nu}\gamma_\lambda-\eta_{\mu\lambda}\gamma_\nu
  =i\epsilon_{\mu\lambda\nu\rho}\gamma_5\gamma^\rho
   -\frac12i\gamma_\mu\gamma^\sigma
    \epsilon_{\sigma\lambda\nu\rho}\gamma_5\gamma^\rho\,,
\]
...
\begin{equation}
  ...
  \\
  &+\frac12\kappa\bar S^\sigma\psi_\sigma
...
\(-\mathcal L_{M\,\mathrm{VAC}}=\lvert df(\phi)/d\phi\rvert^2\), while
Eqs.~\eqref{eq:31.1.33} and \eqref{eq:26.7.27} give
\[
  \mathcal M+i\mathcal N
  =-\frac13\left[
    \phi\frac{df(\phi)}{d\phi}-3f(\phi)
  \right],
\]
so to first order in \(G\), the total vacuum energy is
\begin{equation}
  \rho_{\mathrm{VAC}}
  =\left\lvert\frac{df(\phi)}{d\phi}\right\rvert^2
   -\frac{8\pi G}{3}
    \left\lvert
      \phi\frac{df(\phi)}{d\phi}-3f(\phi)
    \right\rvert^2,
...
\(8\pi G\lvert\phi\rvert^2\lvert df(\phi)/d\phi\rvert^2\). However, this
...
minimum for \(\lvert\phi-\phi_0\rvert\) and \(\lvert df/d\phi\rvert\) of first
...
\begin{equation}
  ...
  =\int_{r_-}^{r_+}dr
   \left[
     \left\lvert\frac{d\phi}{dr}\right\rvert^2
     +\left\lvert\frac{df(\phi)}{d\phi}\right\rvert^2
   \right],
...
\[
  ...
  =\int_{r_-}^{r_+}dr
   \left[
     \left\lvert
       \frac{d\phi}{dr}
       +\xi\left(\frac{df(\phi)}{d\phi}\right)^*
     \right\rvert^2
     -2\operatorname{Re}\left(
       \xi^*\frac{d\phi}{dr}\frac{df(\phi)}{d\phi}
     \right)
   \right],
\]
...
\[
  \int_{r_-}^{r_+}dr\,
  \frac{d\phi}{dr}\frac{df(\phi)}{d\phi}
  =-f(\phi_0)\,.
\]
...
\(d\phi/dr=-\xi(df/d\phi)^*\) with the appropriate boundary conditions. The
...
the form
\begin{equation}
  \frac{\kappa}{3}\int \delta^4x\,
  \sum_n\lvert\phi_n\rvert^2
  \left(\eta^{\mu\nu}\Box-\partial^\mu\partial^\nu\right)h_{\mu\nu}
  =\frac16R^{(1)}\sum_n\lvert\phi_n\rvert^2\,,
