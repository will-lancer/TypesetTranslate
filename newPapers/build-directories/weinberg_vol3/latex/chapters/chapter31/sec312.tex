...
% in Section 31.2.
% Correction: Eq. (31.2.27) has a consistent spacetime integration measure
% on both sides. The unsimplified source coefficients in Eq. (31.2.16) are
% retained.
% Uncertainties: none.
...
the form
\begin{equation}
  \frac{\kappa}{3}\int d^4x\,
  \sum_n\lvert\phi_n\rvert^2
  \left(\eta^{\mu\nu}\Box-\partial^\mu\partial^\nu\right)h_{\mu\nu}
  =\frac16\int d^4x\,R^{(1)}\sum_n\lvert\phi_n\rvert^2\,,
