...
% Correction: the opening sentence links the preceding weak-field sections.
...
\(\beta\equiv \ii\gamma^0\). With the usual Dirac convention that
...
\begin{equation}
  ...
  \\
  &-\frac13
  \left(\gamma^\mu-\ii\frac{q^\mu}{m_g}\right)
  (\ii\sl{q}+m_g)
  \left(\gamma^\nu-\ii\frac{q^\nu}{m_g}\right).
  \end{aligned}
...
\begin{equation}
  ...
  M(A+B\to C+D)
  ={}&\frac14(8\pi G)
  \OutBra{C}\bar S_\mu\InKet{A}\!{}_{N}
  \Delta^{\mu\nu}(q)
  \OutBra{D}S_\nu\InKet{B}\!{}_{N}\,,
  \end{aligned}
