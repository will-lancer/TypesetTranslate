...
% Corrections: Eq. (31.6.63) and the following display consistently use
% the dimensionless factor 1-kappa^2 K/3.
...
\begin{equation}
  ...
  +\frac{2}{3}\gamma_\mu(s-\ii\gamma_5p)\alpha,
...
\begin{equation}
  ...
  +\frac{\kappa}{2}
   \bigl(\bar\alpha
   [\ii\gamma_5b^\nu-s\gamma^\nu-\ii p\gamma_5\gamma^\nu]\psi_\nu\bigr),
  \tag{31.6.3}\label{eq:31.6.3}
\end{equation}
\begin{equation}
  \delta p
  =-\frac{\ii}{4e}\bigl(\bar\alpha\gamma_5\gamma_\mu L^\mu\bigr)
  +\frac{\kappa}{2}
   \bigl(\bar\alpha
   [b^\nu+is\gamma_5\gamma^\nu-p\gamma^\nu]\psi_\nu\bigr),
...
\begin{multline}
  ...
  +\frac{\ii\kappa}{2}
    \bigl(\bar\psi_\mu\gamma_5(s-\ii\gamma_5p)\alpha\bigr)
...
\begin{equation}
  \delta C=\ii\bigl(\bar\alpha\gamma_5\omega\bigr),
  \tag{31.6.12}\label{eq:31.6.12}
\end{equation}
\begin{equation}
  \delta\omega
  =[-\ii\gamma_5\sl{\mathcal D}C-M+\ii\gamma_5N+\sl{V}]\alpha,
...
\begin{equation}
  ...
  +\frac{2\kappa}{3}
    \bigl(\bar\alpha[s-\ii\gamma_5p+\ii\gamma_5\sl{b}]\omega\bigr),
  \tag{31.6.14}\label{eq:31.6.14}
\end{equation}
\begin{equation}
  \delta N
  =\ii\bigl(\bar\alpha\gamma_5[\lambda+\sl{\mathcal D}\omega]\bigr)
  +\frac{2\ii\kappa}{3}
    \bigl(\bar\alpha
      [s-\ii\gamma_5p+\ii\gamma_5\sl{b}]\gamma_5\omega\bigr),
...
\begin{equation}
  ...
  =\bigl(\bar\alpha\gamma_a\lambda\bigr)
   ...
   +\frac{\kappa}{3}
    \bigl(\bar\alpha
      [s-\ii\gamma_5p+\ii\gamma_5\sl{b}]\gamma_a\omega\bigr),
...
\end{equation}
\begin{equation}
  \delta D=\ii\bigl(\bar\alpha\gamma_5\sl{\mathcal D}\lambda\bigr),
...
\begin{multline}
  ...
  =e_a{}^\mu\left[
    ...
    -\ii\kappa b_\mu\gamma_5\omega\right.\\
  \left.
    {}-\frac{\kappa}{2}
      (\sl{V}-\ii\gamma_5\sl{\mathcal D}C-M+\ii\gamma_5N)\psi_\mu
  \right],
...
\begin{multline}
  ...
  =e_a{}^\mu\left[
    ...
    +\ii\kappa b_\mu\gamma_5\lambda
    +\frac{\kappa}{8}[\gamma_b,\gamma_c]\psi_\mu F_{bc}\right.\\
  \left.
    {}-\frac{\ii\kappa}{2}\gamma_5D\psi_\mu
  \right],
...
\end{equation}
\begin{equation}
  V^a=C_1V_2^a+C_2V_1^a-\frac{\ii}{2}
...
\begin{multline}
  ...
  +\frac{1}{2}(N_1-\ii\gamma_5M_1)\omega_2
  +\frac{1}{2}(N_2-\ii\gamma_5M_2)\omega_1,
...
\begin{equation}
  ...
  =\sqrt{2}\bigl(\bar\alpha\sl{\mathcal D}\psi_L\bigr)
   -\frac{2\kappa}{3}
    \bigl(\bar\alpha[s-\ii p-\ii\sl{b}]\psi_L\bigr),
...
\begin{equation}
  ...
  =\phi_1\mathcal F_2+\phi_2\mathcal F_1
   -\bigl(\psi_{1L}^{\mathsf T}\epsilon\psi_{2L}\bigr).
  ...
  =\left(1-\frac{\kappa^2}{3}K\right)^{-1}
    ...
    \left[
      ...
      +\frac{3}{2}\partial_\mu
        \ln\left(1-\frac{\kappa^2K}{3}\right)
        \partial_\nu
        \ln\left(1-\frac{\kappa^2K}{3}\right)
    \right],
\]
