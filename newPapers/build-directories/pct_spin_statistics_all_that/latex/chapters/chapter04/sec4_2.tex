...
Let $\ket{\Psi}$ be orthogonal to all vectors of the form (4-10). We are
...
after (3-24). One first notes that
...
$x_1\ldots x_n\in\mathcal O$. Thus, by Theorem 2-17 $F$ vanishes and
...
Theorem 4-3 is an analogue of this statement for our case. It can be
...
$T\in\PolynomialAlgebra(\mathcal O)$ satisfying (4-11),
...
where in the last equality (4-11) has been used. Since, by Theorem 4-2,
...
\begin{enumerate}
\item Theorem 4-3 retains its validity if, instead of assuming that
commutators of fields vanish at space-like separations, we assume that
anti-commutators vanish. This will be used in the proof of Theorem 4-8.
...
Theorem 4-4, also due to Reeh and Schlieder, shows that
...
Recall the definition of an irreducible set, Eq.~(3-8). Suppose that for some
...
Then (4-13) holds, in particular, for a state $\ket{\Psi}$ of the form
...
where (4-13), (4-14), and the definition of $E_0$,
...
have been used. Clearly, (4-16) says
...
Theorem 4-4 shows that for any $\mathcal O$ the adjunction of $E_0$ to
...
$C\ket{\Omega}=c\ket{\Omega}$, where $c$ is a complex number. Then (4-17) for
