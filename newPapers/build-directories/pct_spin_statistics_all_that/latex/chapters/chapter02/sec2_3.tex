...
$\xi-i\eta$ according to Theorem \ref{thm:ch2-separate-holomorphy}.
...
$\mathcal{T}_n=\mathbb{R}^{4n}-i\Gamma$ and satisfying the inequality \eqref{eq:ch2-laplace-forward-cone-bound}
