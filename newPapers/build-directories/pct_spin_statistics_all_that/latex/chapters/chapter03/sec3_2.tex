% PCT-SOURCE: pdf=114 print=102 kind=heading id=3-2
\subsection{Independence and Compatibility of the Axioms}
\label{sec:ch3-2-independence}

% PCT-SOURCE: pdf=114 print=102 kind=prose id=3-2-opening
...
described heuristically at the end of Section 1-4.  These theories will

% PCT-SOURCE: pdf=115 print=103 kind=prose-continuation id=3-2-opening
...
% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-fields
...
% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-9
\begin{equation}
  \Hilbert=\bigoplus_{n=0}^{\infty}\Hilbert^{(n)},
  \tag{3-9}\label{eq:ch3-free-field-hilbert-sum}
\end{equation}

% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-field-components
...
% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-10
\begin{equation}
  \{\Phi^{(0)},\Phi^{(1)},\Phi^{(2)},\ldots\}
  \tag{3-10}\label{eq:ch3-free-field-sequence}
\end{equation}

% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-field-inner-product
of vectors with $\Phi^{(j)}\in\Hilbert^{(j)}$, and the scalar product in
$\Hilbert$ is

% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-11
\begin{equation}
...
% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-field-norm
where the scalar product $\braket{\Phi^{(n)}}{\Psi^{(n)}}$ is in
$\Hilbert^{(n)}$.  Only those sequences are in $\Hilbert$ which satisfy

% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-12
\begin{equation}
  \braket{\Phi}{\Phi}=\sum_{n=0}^{\infty}\norm{\Phi^{(n)}}^2<\infty.
  \tag{3-12}\label{eq:ch3-free-field-norm}
\end{equation}

% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-field-spin
...
group of undotted spinor indices like those in (1-58).  The scalar product
in $\Hilbert^{(n)}$ is

% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-13
\begin{equation}
\begin{aligned}
  \braket{\Phi^{(n)}}{\Psi^{(n)}}={}&
  \int\!\cdots\!\int
...
% PCT-SOURCE: pdf=115 print=103 kind=prose id=3-2-free-field-operator
and the field operator $\varphi_\alpha$ is defined by

% PCT-SOURCE: pdf=115 print=103 kind=equation id=3-14
\begin{equation}
\begin{aligned}
...
% PCT-SOURCE: pdf=116 print=104 kind=prose id=3-2-fourier-transform
Here a hat over a letter means omit it, and $\widetilde f$ is defined by

% PCT-SOURCE: pdf=116 print=104 kind=equation id=3-15
\begin{equation}
...
% PCT-SOURCE: pdf=116 print=104 kind=prose id=3-2-inhomogeneous-representation
The representation of the inhomogeneous $SL(2,\mathbb C)$ is here

% PCT-SOURCE: pdf=116 print=104 kind=equation id=3-16
\begin{equation}
\begin{aligned}
...
% PCT-SOURCE: pdf=116 print=104 kind=prose id=3-2-free-field-domain
...
% PCT-SOURCE: pdf=116 print=104 kind=prose id=3-2-wick-polynomials
...
% PCT-SOURCE: pdf=116 print=104 kind=equation id=3-17
\begin{equation}
\begin{aligned}
...
% PCT-SOURCE: pdf=116 print=104 kind=prose id=3-2-wick-polynomials-continuation
and analogously for higher degrees in $\varphi$.  [Recall the definition of
$D^\alpha$ in (2-5).]  It is not difficult to show, by using formula
(3-14), that the right-hand sides of these expressions indeed define fields
...
% PCT-SOURCE: pdf=116 print=104 kind=equation id=3-18
\begin{equation}
  \psi(x)=\varphi(x)+:
...
% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-wick-polynomial-conclusion
Such fields are sometimes called Wick polynomials.  The particular example
(3-18) satisfies axiom IV in addition to O, I, II, and III, but it gives the
same $S$-matrix as the free field.  That is what always happens for a field
theory defined by a Wick polynomial, as will be seen in Chapter 4.

% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-generalized-free-fields
Another class of examples of fields can be obtained by replacing the
$\dd\Omega_m(p)$ in (3-13) and (3-14) by
...
% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-representation-examples
...
% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-local-commutativity
...
small distances, say $10^{-16}\,\mathrm{cm}$.  In this connection Theorem 4-1
...
% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-time-slice
...
% PCT-SOURCE: pdf=117 print=105 kind=prose id=3-2-conclusion
