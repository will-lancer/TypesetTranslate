...
% Native reconstruction from the rendered source page.  Each solid double
% arrow joins the two components that a connected component of L(C) contains;
% the dashed pair of lines flanking it marks that component of L(C).
\begingroup
