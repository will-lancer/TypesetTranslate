...
% Native reconstruction from the rendered source page.  The outer closed curve
% bounds D_1 and D_2 together; C_1 and C_2 are the two contours inside them,
% each traversed counterclockwise with its flat edge next to the real axis.
\begingroup
