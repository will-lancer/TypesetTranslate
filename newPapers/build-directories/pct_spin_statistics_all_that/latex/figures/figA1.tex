...
% Native reconstruction from the rendered source page.  The diamond is the
% dependence domain of the interval on which g=1, and the measured interval
% is marked below its horizontal diagonal.
\begingroup
