% PCT-SOURCE coverage: pdf=013--015, printed pages 1--3.
\section*{INTRODUCTION}

% PCT-SOURCE: pdf=013 print=1 kind=prose
...
% PCT-SOURCE: pdf=014 print=2 kind=prose
...
% PCT-SOURCE: pdf=014 print=2 kind=footnote
\begingroup
...
% PCT-SOURCE: pdf=015 print=3 kind=prose
