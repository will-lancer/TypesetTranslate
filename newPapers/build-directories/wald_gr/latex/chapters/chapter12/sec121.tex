...
spacetime \(\overline M\), so, in particular, \(i^0\in\widetilde V\). Our definition
...
\[
  M=\overline M-[J^-(i^0)\cup J^+(i^0)].
\]
Hence, a Cauchy surface for \((\widetilde V,\widetilde g_{ab})\) which passes
through \(i^0\) will be a Cauchy surface for \((M\cap\widetilde V,g_{ab})\).
