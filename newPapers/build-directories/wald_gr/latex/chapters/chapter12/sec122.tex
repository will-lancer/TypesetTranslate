...
infinity, \(i^0\), is not to the causal future of any point in \(M\), so clearly
...
open neighborhood of \(i^0\) which fails to intersect \(J^+(T)\), and, thus, an open
...
other hand, all generators of \(\mathcal I^+\) have past endpoints at \(i^0\) and
...
Cauchy surface for \(\widetilde V\), so that \(\Sigma\) passes through \(i^0\) and is
...
\(\mathcal T\) cannot enter the region \(r>R\).} \(i^0\notin\mathcal T\), so
