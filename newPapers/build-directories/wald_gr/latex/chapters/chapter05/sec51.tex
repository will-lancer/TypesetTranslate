...
\begin{equation}
  0=D_{[e}{}^{(3)}R_{ab]cd}=(D_{[e}K)h_{|c|a}h_{b]\dd},
...
\begin{equation}
  \dd s^2=\dd\psi^2+\sin^2\psi\bigl(\dd\theta^2+\sin^2\theta\,\dd\phi^2\bigr).
...
\begin{equation}
  \dd s^2=\dd\psi^2+\sinh^2\psi\bigl(\dd\theta^2+\sin^2\theta\,\dd\phi^2\bigr).
...
\begin{equation}
  \dd s^2=-\dd\tau^2+a^2(\tau)
  \begin{cases}
    \dd\psi^2+\sin^2\psi\bigl(\dd\theta^2+\sin^2\theta\,\dd\phi^2\bigr),\\
    \dd x^2+\dd y^2+\dd z^2,\\
    \dd\psi^2+\sinh^2\psi\bigl(\dd\theta^2+\sin^2\theta\,\dd\phi^2\bigr),
  \end{cases}
...
\(\dd\psi^2+\psi^2(\dd\theta^2+\sin^2\theta\,\dd\phi^2)\).] The general form of the
