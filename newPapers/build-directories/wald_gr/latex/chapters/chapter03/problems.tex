...
in the signature of the metric. Consider the equation $\nabla_a\beta=\epsilon_{ab}\nabla^b\alpha$.
  ...
  \[
    \dd s^2=\pm\Omega^2(\alpha,\beta)\bigl[d\alpha^2+(-1)^sd\beta^2\bigr].
  \]
  \end{enumerate}
...
\[
  \dd s^2=\dd r^2+r^2(\dd\theta^2+\sin^2\theta\,\dd\phi^2)
\]
...
\item As shown in problem 2, an arbitrary Lorentz metric on a two-dimensional manifold locally always can be put in the form $\dd s^2=\Omega^2(x,t)[-\dd t^2+\dd x^2]$. Calculate
