...
\(\dd\mathbf v=\mathbf F\,\dd t/m\) at the time \(t_0+\dd t\), performing another
...
interval \(\dd\tau\) equals \(\dd t\), so \(f^i=F^i\), where \(F^i\) are the
...
\end{equation}
Any quantity such as \(\dd x^\mu\) or \(f^\mu\) that transforms according to
...
However, the initial values of \(\dd x^\mu/\dd\tau\) must be chosen so that
\(\dd\tau\) really is the proper time; that is, so that
\begin{equation}
  -1=\eta_{\mu\nu}
...
\begin{aligned}
  ...
  &=\eta_{\mu\nu}\Lambda^\mu{}_\rho\Lambda^\nu{}_\sigma
    f^\rho\frac{\dd x^\sigma}{\dd\tau}\\
  &=\eta_{\rho\sigma}f^\rho\frac{\dd x^\sigma}{\dd\tau},
\end{aligned}
\]
