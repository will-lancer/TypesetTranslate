...
\begin{equation}
  T^{\mu i}(\mathbf x,t)
  \equiv\sum_n p_n^\mu(t)\frac{\dd x_n^i(t)}{\dd t}
  \delta^3\bigl(\mathbf x-\mathbf x_n(t)\bigr).
...
\begin{aligned}
  ...
  &=-\sum_n p_n^\mu(t)\frac{\dd x_n^i(t)}{\dd t}
...
\begin{aligned}
  ...
  &\equiv\sum_n\delta^3\bigl(\mathbf x-\mathbf x_n(t)\bigr)
      \frac{\dd p_n^\mu(t)}{\dd t}\\
  &=\sum_n\delta^3\bigl(\mathbf x-\mathbf x_n(t)\bigr)
      \frac{\dd\tau}{\dd t}f_n^\mu(t).
\end{aligned}
\]
...
\[
  ...
  =\sum_c\delta^3\bigl(\mathbf x-\mathbf x_c(t)\bigr)
    \frac{\dd}{\dd t}\sum_{n\in c}p_n^\mu(t),
\]
...
\[
  \partial_\nu T^{\mu\nu}(x)
  =\sum_n e_nF^\mu{}_\rho(x)\frac{\dd x_n^\rho}{\dd t}
    \delta^3\bigl(\mathbf x-\mathbf x_n(t)\bigr),
\]
