...
\((\mathbf{x},t)\) and \((\mathbf{x},t+dt)\) on a given particle's trajectory
is just \(dt\). In the binding signature this says
\[
  d\tau^2=-g_{\mu\nu}\,dx^\mu dx^\nu=-g_{tt}\,dt^2,
\]
and therefore
...
\[
  ...
  =0,
\]
and in which the movement of \(P\) in a time interval \(dt\) is purely
temporal,
\[
  \left.
  \frac{d\xi^i}{dt}
...
\begin{equation}
  ds^2=-dt^2+g_{ij}(\mathbf{x},t)\,dx^i dx^j.
...
\[
  \begin{aligned}
  ds^2={}&-C(r,t)\,dt^2+D(r,t)\,dr^2+2E(r,t)\,dr\,dt\\
