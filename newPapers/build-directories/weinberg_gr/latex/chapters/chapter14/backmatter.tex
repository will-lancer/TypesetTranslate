...
% Uncertainties: reference 13's printed year conflicts with both the text and
%                the cited volume; the source reading is retained and
%                documented below.
%
% VERIFY SOURCE: reference 13 prints 1927, although Section 14.6 calls this
% Hubble's 1929 discovery and volume 15 of the Proceedings is from 1929. The
% reference below retains the printed 1927 rather than silently emending it.
...
\begin{enumerate}
  ...
  E.~P.~Hubble, \emph{Proc.\ Nat.\ Acad.\ Sci.}\ \textbf{15}, 168 (1927).
