...
% Uncertainties: SOURCE ERRATA -- the final line of (15.11.4) omits exponent
%                -1/2, and (15.11.21) reverses the derived coefficient; both
%                are corrected below.
...
\end{equation}
% SOURCE ERRATUM: the scan omits the exponent -1/2 in the final line.
...
\begin{equation}
  \frac{\tau_g}{t}
  =
  \left(\frac{5\mathcal N}{4}\right)^{1/2}.
  \tag{15.11.21}\label{eq:15.11.21}
\end{equation}
% SOURCE ERRATUM: combining (15.11.4) and (15.11.20) gives
% (5\mathcal N/4)^{1/2}, not the scan's (4\mathcal N/5)^{1/2}.
