...
%                and to the later criterion after (15.9.46); the printed
%                inequalities are preserved and marked VERIFY SOURCE below.
...
% VERIFY SOURCE: the scan prints the two greater-than inequalities below.
% Equation (15.9.23), and the later criterion after (15.9.46), instead make
% growth require pressure support below the Jeans threshold.
\[
  \frac{v_s^2q^2}{a^2}\gtrsim6\pi G\rho,
\]
