...
\begin{equation}
  \begin{gathered}
    ...
    \\
    d+\dd\rightleftarrows\mathrm{He}^3+n
    \rightleftarrows\mathrm H^3+p,
    \\
    \mathrm H^3+\dd\rightleftarrows\mathrm{He}^4+n,
    \qquad\text{etc.}
  \end{gathered}
...
\begin{equation}
  \begin{gathered}
    p+\dd\rightleftarrows\mathrm{He}^3+\gamma,
    \qquad
    n+\dd\rightleftarrows\mathrm H^3+\gamma,
    \qquad
    p+\mathrm H^3\rightleftarrows\mathrm{He}^4+\gamma,
    \\
    n+\mathrm{He}^3\rightleftarrows\mathrm{He}^4+\gamma,
    \qquad
    d+\dd\rightleftarrows\mathrm{He}^4+\gamma,
  \end{gathered}
