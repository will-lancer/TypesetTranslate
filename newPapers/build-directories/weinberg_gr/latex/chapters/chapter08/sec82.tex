...
\[
  \frac{\dd}{\dd r}\bigl(rB(r)\bigr)=rB'(r)+B(r)=1.
\]
The solution is
\begin{equation}
  rB(r)=r+\text{constant}.
...
\begin{equation}
  \dd s^2
  =
  -\left(1-\frac{2MG}{r}\right)\dd t^2
  +\left(1-\frac{2MG}{r}\right)^{-1}\dd r^2
  +r^2\dd\theta^2+r^2\sin^2\theta\,\dd\varphi^2.
...
\begin{equation}
  \begin{split}
  \dd s^2={}&
  -\frac{(1-MG/2\rho)^2}{(1+MG/2\rho)^2}\,\dd t^2\\
...
\[
  \frac{\dd}{\dd r}
  \left[
    r^2\left(1-\frac{2MG}{r}\right)\frac{\dd R}{\dd r}
  \right]-2R=0.
\]
...
\begin{equation}
  \begin{split}
  \dd s^2={}&
  -\left(\frac{1-MG/R}{1+MG/R}\right)\dd t^2
  +\left(1+\frac{MG}{R}\right)^2\dd\mathbf{X}^2\\
...
\[
  ...
  \right\}r^{-2}(\mathbf{x}\cdot \dd\mathbf{x})^2
  +\dd\mathbf{x}^2.
\]
