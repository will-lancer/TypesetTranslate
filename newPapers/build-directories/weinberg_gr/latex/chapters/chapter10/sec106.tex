...
\begin{equation}
  ...
  =
  \int \dd\Omega\,
  \left\langle t_{\mathrm{out}}^{0\ii}\right\rangle
  \widehat x_i r^2,
  \tag{10.6.5}\label{eq:10.6.5}
\end{equation}
where \(\langle t_{\mathrm{out}}^{0\ii}\rangle\) is the mean energy flux, obtained
...
\begin{equation}
  \Phi
  \equiv
  \left\langle t^{0\ii}\right\rangle\widehat k_i
  =
  \frac{\omega^2}{16\pi G}
  \left[
    e^{\lambda\nu*}e_{\lambda\nu}
