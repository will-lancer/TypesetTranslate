...
\begin{equation}
  D_{ij}(\omega)
  \equiv
  \int d^3x\,x^ix^jT^{00}(\mathbf{x},\omega).
...
\begin{equation}
  ...
  \int_0^\infty
  \omega^6D_{ij}^*(\omega)D_{lm}(\omega)\,d\omega.
...
\[
  \int d\Omega\,\widehat k_i\widehat k_j
  =
...
\begin{equation}
  D_{ij}(t)
  \equiv
  \int d^3x\,x^ix^jT^{00}(\mathbf{x},t),
...
\begin{equation}
  D_{ij}(t)
  =
  \int_0^\infty d\omega\,D_{ij}(\omega)e^{-\ii\omega t}
  +\text{c.c.},
...
\begin{align*}
  \int &(x^i-a^i)(x^j-a^j)T^{00}(\mathbf{x},t)\,d^3x\\
  ={}&
  \int x^ix^jT^{00}(\mathbf{x},t)\,d^3x
  -a^i\int x^jT^{00}(\mathbf{x},t)\,d^3x
  -a^j\int x^iT^{00}(\mathbf{x},t)\,d^3x
  +a^ia^j\int T^{00}(\mathbf{x},t)\,d^3x.
\end{align*}
But conservation of energy and momentum tells us that the last three terms
are at most linear functions of time, because
\[
  \frac{\partial}{\partial t}\int T^{00}(\mathbf{x},t)\,d^3x
  =
  -\int\partial_iT^{i0}(\mathbf{x},t)\,d^3x
  =0,
\]
\[
  \frac{\partial^2}{\partial t^2}
  \int x^iT^{00}(\mathbf{x},t)\,d^3x
  =
  \int x^i\partial_j\partial_kT^{jk}(\mathbf{x},t)\,d^3x
  =
  -\int\partial_jT^{ij}(\mathbf{x},t)\,d^3x
  =0.
\]
...
\begin{equation}
  D_{ij}(\omega)
  \equiv
  \int x^ix^jT^{00}(\mathbf{x},\omega)\,d^3x
  =
  \int(x^i-a^i)(x^j-a^j)T^{00}(\mathbf{x},\omega)\,d^3x.
...
\[
  E
  =
  \frac12\rho_0A\int_0^Lv_{\max}^2(z)\,dz
  =
...
\begin{equation}
  I_{ij}
  \equiv
  \int d^3x'\,x'_ix'_j\rho(\mathbf{x}').
