...
It will be necessary here to work in a Euclidean spacetime, with $x^4=x_4=ix^0$, $y^4=y_4=iy^0$, and $A^4_a=A_{4a}=iA_{0a}$, all real. (See Appendix A of Chapter 23.) In this case, the Dirac action is
\begin{equation}
...
\begin{equation}
\sl{D}
=\sum_{i=1}^4(\partial_i-it^a A_{ia})\gamma_i,
