...
=\frac{\bra{\Omega}H\ket{\Omega}}{\braket{\Omega}{\Omega}},
...
\begin{equation}
\frac{\bra{\Omega}\Phi_n(\mathbf{x},t)\ket{\Omega}}
{\braket{\Omega}{\Omega}}
=\phi_n(\mathbf{x}).
...
\begin{equation}
\bra{\Omega}H\ket{\Omega}
-\alpha\braket{\Omega}{\Omega}
-\int \dd^3x\,\beta^n(\mathbf{x})
 \bra{\Omega}\Phi_n(\mathbf{x})\ket{\Omega}
\tag{16.3.6}\label{eq:16.3.6}
\end{equation}
with no constraints on $\ket{\Omega}$. This gives
\begin{equation}
H\ket{\Omega}=\alpha\ket{\Omega}
+\int \dd^3x\,\beta^n(\mathbf{x})\Phi_n(\mathbf{x})\ket{\Omega}.
...
Now, we have said that in the presence of a current $\mathcal J^n(\mathbf{x})$, the Hamiltonian $H-\int \dd^3x\,\mathcal J^n(\mathbf{x})\Phi_n(\mathbf{x})$ has an eigenvalue $E[\mathcal J]$:
\begin{equation}
\left[H-\int \dd^3x\,\mathcal J^n(\mathbf{x})\Phi_n(\mathbf{x})\right]
\ket{\Psi_{\mathcal J}}
...
\langle H\rangle_\Omega
=E[\mathcal J_\phi]
+\int \dd^3x\,\mathcal J_\phi^n(\mathbf{x})\phi_n(\mathbf{x}).
...
+\int \dd^4x\,J_\phi^n(x)\phi_n(x)\right]
=-\frac{1}{T}\,\Gamma[\phi].
