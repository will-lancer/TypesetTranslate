...
\begin{align*}
 ...
 &=\theta\Bigl(-\frac{1}{2}C_{abc}
 \partial_\mu(\omega_b\omega_c)
 +C_{abc}(\partial_\mu\omega_b)\omega_c\Bigr)\\
 &\quad+\theta\Bigl(
 C_{abc}C_{bde}
 A_{\dd\mu}\omega_e\omega_c
 -\frac{1}{2}C_{abc}C_{cde}
 A_{b\mu}\omega_d\omega_e\Bigr)\\
 &=\theta\Bigl(\frac{1}{2}C_{abc}
 (\partial_\mu\omega_b)\omega_c
 +\frac{1}{2}C_{abc}
 (\partial_\mu\omega_c)\omega_b\Bigr)\\
 &\quad-\theta\Bigl(
 C_{abc}C_{cde}
 A_{\dd\mu}\omega_e\omega_b
 +\frac{1}{2}C_{abc}C_{cde}
 A_{b\mu}\omega_d\omega_e\Bigr).
\end{align*}
