...
\begin{equation}
 \delta\psi_\ell(x)=i\epsilon^a(x)(t_a)_\ell{}^m\psi_m(x) ,
...
\begin{equation}
 ...
 =i\epsilon^a(x)(t_a)_\ell{}^m\bigl(\partial_\mu\psi_m(x)\bigr)
 +i\bigl(\partial_\mu\epsilon^a(x)\bigr)(t_a)_\ell{}^m\psi_m(x) .
...
\[
 ...
 +i\epsilon^a(t^A_a)^b{}_c A^c_\mu
\]
...
\begin{equation}
 ...
 -iA^b_\mu(x)(t_b)_\ell{}^m\psi_m(x) .
...
\begin{align*}
 \delta(D_\mu\psi)_\ell={}&i\epsilon^a(t_a)_\ell{}^m
 \partial_\mu\psi_m-iC^b{}_{ca}\epsilon^a
 A^c_\mu(t_b)_\ell{}^m\psi_m\\
 &{}+A^c_\mu(t_c)_\ell{}^m
 i\epsilon^a(t_a)_m{}^n\psi_n
\end{align*}
or, using Eq.~\eqref{eq:15.1.2},
\begin{equation}
 \delta(D_\mu\psi)_\ell=i\epsilon^a(t_a)_\ell{}^m(D_\mu\psi)_m ,
...
\begin{equation}
 ...
 =\bigl[\exp(it_a\Lambda^a(x))\bigr]_\ell{}^m\psi_m(x) .
 \tag{15.1.15}\label{eq:15.1.15}
\end{equation}
We want the covariant derivative to transform in the same way:
\begin{equation}
 (\partial_\mu-it_a A^a_{\mu\Lambda})\psi_\Lambda
 =\exp(it_a\Lambda^a)(\partial_\mu-it_a A^a_\mu)\psi ,
...
\[
 \partial_\mu\exp(it_b\Lambda^b)
 -it_b\exp(it_a\Lambda^a)A^b_{\mu\Lambda}
 =-i\exp(it_a\Lambda^a)t_b A^b_\mu
\]
or in other words
\begin{align}
 t_a A^a_{\mu\Lambda}={}&
 \exp(it_b\Lambda^b)t_a A^a_\mu
 \exp(-it_b\Lambda^b)\notag\\
 &{}-i\bigl[\partial_\mu\exp(it_b\Lambda^b)\bigr]
 \exp(-it_b\Lambda^b) .
...
\begin{equation}
 \partial_3\exp(it_b\Lambda^b)
 =-i\exp(it_b\Lambda^b)t_a A^a_3 ,
...
\begin{equation}
 \partial_\mu\exp(it_b\Lambda^b)
 =-i\exp(it_b\Lambda^b)t_a A^a_\mu ,
