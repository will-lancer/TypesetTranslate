...
\begin{align*}
  ...
  -\partial_\nu A_{a\mu}+C_{abc}
  A_{b\mu}A_{c\nu},\\
  D_\mu\psi&\equiv\partial_\mu\psi-it_a A_{a\mu}\psi.
\end{align*}
...
\begin{equation}
  ...
  {\partial(\partial_0A_{a i})}=-F_a^{0i}
...
\begin{equation}
  J_a^0=-i\frac{\partial\mathcal L_M}{\partial D_0\psi_\ell}
  (t_a)_{\ell m}\psi_m
  =-i\pi_\ell(t_a)_{\ell m}\psi_m.
...
\begin{align}
  ...
  \notag\\
 &=\Pi_{a i}\bigl(F_{a0i}+\partial_iA_{a0}
 -C_{abc}A_{b0}A_{c i}\bigr)
  +\pi_\ell\partial_0\psi_\ell
  \notag\\
  &\quad-\frac12F_{a0i}F_{a0i}
...
factor $\exp(iI)$, where
\begin{equation}
  I=\int d^4x\left[\Pi_{a i}\partial_0A_{a i}
...
$\int d^3x\,\mathcal H$ is evidently quadratic in $\Pi_{a i}$, with the
...
\begin{align}
  I&=\int d^4x\left[\mathcal L_M+\frac12F_{a0i}F_{a0i}
  -\frac12F_{a ij}F_{a ij}
  -\frac12\partial_3A_{a i}\partial_3A_{a i}
...
$\prod_{a,\mu,x}dA_{a\mu}(x)$ for the integration over gauge fields
in \eqref{eq:15.4.16} is gauge-invariant, in the sense that
\begin{equation}
  \prod_{a,\mu,x}dA_{\Lambda\,a\mu}(x)
  =\prod_{a,\mu,x}dA_{a\mu}(x),
