...
$A_{3\ii}$. 't~Hooft~\hyperref[ch23-ref-2]{[2]} found a gauge-invariant
...
\begin{equation}
 ...
 \int_{\mathcal S}\mathcal F_{ij}\,\dd^2S_k.
...
\[
 \mathbin{\pm}\frac12\epsilon_{ijk}\int \dd^3x\,
 F_{nij}D_k\phi_n
 =\mathbin{\pm}\langle\phi\rangle\int\mathbf B\cdot \dd\mathbf A
...
\begin{align}
 ...
 \hat{\mathbf v}\hat{\mathbf v}^{\mathsf T}
 +\hat{\mathbf v}
 \bigl(\hat{\mathbf x}-(\hat{\mathbf x}\cdot\hat{\mathbf v})
 \hat{\mathbf v}\bigr)^{\mathsf T}
 \notag\\
 &+\bigl(\hat{\mathbf x}-(\hat{\mathbf x}\cdot\hat{\mathbf v})
 \hat{\mathbf v}\bigr)\hat{\mathbf v}^{\mathsf T}
 \notag\\
 &-\frac{
 \bigl(\hat{\mathbf x}-(\hat{\mathbf x}\cdot\hat{\mathbf v})
 \hat{\mathbf v}\bigr)
...
charge $q$ by a factor $\exp(2\ii qg\varphi)$, which is not single-valued
...
subgroup $H'\times U(1)$, where $H'$ is simply connected. (According to
\hyperref[app:23.B]{Appendix B of this chapter}, for simply connected
groups $G$ we have $\pi_2(G/H)=\pi_1(H)$, which for
$H=H'\times U(1)$ equals
$\pi_1(H')\times\pi_1(U(1))=\pi_1(U(1))=\mathbb Z$.) There are no
monopoles produced in the spontaneous breaking of the gauge group
$SU(2)\times U(1)$ of the standard electroweak theory, which is not simply
...
electroweak interactions, such as $SU(4)\times SU(4)$ or $SU(5)$ or
$\operatorname{Spin}(10)$, is spontaneously broken to the gauge group
$SU(3)\times SU(2)\times U(1)$ of the standard model. (See
...
spontaneously broken to $SU(3)\times SU(2)\times U(1)$, at a temperature
$T$ of order $M$.
