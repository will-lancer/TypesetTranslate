% Source: physical pp. 114--118 (printed pp. 91--95). Coverage: Section 17.3 from its heading through the paragraph immediately before Section 17.4; Eqs. (17.3.1)--(17.3.14), all unnumbered displays, citations [3,4], and two footnotes. Figures/tables/dividers: none. Source issue: Eq. (17.3.7) visibly prints g t F_1, although the surrounding hbar expansion and Eq. (17.3.8) strongly suggest that hbar t F_1 was intended; the visible source is preserved here.
...
\begin{equation}
(S_R,S_N)=-\frac12\sum_{M=1}^{N-1}(S_M,S_{N-M})+i\Delta S_{N-1}.
\label{eq:17.3.5}
\end{equation}
