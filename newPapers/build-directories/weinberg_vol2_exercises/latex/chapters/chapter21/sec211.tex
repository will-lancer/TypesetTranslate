...
representation of the symmetry algebra, for which the matrices $it_a$
...
\begin{equation}
 ...
 =-\frac12\sum_n\left(
 \partial_\mu\phi'_n
 -i\sum_{m,a}t^a_{nm}A_{a\mu}v_m\right)^2.
...
\begin{equation}
 ...
 =\sum_n\left(\sum_{a,m}
 c_a\cdot it^a_{nm}v_m\right)^2\geq 0,
