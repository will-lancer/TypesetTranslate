...
put in the form
\begin{equation}
 g=\exp\left(-\ii\sum_a\theta_a\mathcal T_a\right)
 \exp\left(\ii\sum_r\phi_r x_r\right)
 \exp\left(\ii\sum_i\mu_i t_i\right),
...
$g$ may be written
\begin{equation}
 g=1+\ii\sum_r\phi_r^0x_r+\ii\sum_i\mu_i^0t_i,
 \tag{21.A.4}\label{eq:21.A.4}
\end{equation}
with $\phi_r^0$ and $\mu_i^0$ infinitesimal. Equivalently,
\begin{equation}
 g=1+\ii\sum_r\phi_rx_r+\ii\sum_i\mu_it_i
 -\ii\sum_a\theta_a\mathcal T_a,
...
\begin{equation}
 g=\gamma(\xi)=\exp\left(\ii\sum_r\xi_rx_r\right)
 \tag{21.A.9}\label{eq:21.A.9}
\end{equation}
and write it in the form \eqref{eq:21.A.2}:
\begin{equation}
 \gamma(\xi)
 =\exp\left(-\ii\sum_a\theta_a(\xi)\mathcal T_a\right)
 \gamma\bigl(\phi(\xi)\bigr)
 \exp\left(\ii\sum_i\mu_i(\xi)t_i\right),
