...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item[(iii)]
    Write the field as
    \(U(x)=\exp(2\ii\pi(x)/f_\pi)\), with the pion field
  ...
  subgroup
  \(H=\{(e^{\ii\beta},e^{\ii\beta})\}\).  Represent a point of \(G/H\) by
  \[
    g(x)=(e^{\ii\theta_L(x)},e^{\ii\theta_R(x)}),
    \qquad g\sim gh^{-1}.
  \]
  ...
  \begin{enumerate}
    ...
    \((e^{\ii\alpha_L},e^{\ii\alpha_R})\in G\) and under the local change of
    ...
    \[
      \widetilde\Phi
        =e^{-\ii(q_L\theta_L+q_R\theta_R)}\Phi .
    \]
  ...
  \begin{enumerate}
    ...
    \[
      \mu\frac{\dd\alpha}{\dd\mu}=-\frac{b}{2\pi}\alpha^2,
    \]
    ...
    \(m_{u,\dd}\sim O(1)\,\mathrm{MeV}\), with the other ones much heavier,
    \[
      m_s,m_c,m_b,m_t\sim
    ...
    limit \(m_{u,\dd}\to0\), and argue why they can be broken.
    \begin{enumerate}
      \item[(i)]
  ...
  \begin{enumerate}
    ...
    \item[(c)]
    Put \(U=\exp(2\ii B/F)\) in
    \(\int_{B_5}\operatorname{Tr}(U^{-1}\dd U)^5\).
  ...
  \begin{enumerate}
    ...
    \[
      S[X]= -\frac{1}{4\pi}\int \dd^2\sigma\,
    ...
    \[
      ...
      \tag{2}
    \]
    and, writing \(z=\sigma_E^1+\ii\sigma_E^2\), is given by
    \[
      G_2(z,z')=-\ln|z-z'|,
    \]
