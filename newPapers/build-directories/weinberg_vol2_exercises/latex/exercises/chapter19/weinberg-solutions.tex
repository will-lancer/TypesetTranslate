...
\begin{enumerate}
  ...
  \[
    \gamma(\boldsymbol\xi)
      =\exp(\ii\xi_at_a),\qquad
    r=(\xi_1^2+\xi_2^2)^{1/2},\qquad
    n_a=\xi_a/r.
  \]
  We use \([t_i,t_j]=\ii\epsilon_{ijk}t_k\) and
  \(\epsilon_{12}=+1\).  For an infinitesimal transformation
  \(g=1+\ii\epsilon_at_a+\ii\epsilon_3t_3\), the factorization
  \(g\gamma(\xi)=\gamma(\xi+\delta\xi)\exp(\ii\vartheta t_3)\)
  gives
  \[
    \boxed{\delta\xi_a
      =r\cot r\,\epsilon_a
  ...
  transforms as
  \(\chi_q\mapsto e^{\ii q\vartheta}\chi_q\), and its covariant derivative is
  \[
    \boxed{\mathcal D_\mu\chi_q
      =(\partial_\mu+\ii qE_\mu)\chi_q.}
  \]
  ...
  rule.  Define \(D_\mu^\pm=(D_{1\mu}\mp \ii D_{2\mu})/\sqrt2\); these have
  ...
  \WeinbergSolution{4}
  Let
  \(Q_5^\pm=\int \dd^3x\,A_0^\pm(x)\).  The current algebra is
  \[
    [Q_5^+,Q_5^-]=2I_3.
  \]
  ...
  \[
    \bra{\Omega}A_\mu^a(0)\ket{\pi^b(q)}
       =\frac{\ii F_\pi}{2}\,q_\mu\delta^{ab},
  \]
  ...
  \[
    [t_a,t_b]=\ii\epsilon_{abc}t_c,\qquad
    [t_a,x_b]=\ii\epsilon_{abc}x_c,\qquad
    [x_a,x_b]=\ii\epsilon_{abc}t_c
  \]
  and choose
  \(\gamma(\boldsymbol\xi)=\exp(\ii\boldsymbol\xi\cdot\boldsymbol x)\).
  Write \(r=|\boldsymbol\xi|\) and
  \(\boldsymbol n=\boldsymbol\xi/r\).  For
  \[
    g=1+\ii\boldsymbol\alpha\cdot\boldsymbol t
       +\ii\boldsymbol\beta\cdot\boldsymbol x,
  \]
  factor
  ...
  \[
    h=1+\ii\boldsymbol\vartheta\cdot\boldsymbol t,\qquad
    \boldsymbol\vartheta
      =\boldsymbol\alpha+
       \frac{\tan(r/2)}{r}
