...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \[
      U_\square
        =\mathbf{1}+i\bigl(\partial_\mu A_\nu-\partial_\nu A_\mu
          -i[A_\mu,A_\nu]\bigr)u^\mu v^\nu+O(\ell^3)
        =\mathbf{1}+iF_{\mu\nu}u^\mu v^\nu+O(\ell^3).
    \]
  ...
  \begin{enumerate}
    ...
    \(A'-A=d\lambda\), which is precisely a local Abelian gauge
  ...
  \begin{enumerate}
    \item[(a)] Endpoint factors cancel around the quadrangle, so its
      ...
      connection, gives
      \[
        \mathcal W(x)=\mathbf{1}+i\epsilon^2m^\mu n^\nu
        \bigl(\partial_\mu A_\nu-\partial_\nu A_\mu
              i[A_\mu,A_\nu]\bigr)+O(\epsilon^3).
      \]
  ...
  \begin{enumerate}
    ...
    \[
      \omega^2=\frac12\omega^a\omega^b[T_a,T_b]
        =\frac{i}{2}f_{ab}{}^c\omega^a\omega^bT_c.
    \]
  ...
  \begin{enumerate}
    ...
    \item[(b)] With real couplings and the usual conserved Dirac fermion
      ...
      density \(i\theta F^a_{\mu\nu}\widetilde F^a_{\mu\nu}\) and
      independent pseudoscalar mass and Yukawa terms
      \(i m_5\bar\psi\gamma_5\psi\) and
      \(i y_5\bar\psi\gamma_5\phi\psi\).  These do not alter the gauge
      invariance argument.
  ...
  \begin{enumerate}
    ...
    \item[(c)] Acting with the quadratic operators on normalized
      ...
      \[
        \int d^Dx\,e^{-ipx}\langle\Phi(x)\Phi^{\mathsf T}(0)\rangle
        =-\frac1{p^2}
        \begin{pmatrix}
          i\!\left[\eta_{\mu\nu}
             -(1-\xi)\dfrac{p_\mu p_\nu}{p^2}\right]&ip_\mu\\
  ...
  \begin{enumerate}
    ...
    \item[(c)] Let \(\delta\Psi\) be an arbitrary infinitesimal change of
      ...
      an insertion
      \[
        \delta_\Psi\braket{f}{i}
          =i\bra{f}
             \int d^4x\,\{\widehat Q,\delta\Psi\}
            \ket{i} .
      \]
      If
      \(\widehat Q\ket{i}=0\) and
