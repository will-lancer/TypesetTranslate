...
\begin{enumerate}
  ...
  \SupplementarySolution{5}{Faddeev--Popov Operators and Ghost Vertices}
  \begin{enumerate}
    \item[(a)]
    From
  ...
  \SupplementarySolution{8}{Covariant Propagators and Ward Identities}
  \begin{enumerate}
    \item[(a)]
  ...
  \SupplementarySolution{12}{Physical Polarizations as Cohomology}
