...
\begin{enumerate}
  ...
  \[
    E[\phi]=\int_{-\infty}^{\infty}
      \left[\frac12\left(\frac{d\phi}{dx}\right)^2+U(\phi)\right]dx
  \]
  and is such that \(E[\phi]\) is finite, then
  \[
    \int_{-\infty}^{\infty}
      \frac12\left(\frac{d\phi}{dx}\right)^2dx
  ...
  equation
  \[
    \frac{d^2\phi}{dx^2}=3\phi^5-4\phi^3+\phi,
  \]
  ...
  Let
  \[
    g=d\mathbf x\cdot d\mathbf x+d\tau^2
  \]
  ...
  \begin{enumerate}
    ...
    \begin{equation}
      ...
      \tag{1}
    \end{equation}
    where \(F=dA+A\wedge A\), and
    \[
      A=A_w\,dw+A_{\bar w}\,d\bar w
        +A_z\,dz+A_{\bar z}\,d\bar z
    \]
  ...
  \begin{enumerate}
    ...
    \item[(ii)] Construct a superpotential \(W\) such that
      \[
        U=\frac12\left(\frac{dW}{d\phi}\right)^2,
      \]
  ...
  \[
    S[\phi]=\int\left[
      ...
      +\epsilon V(\epsilon x)|\phi|^2\right]dx\,dt.
  \]
  In this question,
  \[
  ...
  \begin{enumerate}
    \item[(i)] For the case \(\epsilon=0\), show that if \(E<0\), then
      (1) has a solution \(e^{-itE}f_E(x)\), with
      \[
        f_E(x)=\sqrt{2|E|}\,
    ...
    \item[(ii)] Next, still with \(\epsilon=0\), show that this exact
      ...
      \[
        H[\phi]=\int\left[
          \frac12|\phi_x|^2-\frac12|\phi|^4\right]dx,
        \qquad
        P[\phi]=\int\langle\phi,-i\phi_x\rangle dx.
      \]
    ...
    \item[(iii)] For \(\epsilon=1\) and \(V(x)=\tfrac12x^2\), find a
      ...
      \[
        Eg_E=-\frac12\frac{d^2g_E}{dy^2}-g_E^3
          +\frac12y^2g_E,
      \]
  ...
  that this extends to \(D_{5d}\) symmetry.
