...
\begin{enumerate}
  ...
  transformations
  \[
    s\phi_i=\ii\omega^a(T_a)_i{}^j\phi_j,\qquad
    [T_a,T_b]
      =\ii C_{cab}T_c .
  \]
  ...
  fluctuation,
  \(s\psi'=\ii t_a\omega_a(\psi+\psi')\), while
