...
\begin{enumerate}
  \SupplementarySolution{1}{Deriving the Zinn--Justin Equation}
  ...
  \SupplementarySolution{2}{Antifield Bookkeeping}
  ...
  \SupplementarySolution{3}{The Linearized Slavnov Operator}
  ...
  \SupplementarySolution{4}{The Loopwise Master Equation}
  ...
  \SupplementarySolution{5}{Exact Counterterms as Field Redefinitions}
  ...
  \SupplementarySolution{6}{Antighost Translation Ward Identity}
  ...
  \SupplementarySolution{7}{Why Nonlinear Gauges Need More Counterterms}
  ...
  \SupplementarySolution{8}{Scalar BRST Nilpotence}
  ...
  \SupplementarySolution{9}{Power Counting with Scalar Sources}
  ...
  \SupplementarySolution{10}{Invariant Scalar Couplings}
  Write
  \[
  ...
  \SupplementarySolution{11}{The Yukawa Tensor Condition}
  The variations are
  \[
  ...
  \SupplementarySolution{12}{Two Gauge Transformations after a Background Split}
  ...
  \SupplementarySolution{13}{Covariance of the Background Gauge Condition}
  ...
  \SupplementarySolution{14}{The Background Faddeev--Popov Operator}
  ...
  \SupplementarySolution{15}{A BRST-Exact Background Gauge}
  Use
  \[
    sA'_{\alpha\mu}
      =\bar D_\mu\omega_\alpha
  ...
  \SupplementarySolution{16}{The Background Ward Identity}
  ...
  \SupplementarySolution{17}{Why One Renormalization Constant Suffices}
  ...
  \SupplementarySolution{18}{Background-Gauge Transversality at Every Loop}
  ...
  \SupplementarySolution{19}{Signs and Powers of One-Loop Determinants}
  ...
  \SupplementarySolution{20}{The Quartic Trace--Log Expansion}
  ...
  \SupplementarySolution{21}{Casimirs and Dynkin Indices}
  ...
  \SupplementarySolution{22}{Group Factors for Several Matter Representations}
  ...
  \SupplementarySolution{23}{The Fermion Vacuum Polarization Pole}
  The massless Dirac loop is
  \[
    i\Pi_{\mu\nu}^{ab}(q)
      =-g^2T(r)\delta^{ab}\!
       \int\frac{d^dk}{(2\pi)^d}
       \frac{{\rm tr}[\gamma_\mu\slashed k
          \gamma_\nu(\slashed k+\slashed q)]}
        {k^2(k+q)^2}.
  \]
  The initial minus sign is the closed-fermion-loop sign.  Combine
  denominators, shift \(k\mapsto\ell-xq\), and use
  \(\ell_\mu\ell_\nu\mapsto
  \eta_{\mu\nu}\ell^2/d\).  Dimensional regularization permits the shift,
  and the result is
  \[
    \Pi_{\mu\nu}^{ab}\big|_{\rm pole}
      =-\delta^{ab}(q_\mu q_\nu-q^2\eta_{\mu\nu})
       \frac{g^2}{16\pi^2\epsilon}\frac43T(r)
  \]
  up to the common convention relating
  \(\epsilon=(4-d)/2\) to the chapter's \(1/(d-4)\).  It is transverse,
  and comparison with the \(F^2\) counterterm shows
  \[
    \boxed{\Delta b_0^{\rm Dirac}=-\frac43T(r).}
  \]

  \SupplementarySolution{24}{The Ghost Loop and Its Minus Sign}
  Write
  \[
  ...
  \SupplementarySolution{25}{The \(11C_A/3\) Gauge-Sector Coefficient}
  ...
  trace supplies \(1/3\), the four covariant vector components supply
  ...
  \SupplementarySolution{26}{Scalar Bubble--Seagull Cancellation}
  Expansion of the scalar kinetic term gives
  \[
  \begin{split}
  ...
  \end{split}
  \]
  The two derivative vertices give a bubble numerator
  \((2k+q)_\mu(2k+q)_\nu\); the last term gives the seagull.  After
  Feynman parametrization, the bubble contains a local
  \(\eta_{\mu\nu}\) term not accompanied by \(q^2\).  The seagull cancels
  it, leaving
  \[
    \Pi_{\mu\nu}^{ab}\big|_{\rm pole}
      \propto\delta^{ab}
  ...
  \(\beta(g)=-b_0g^3/(16\pi^2)+\cdots\), this is screening:
  \[
    \boxed{\Delta b_0^{\rm complex}=-\frac13T(r),\qquad
      \Delta b_0^{\rm real}=-\frac16T(r).}
  \]
  The factor \(1/2\) counts the independent real modes.

  \SupplementarySolution{27}{The General One-Loop Coefficient}
  ...
  \SupplementarySolution{28}{The Asymptotic-Freedom Bound}
  The condition is
  \[
  ...
  \SupplementarySolution{29}{Stability of the Slavnov Identity}
  ...
  \SupplementarySolution{30}{From the Coupling Counterterm to Running}
