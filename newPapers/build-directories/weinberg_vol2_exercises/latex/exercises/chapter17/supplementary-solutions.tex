...
\begin{enumerate}
    ...
    \begin{split}
      s^2\phi
        ...
        &=\frac12\omega^a\omega^b
          \left([T_a,T_b]
            -iC_{cab}T_c\right)\phi .
    \end{split}
    \]
    Thus \(s^2\phi=0\) for arbitrary ghosts precisely when
    \([T_a,T_b]=iC_{cab}T_c\).  Conversely, if
    ...
    \item[(a)] With the convention used in the question, the finite
      ...
      \[
        A_\mu' =U^\dagger A_\mu U
          +\frac{i}{g}U^\dagger\partial_\mu U,
        \qquad
        F_{\mu\nu}'=U^\dagger F_{\mu\nu}U.
      \]
        ...
        \item[(i)] For definiteness, take a local, Lorentz-invariant
          ...
          \begin{split}
            \mathcal L={}&-\frac14\operatorname{Tr}F_{\mu\nu}F^{\mu\nu}
              ...
              +\bar\psi(i\slashed D-m_\psi)\psi\\
  ...
  \begin{enumerate}
    ...
    The variations are
    \[
      \delta\psi_R=i\epsilon^a t_a^R\psi_R,\quad
      \delta\bar\psi_L=-i\epsilon^a\bar\psi_Lt_a^L,\quad
      \delta\phi_i=i\epsilon^a(T_a)_i{}^j\phi_j .
    \]
  ...
  \begin{enumerate}
    ...
    \[
      \boxed{F'_{\mu\nu}=UF_{\mu\nu}U^\dagger.}
    \]
    For \(U=\mathbf{1}+i\alpha^cT_c+O(\alpha^2)\),
    \[
      \delta F_{\mu\nu}
       =i[\alpha^cT_c,F_{\mu\nu}^bT_b]
       =f_{bc}{}^aF_{\mu\nu}^b\alpha^cT_a,
  ...
  \(\int_L\equiv\mu^{2\epsilon}\int d^dL/(2\pi)^d\),
  \[
  \begin{aligned}
    \int_L\frac1{(L^2+\Delta-i0)^2}
       &=\frac{i}{16\pi^2\epsilon}+O(1),\\
    \int_L\frac{L_\alpha L_\beta}{(L^2+\Delta-i0)^3}
