...
\begin{enumerate}
  \SupplementarySolution{1}{Diagnosing a Large-Log Expansion}
  ...
  \SupplementarySolution{2}{One-Loop Scalar Running}
  ...
  \SupplementarySolution{3}{The Scalar Landau Scale}
  ...
  \SupplementarySolution{4}{Piecewise QED Effective Charge}
  ...
  \SupplementarySolution{5}{A Beta-Function from a Simple Pole}
  ...
  \SupplementarySolution{6}{Leading Logarithms from Characteristics}
  ...
  \SupplementarySolution{7}{Approach to a Simple Fixed Point}
  ...
  \SupplementarySolution{8}{A Two-Coupling Stability Matrix}
  ...
  \SupplementarySolution{9}{Why Stability Exponents Are Scheme Independent}
  ...
  \SupplementarySolution{10}{A Flow with a Marginal Direction}
  The solutions are
  \[
  ...
  \SupplementarySolution{11}{Ultraviolet Critical-Surface Dimension}
  In the convention
  ...
  \SupplementarySolution{12}{Mass as a Running Coupling}
  ...
  \SupplementarySolution{13}{A Perturbative Banks--Zaks Zero}
  ...
  \SupplementarySolution{14}{Probe Forces at a Gauge Fixed Point}
  ...
  \SupplementarySolution{15}{An RG-Improved Short-Distance Potential}
  ...
  \SupplementarySolution{16}{One-Loop Heavy-Flavor Matching}
  ...
  \SupplementarySolution{17}{The Inclusive Hadronic Ratio}
  ...
  \SupplementarySolution{18}{Running Coupling from Three-Jet Fractions}
  ...
  \SupplementarySolution{19}{Gaussian Fixed-Point Power Counting}
  ...
  \SupplementarySolution{20}{Locating the Wilson--Fisher Fixed Point}
  ...
  \SupplementarySolution{21}{The \(O(N)\) Thermal Eigenvalue}
  ...
  \SupplementarySolution{22}{The \(O(N)\) Correlation-Length Exponent}
  Since \(\nu=1/y_t=-1/\lambda_t\),
  \[
    \boxed{\nu=\frac12+
  ...
  \SupplementarySolution{23}{The Correction-to-Scaling Exponent}
  For
  ...
  \SupplementarySolution{24}{Why \(\eta\) Starts at Second Order}
  ...
  \SupplementarySolution{25}{Susceptibility from Homogeneity}
  Choose
  ...
  \SupplementarySolution{26}{Hyperscaling of the Specific Heat}
  ...
  \SupplementarySolution{27}{Universality under an Irrelevant Deformation}
  ...
  \SupplementarySolution{28}{Diagonalizing Coupled Scaling Fields}
  ...
  \SupplementarySolution{29}{A Marginally Irrelevant Temperature}
  Separation gives
  \[
  ...
  \SupplementarySolution{30}{Two-Variable Scaling Form}
