...
- Chapter 15: `barnich-brandt-henneaux-2000` (1), `becchi-gauge-theories-1997` (1), `eth-qft2-fs17` (3), `gomis-paris-samuel-1995` (1), `mit-8324-f10-ps1` (1), `mit-8324-f10-ps2` (2), `mnev-bv-2017` (1), `skinner-aqft-sheet4-2018` (2), `stanford-physics331-w20-set2` (1), `uchicago-physics445-ps5-2021` (1), `uzh-phy552-fs19` (1)
- Chapter 16: `cambridge-part-iii-aqft-2019-p304` (1), `coleman-weinberg-1973` (1), `cornwall-jackiw-tomboulis-1974` (1), `jackiw-effective-potential-1974` (1), `kaplunovsky-effective-potential-2019` (1), `lim-advanced-qft-2019` (2), `mcgreevy-physics215c-2014` (1), `mit-8323-s23-ps10` (1), `srednicki-qft-draft-2006` (1), `ucsc-physics222-effective-potential-2020` (1)
- Chapter 17: `abbott-background-field-1981` (1), `barvinsky-et-al-background-renormalization-2017` (2), `cambridge-part-iii-aqft-2022-p304` (1), `franco-piguet-algebraic-renormalization-2013` (2), `gross-wilczek-asymptotic-freedom-1973` (1), `kaplunovsky-qcd-beta-2024` (1), `piguet-sorella-algebraic-renormalization-1995` (1), `skinner-qft2-ch8-2018` (1), `tong-gauge-theory-2018` (1)
- Chapter 18: `kaplunovsky-rg-flows-2024` (2), `kaplunovsky-rg-techniques-2024` (2), `mcgreevy-215c-s25-assignment4` (2), `mit-ocw-stat-mech-ii-2014` (2), `tong-gauge-rg-2018` (2), `tong-statistical-field-theory-2021` (2)
- Chapter 19: `mcgreevy-215c-s25-assignment4` (1), `mit-ocw-qft-iii-2007` (2), `pich-effective-field-theory-1998` (2), `scherer-chiral-perturbation-2002` (2), `tong-standard-model-broken-symmetries-2025` (2), `tong-statistical-field-theory-goldstone-2021` (2)
- Chapter 20: `beneke-renormalons-1999` (2), `mcgreevy-215c-s25-homework5` (1), `mit-8324-f10-ps6-ope-rg` (2), `mit-8325-s07-dis` (1), `pdg-structure-functions-2025` (2), `radyushkin-qcd-sum-rules-2001` (2)
- Chapter 21: `cambridge-part-iii-standard-model-2022-p305` (1), `greiter-superconductivity-2005` (2), `hamilton-higgs-mathematicians-2015` (1), `mit-8323-s23-rec10-ew-higgs` (2), `pdg-electroweak-2025` (2), `pdg-guts-2025` (2)
- Chapter 22: `bilal-lectures-anomalies-2008` (2), `harvey-tasi-anomalies-2005` (2), `mcgreevy-215c-s25-assignment2` (1), `mcgreevy-215c-s25-assignment3` (1), `mit-8325-s07-hw6-anomalies` (2), `preskill-qcd-anomalies-1984` (2), `tong-gauge-theory-anomalies-2018` (2)
- Chapter 23: `bernard-instanton-zero-modes-1979-ch23` (1), `bogomolny-stability-classical-solutions-1976-ch23` (1), `bpst-pseudoparticle-yang-mills-1975-ch23` (1), `callan-coleman-false-vacuum-ii-1977-ch23` (1), `callan-dashen-gross-gauge-vacuum-1976-ch23` (1), `cambridge-part-iii-solitons-3p11a` (3), `coleman-false-vacuum-1977-ch23` (1), `derrick-nonlinear-wave-1964-ch23` (1), `kibble-topology-defects-1976-ch23` (1), `mcgreevy-215c-s25-assignment2` (1), `mcgreevy-215c-s25-assignment3` (1), `prasad-sommerfield-monopole-1975-ch23` (1), `sikivie-axion-domain-walls-1982-ch23` (1), `t-hooft-magnetic-monopoles-1974-ch23` (1), `weinberg-new-light-boson-1978-ch23` (1)

## First-choice source families by chapter

- Chapter 15: `cambridge-part-iii` (2), `other` (13)
- Chapter 16: `cambridge-part-iii` (1), `mcgreevy` (1), `other` (9)
- Chapter 17: `cambridge-part-iii` (2), `other` (9)
- Chapter 18: `mcgreevy` (2), `other` (10)
- Chapter 19: `mcgreevy` (1), `other` (10)
- Chapter 20: `mcgreevy` (1), `other` (9)
- Chapter 21: `cambridge-part-iii` (1), `other` (9)
- Chapter 22: `mcgreevy` (2), `other` (10)
- Chapter 23: `cambridge-part-iii` (3), `mcgreevy` (2), `other` (12)
