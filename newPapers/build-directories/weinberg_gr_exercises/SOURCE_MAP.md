...
The source front matter includes the title page, dedication, publication data,
preface, notation, contents, and copyright acknowledgements. The publication-
data and copyright-acknowledgement leaves are retained in the transcription
archive but intentionally omitted from the compiled edition. The main text is
divided into:
