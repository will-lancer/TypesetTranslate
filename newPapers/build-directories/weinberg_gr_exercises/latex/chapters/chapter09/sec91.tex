...
\end{equation}
\begin{equation}
  g^{0\mu}g_{0\mu}=g^{00}g_{00}+g^{0i}g_{0i}=1,
...
\(\Gamma^i{}_{00},\Gamma^i{}_{jk},\Gamma^0{}_{0i}\) have expansions
\begin{equation}
  \Gamma^\mu{}_{\nu\lambda}
  =\Gamma^{\mu(2)}{}_{\nu\lambda}
  +\Gamma^{\mu(4)}{}_{\nu\lambda}+\cdots,
  \quad
  (\Gamma^i{}_{00},\Gamma^i{}_{jk},\Gamma^0{}_{0i}),
...
\end{equation}
\begin{equation}
  \Gamma^{0(2)}{}_{0i}=-\frac12\partial_i g_{00}^{(2)},
...
\begin{equation}
  R_{00}^{(4)}
  =
  -\partial_t\Gamma^{i(3)}{}_{0i}
  +\partial_i\Gamma^{i(4)}{}_{00}
  -\Gamma^{0(2)}{}_{0i}\Gamma^{i(2)}{}_{00}
...
\end{equation}
while the second-order term with \(\lambda=i\) gives
\begin{equation}
  0=
