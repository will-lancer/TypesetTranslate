...
% Uncertainties: SOURCE ERRATUM -- the scan's t/3 in (15.3.34) conflicts with
%                the preceding expression, which evaluates to 3t; corrected.
...
\input{figures/chapter15/fig15-01.tex}
...
% SOURCE ERRATUM: the scan prints t/3; (15.3.4) and the preceding expression
% give 3t.
\begin{equation}
  d_H(t)
  \longrightarrow
