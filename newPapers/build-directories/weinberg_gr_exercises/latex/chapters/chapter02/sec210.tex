...
\end{equation}
\begin{equation}
  \widetilde T^{i0}=\widetilde T^{0\ii}=0,
...
\begin{equation}
  \mathbf U=\frac{\dd\mathbf x}{\dd\tau}
  =(1-\mathbf v^2)^{-1/2}\mathbf v,\qquad
  U^0=\frac{\dd t}{\dd\tau}=(1-\mathbf v^2)^{-1/2},
...
scalar equations. The three-vector equation is obtained by setting \(\mu=\ii\)
...
in such a way that
\begin{equation}
  kT\,\dd\sigma=p\,\dd\left(\frac1n\right)
...
\begin{equation}
  ...
  =p\,\dd\left(\frac1n\right)
   +(\gamma-1)^{-1}\dd\left(\frac pn\right)
  =\frac{n^{\gamma-1}}{\gamma-1}
   \dd\left(\frac{p}{n^\gamma}\right).
...
\[
  ...
  =-\frac{\boldsymbol{\nabla}p_1}{p+\rho}.
\]
But with \(\dd\sigma=0\), Eq.~\eqref{eq:2.10.18} gives
\[
