...
% Uncertainties: source prose says "Table 8.2" where the orbital data are in
%                Table 8.3; preserved and marked VERIFY SOURCE below.
...
\(dr/d\varphi\) vanishes, so Eq.~\eqref{eq:8.4.29} gives
\[
...
\input{figures/chapter08/fig08-02.tex}
...
% VERIFY SOURCE: the printed text says Table 8.2, although the planetary
% precession data used in this argument are in Table 8.3.
Table 8.2 shows that in fact the observed anomalous precession per
