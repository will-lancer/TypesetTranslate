...
\input{figures/chapter11/fig11-02.tex}
...
\begin{align}
  ...
  \int_0^{k_F}(k^2+m_n^2)^{1/2}k^2\,\dd k
  =
  3\rho_c\int_0^{k_F/m_n}(u^2+1)^{1/2}u^2\,\dd u,
  \tag{11.4.1}\label{eq:11.4.1}\\
  p
  &=
  \frac{8\pi}{3(2\pi\hbar)^3}
  \int_0^{k_F}\frac{k^2}{(k^2+m_n^2)^{1/2}}k^2\,\dd k
  =
  \rho_c\int_0^{k_F/m_n}(u^2+1)^{-1/2}u^4\,\dd u,
...
\begin{align}
  ...
  &=
  \frac{8\pi}{(2\pi\hbar)^3}
  \int_0^{k_{F,\ii}}(k^2+m_i^2)^{1/2}k^2\,\dd k,
  \tag{11.4.18}\label{eq:11.4.18}\\
  n_i
  &=
  \frac{8\pi}{(2\pi\hbar)^3}
  \int_0^{k_{F,\ii}}k^2\,\dd k
  =
  \frac{k_{F,\ii}^3}{3\pi^2\hbar^3}.
...
\begin{equation}
  ...
  &=
  3C^{-3}\bigg\{
    \int_0^{Cn_n^{1/3}}(k^2+m_n^2)^{1/2}k^2\,\dd k\\
  &\qquad
    +\int_0^{C(n_B-n_n)^{1/3}}(k^2+m_p^2)^{1/2}k^2\,\dd k\\
  &\qquad
    +\int_0^{C(n_B-n_n)^{1/3}}(k^2+m_e^2)^{1/2}k^2\,\dd k
  \bigg\},
  \end{aligned}
