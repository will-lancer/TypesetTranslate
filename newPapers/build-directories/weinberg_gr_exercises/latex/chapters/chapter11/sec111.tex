...
% Uncertainties: source (11.1.19) uses the four-dimensional determinant per
%                unit coordinate time rather than the proper three-volume;
%                the convective-energy prose prints A Delta s/T; both are
...
\end{align}
A prime denotes \(d/dr\). (We do not need to write down the equation for
...
lose an energy \(A\,\Delta s/T\) when transported from one part
...
% VERIFY SOURCE: the scan prints A Delta s/T.  The thermodynamic combination
% would ordinarily be A T Delta s; the printed expression is preserved.
...
\begin{equation}
  M=\mathcal{M}(R)=\int_0^R4\pi r^2\rho(r)\,dr.
...
% VERIFY SOURCE: this is the source's four-dimensional determinant per unit
% coordinate time, not the induced proper three-volume measure.
\begin{equation}
  M_{\mathrm{matter}}
  =
  \int\sqrt{-g}\,\rho\,dr\,d\theta\,d\varphi
  =
  \int_0^R4\pi r^2\sqrt{A(r)B(r)}\,\rho(r)\,dr.
...
\begin{equation}
  N
  =
  \int\sqrt{-g}\,J_N^0\,dr\,d\theta\,d\varphi
  =
  \int_0^R4\pi r^2\sqrt{A(r)B(r)}\,J_N^0(r)\,dr,
...
\begin{equation}
  ...
  N
  &=
  \int_0^R4\pi r^2\sqrt{A(r)}\,n(r)\,dr\\
  &=
  \int_0^R4\pi r^2
...
\begin{equation}
  \begin{aligned}
  -G\int_0^R4\pi r\mathcal{M}(r)\rho(r)\,dr
  &=-\frac G2\int_0^R\frac1r\,d\!\left(\mathcal{M}^2(r)\right)\\
  &=-\frac{GM^2}{2R}
    -\frac G2\int_0^R\frac{\mathcal{M}^2(r)}{r^2}\,dr\\
  &=\frac{\phi(R)\mathcal{M}(R)}2
    -\frac12\int_0^R\mathcal{M}(r)\,d\phi(r)\\
  &=\frac12\int_0^R\phi(r)\,d\mathcal{M}(r),
  \end{aligned}
...
\[
  \phi(r)=-\frac{GM}{R}
  -G\int_r^R\frac{\mathcal{M}(r')}{r'^2}\,dr'.
\]
