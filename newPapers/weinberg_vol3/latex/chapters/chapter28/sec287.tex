...
% Source-visible anomaly preserved: the opening paragraph identifies
% Eqs. (28.1.2) and (28.1.3), rather than (28.1.4) and (28.1.5), as
% baryon- and lepton-number non-conserving operators. Uncertainties: none.
...
\eqref{eq:28.1.2} and \eqref{eq:28.1.3} of dimensionality four that can be
included in a renormalizable
\(SU(3)\mathbin{\cdot}SU(2)\mathbin{\cdot}U(1)\)-invariant theory and that
...
\(SU(3)\mathbin{\cdot}SU(2)\mathbin{\cdot}U(1)\)-invariant but baryon- and
...
standard model with coefficients proportional to \(M^{4-d}\). With only
...
\IfFileExists{chapters/chapter28/figures/fig28-07.tex}{%
  \input{chapters/chapter28/figures/fig28-07.tex}%
}{%
  \input{../chapters/chapter28/figures/fig28-07.tex}%
}

In the notation of Section 28.1, the
\(SU(3)\mathbin{\cdot}SU(2)\mathbin{\cdot}U(1)\)-invariant operators of
...
\[
  u_1=u\,,
  \qquad
  d_1=d\cos\theta_c+s\sin\theta_c\,,
  \qquad
  d_2=-d\sin\theta_c+s\cos\theta_c\,,
\]
...
by the phase \(\exp(i\pi/3)\), and the \(L\), \(H_1\), \(\bar U\), and
\(\bar E\) superfields are multiplied by the opposite phase
\(\exp(-i\pi/3)\). This symmetry is designed to allow the fundamental
