...
\begin{equation}
  \Phi(x,\theta)
  =\phi(x_+)-\sqrt{2}(\theta_L^T\epsilon\psi_L(x_+))
  +\mathcal{F}(x_+)(\theta_L^T\epsilon\theta_L)\,,
  \tag{26.3.21}\label{eq:26.3.21}
\end{equation}
\begin{equation}
  \widetilde{\Phi}(x,\theta)
  =\widetilde{\phi}(x_-)+\sqrt{2}(\theta_R^T\epsilon\psi_R(x_-))
  -\widetilde{\mathcal{F}}(x_-)(\theta_R^T\epsilon\theta_R)\,,
...
\begin{equation}
  ...
  =x^\mu\pm(\theta_R^T\epsilon\gamma^\mu\theta_L)\,.
...
$(\SuperD_R^T\epsilon\SuperD_R)S$. If one of the left-chiral superfields in
...
superpotential as $f=(\SuperD_R^T\epsilon\SuperD_R)h$ for some other
superfield $h$. Now,
\[
  (\SuperD_R^T\epsilon\SuperD_R)
  (\theta_R^T\epsilon\theta_R)=-4\,,
\]
so, apart from spacetime derivatives that do not contribute to the action,
$(\SuperD_R^T\epsilon\SuperD_R)h$ is the coefficient of
$-(\theta_R^T\epsilon\theta_R)/4$ in $h$. But, again apart from spacetime
derivatives, $[f]_{\mathcal{F}}$ is the coefficient of
$(\theta_L^T\epsilon\theta_L)$ in $f$, so
$[(\SuperD_R^T\epsilon\SuperD_R)h]_{\mathcal{F}}$ equals the coefficient of
\[
  -\frac14(\theta_L^T\epsilon\theta_L)
...
\begin{equation}
  \int d^4x\,
  [(\SuperD_R^T\epsilon\SuperD_R)h]_{\mathcal{F}}
  =2\int d^4x\,[h]_D\,.
