...
% [4], [8]--[13].
% Source-visible cross-reference anomalies are retained: the duality
% sentence cites Eqs. (32.3.1)--(32.3.3), and the d=11 discussion cites
% Eq. (32.3.8).
...
Eqs. (32.3.1)--(32.3.3) for any \(d\), so that we can restrict \(p\) to
...
\(M\)-theory generalization of string theories. Eq. (32.3.8) shows that
